...
- Maximum Tank health: `1,000,000` (Increase/decrease the value in the `mutant_tanks.inc` file on lines `92-93` and recompile all the plugins, but expect bugs with higher values.) [Default: `65,535`]
