...
## Notes
> This file contains everything you need to know about each ability/setting. Be sure to use this guide to help you with any questions you may have about any setting before asking about it or reporting an issue. This file uses the first (original) config format for examples.
