...
{
	if (MT_IsTankSupported(tank, MT_CHECK_INDEX|MT_CHECK_INGAME|MT_CHECK_INKICKQUEUE) && MT_IsCustomTankSupported(tank) && !MT_IsTankIdle(tank) && g_esCache[tank].g_iShakeDeath == 1 && GetRandomFloat(0.1, 100.0) <= g_esCache[tank].g_flShakeDeathChance)
	{
