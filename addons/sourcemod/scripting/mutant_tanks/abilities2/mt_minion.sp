...
esMinionTeammate g_esMinionTeammate[MAXPLAYERS + 1][7];
...
esMinionSpecial g_esMinionSpecial[MT_MAXTYPES + 1][7];
	...
	switch (mode)
	{
		case 1:
		{
			for (int iIndex = MT_GetMinType(); iIndex <= MT_GetMaxType(); iIndex++)
			{
				...
				{
					g_esMinionSpecial[iIndex][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esMinionSpecial[iIndex][iSpecType].g_iComboAbility = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iHumanAbility = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iHumanAmmo = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iHumanCooldown = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esMinionSpecial[iIndex][iSpecType].g_iRequiresHumans = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iMinionAbility = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iMinionMessage = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iMinionAmount = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_flMinionChance = -1.0;
					g_esMinionSpecial[iIndex][iSpecType].g_iMinionCooldown = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_flMinionLifetime = -1.0;
					g_esMinionSpecial[iIndex][iSpecType].g_iMinionRemove = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iMinionReplace = -1;
					g_esMinionSpecial[iIndex][iSpecType].g_iMinionTypes = -1;
				}
			}
		}
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				...
				for (int iSpecType = 0; iSpecType < (sizeof g_sSpecialNames); iSpecType++)
				{
					g_esMinionTeammate[iPlayer][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esMinionTeammate[iPlayer][iSpecType].g_iComboAbility = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iHumanAbility = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iHumanAmmo = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iHumanCooldown = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esMinionTeammate[iPlayer][iSpecType].g_iRequiresHumans = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iMinionAbility = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iMinionMessage = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iMinionAmount = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_flMinionChance = -1.0;
					g_esMinionTeammate[iPlayer][iSpecType].g_iMinionCooldown = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_flMinionLifetime = -1.0;
					g_esMinionTeammate[iPlayer][iSpecType].g_iMinionRemove = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iMinionReplace = -1;
					g_esMinionTeammate[iPlayer][iSpecType].g_iMinionTypes = -1;
				}
			}
		}
	}
...
#if defined MT_ABILITIES_MAIN2
void vMinionConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esMinionTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esMinionTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esMinionTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esMinionTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esMinionTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esMinionTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esMinionTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esMinionTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esMinionTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esMinionTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esMinionTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esMinionTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esMinionTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esMinionTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esMinionTeammate[admin][specType].g_iMinionAbility = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esMinionTeammate[admin][specType].g_iMinionAbility, value, -1, 1, specType);
			g_esMinionTeammate[admin][specType].g_iMinionMessage = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esMinionTeammate[admin][specType].g_iMinionMessage, value, -1, 1, specType);
			g_esMinionTeammate[admin][specType].g_iMinionAmount = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionAmount", "Minion Amount", "Minion_Amount", "amount", g_esMinionTeammate[admin][specType].g_iMinionAmount, value, -1, 15, specType);
			g_esMinionTeammate[admin][specType].g_flMinionChance = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionChance", "Minion Chance", "Minion_Chance", "chance", g_esMinionTeammate[admin][specType].g_flMinionChance, value, -1.0, 100.0, specType);
			g_esMinionTeammate[admin][specType].g_iMinionCooldown = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionCooldown", "Minion Cooldown", "Minion_Cooldown", "cooldown", g_esMinionTeammate[admin][specType].g_iMinionCooldown, value, -1, 99999, specType);
			g_esMinionTeammate[admin][specType].g_flMinionLifetime = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionLifetime", "Minion Lifetime", "Minion_Lifetime", "lifetime", g_esMinionTeammate[admin][specType].g_flMinionLifetime, value, -1.0, 99999.0, specType);
			g_esMinionTeammate[admin][specType].g_iMinionRemove = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionRemove", "Minion Remove", "Minion_Remove", "remove", g_esMinionTeammate[admin][specType].g_iMinionRemove, value, -1, 1, specType);
			g_esMinionTeammate[admin][specType].g_iMinionReplace = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionReplace", "Minion Replace", "Minion_Replace", "replace", g_esMinionTeammate[admin][specType].g_iMinionReplace, value, -1, 1, specType);
			g_esMinionTeammate[admin][specType].g_iMinionTypes = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionTypes", "Minion Types", "Minion_Types", "types", g_esMinionTeammate[admin][specType].g_iMinionTypes, value, -1, 63, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esMinionSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esMinionSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esMinionSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esMinionSpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esMinionSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esMinionSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esMinionSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esMinionSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esMinionSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esMinionSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esMinionSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esMinionSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esMinionSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esMinionSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esMinionSpecial[type][specType].g_iMinionAbility = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esMinionSpecial[type][specType].g_iMinionAbility, value, -1, 1, specType);
			g_esMinionSpecial[type][specType].g_iMinionMessage = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esMinionSpecial[type][specType].g_iMinionMessage, value, -1, 1, specType);
			g_esMinionSpecial[type][specType].g_iMinionAmount = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionAmount", "Minion Amount", "Minion_Amount", "amount", g_esMinionSpecial[type][specType].g_iMinionAmount, value, -1, 15, specType);
			g_esMinionSpecial[type][specType].g_flMinionChance = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionChance", "Minion Chance", "Minion_Chance", "chance", g_esMinionSpecial[type][specType].g_flMinionChance, value, -1.0, 100.0, specType);
			g_esMinionSpecial[type][specType].g_iMinionCooldown = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionCooldown", "Minion Cooldown", "Minion_Cooldown", "cooldown", g_esMinionSpecial[type][specType].g_iMinionCooldown, value, -1, 99999, specType);
			g_esMinionSpecial[type][specType].g_flMinionLifetime = flGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionLifetime", "Minion Lifetime", "Minion_Lifetime", "lifetime", g_esMinionSpecial[type][specType].g_flMinionLifetime, value, -1.0, 99999.0, specType);
			g_esMinionSpecial[type][specType].g_iMinionRemove = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionRemove", "Minion Remove", "Minion_Remove", "remove", g_esMinionSpecial[type][specType].g_iMinionRemove, value, -1, 1, specType);
			g_esMinionSpecial[type][specType].g_iMinionReplace = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionReplace", "Minion Replace", "Minion_Replace", "replace", g_esMinionSpecial[type][specType].g_iMinionReplace, value, -1, 1, specType);
			g_esMinionSpecial[type][specType].g_iMinionTypes = iGetKeyValue(subsection, MT_MINION_SECTION, MT_MINION_SECTION2, MT_MINION_SECTION3, MT_MINION_SECTION4, key, "MinionTypes", "Minion Types", "Minion_Types", "types", g_esMinionSpecial[type][specType].g_iMinionTypes, value, -1, 63, specType);
		}
		else
		{
...
#endif
{
	...
	g_esMinionPlayer[tank].g_iInfectedType = iGetInfectedType(tank);
	g_esMinionPlayer[tank].g_iTankType = apply ? type : 0;
	int iSpecType = g_esMinionPlayer[tank].g_iInfectedType;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esMinionCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_flCloseAreasOnly, g_esMinionTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esMinionPlayer[tank].g_flCloseAreasOnly, g_esMinionSpecial[type][0].g_flCloseAreasOnly, g_esMinionSpecial[type][iSpecType].g_flCloseAreasOnly, g_esMinionAbility[type].g_flCloseAreasOnly, 1);
		g_esMinionCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iComboAbility, g_esMinionTeammate[tank][iSpecType].g_iComboAbility, g_esMinionPlayer[tank].g_iComboAbility, g_esMinionSpecial[type][0].g_iComboAbility, g_esMinionSpecial[type][iSpecType].g_iComboAbility, g_esMinionAbility[type].g_iComboAbility, 1);
		g_esMinionCache[tank].g_flMinionChance = flGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_flMinionChance, g_esMinionTeammate[tank][iSpecType].g_flMinionChance, g_esMinionPlayer[tank].g_flMinionChance, g_esMinionSpecial[type][0].g_flMinionChance, g_esMinionSpecial[type][iSpecType].g_flMinionChance, g_esMinionAbility[type].g_flMinionChance, 1);
		g_esMinionCache[tank].g_flMinionLifetime = flGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_flMinionLifetime, g_esMinionTeammate[tank][iSpecType].g_flMinionLifetime, g_esMinionPlayer[tank].g_flMinionLifetime, g_esMinionSpecial[type][0].g_flMinionLifetime, g_esMinionSpecial[type][iSpecType].g_flMinionLifetime, g_esMinionAbility[type].g_flMinionLifetime, 1);
		g_esMinionCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iHumanAbility, g_esMinionTeammate[tank][iSpecType].g_iHumanAbility, g_esMinionPlayer[tank].g_iHumanAbility, g_esMinionSpecial[type][0].g_iHumanAbility, g_esMinionSpecial[type][iSpecType].g_iHumanAbility, g_esMinionAbility[type].g_iHumanAbility, 1);
		g_esMinionCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iHumanAmmo, g_esMinionTeammate[tank][iSpecType].g_iHumanAmmo, g_esMinionPlayer[tank].g_iHumanAmmo, g_esMinionSpecial[type][0].g_iHumanAmmo, g_esMinionSpecial[type][iSpecType].g_iHumanAmmo, g_esMinionAbility[type].g_iHumanAmmo, 1);
		g_esMinionCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iHumanCooldown, g_esMinionTeammate[tank][iSpecType].g_iHumanCooldown, g_esMinionPlayer[tank].g_iHumanCooldown, g_esMinionSpecial[type][0].g_iHumanCooldown, g_esMinionSpecial[type][iSpecType].g_iHumanCooldown, g_esMinionAbility[type].g_iHumanCooldown, 1);
		g_esMinionCache[tank].g_iMinionAbility = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iMinionAbility, g_esMinionTeammate[tank][iSpecType].g_iMinionAbility, g_esMinionPlayer[tank].g_iMinionAbility, g_esMinionSpecial[type][0].g_iMinionAbility, g_esMinionSpecial[type][iSpecType].g_iMinionAbility, g_esMinionAbility[type].g_iMinionAbility, 1);
		g_esMinionCache[tank].g_iMinionAmount = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iMinionAmount, g_esMinionTeammate[tank][iSpecType].g_iMinionAmount, g_esMinionPlayer[tank].g_iMinionAmount, g_esMinionSpecial[type][0].g_iMinionAmount, g_esMinionSpecial[type][iSpecType].g_iMinionAmount, g_esMinionAbility[type].g_iMinionAmount, 1);
		g_esMinionCache[tank].g_iMinionCooldown = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iMinionCooldown, g_esMinionTeammate[tank][iSpecType].g_iMinionCooldown, g_esMinionPlayer[tank].g_iMinionCooldown, g_esMinionSpecial[type][0].g_iMinionCooldown, g_esMinionSpecial[type][iSpecType].g_iMinionCooldown, g_esMinionAbility[type].g_iMinionCooldown, 1);
		g_esMinionCache[tank].g_iMinionMessage = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iMinionMessage, g_esMinionTeammate[tank][iSpecType].g_iMinionMessage, g_esMinionPlayer[tank].g_iMinionMessage, g_esMinionSpecial[type][0].g_iMinionMessage, g_esMinionSpecial[type][iSpecType].g_iMinionMessage, g_esMinionAbility[type].g_iMinionMessage, 1);
		g_esMinionCache[tank].g_iMinionRemove = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iMinionRemove, g_esMinionTeammate[tank][iSpecType].g_iMinionRemove, g_esMinionPlayer[tank].g_iMinionRemove, g_esMinionSpecial[type][0].g_iMinionRemove, g_esMinionSpecial[type][iSpecType].g_iMinionRemove, g_esMinionAbility[type].g_iMinionRemove, 1);
		g_esMinionCache[tank].g_iMinionReplace = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iMinionReplace, g_esMinionTeammate[tank][iSpecType].g_iMinionReplace, g_esMinionPlayer[tank].g_iMinionReplace, g_esMinionSpecial[type][0].g_iMinionReplace, g_esMinionSpecial[type][iSpecType].g_iMinionReplace, g_esMinionAbility[type].g_iMinionReplace, 1);
		g_esMinionCache[tank].g_iMinionTypes = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iMinionTypes, g_esMinionTeammate[tank][iSpecType].g_iMinionTypes, g_esMinionPlayer[tank].g_iMinionTypes, g_esMinionSpecial[type][0].g_iMinionTypes, g_esMinionSpecial[type][iSpecType].g_iMinionTypes, g_esMinionAbility[type].g_iMinionTypes, 1);
		g_esMinionCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_flOpenAreasOnly, g_esMinionTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esMinionPlayer[tank].g_flOpenAreasOnly, g_esMinionSpecial[type][0].g_flOpenAreasOnly, g_esMinionSpecial[type][iSpecType].g_flOpenAreasOnly, g_esMinionAbility[type].g_flOpenAreasOnly, 1);
		g_esMinionCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esMinionTeammate[tank][0].g_iRequiresHumans, g_esMinionTeammate[tank][iSpecType].g_iRequiresHumans, g_esMinionPlayer[tank].g_iRequiresHumans, g_esMinionSpecial[type][0].g_iRequiresHumans, g_esMinionSpecial[type][iSpecType].g_iRequiresHumans, g_esMinionAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esMinionCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esMinionCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esMinionPlayer[tank].g_iTankType, tank) || (g_esMinionCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esMinionCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esMinionAbility[g_esMinionPlayer[tank].g_iTankType].g_iAccessFlags, g_esMinionPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
void tTimerMinionCombo(Handle timer, int userid)
{
	...
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esMinionAbility[g_esMinionPlayer[iTank].g_iTankType].g_iAccessFlags, g_esMinionPlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esMinionPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esMinionCache[iTank].g_iMinionAbility == 0)
	{
		return;
	}
