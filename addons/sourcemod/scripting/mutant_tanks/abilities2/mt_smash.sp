...
esSmashTeammate g_esSmashTeammate[MAXPLAYERS + 1][6];
...
esSmashSpecial g_esSmashSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN2
void vSmashConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esSmashTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esSmashTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esSmashTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esSmashTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esSmashTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esSmashTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esSmashTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esSmashTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esSmashTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esSmashTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			...
			g_esSmashTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esSmashTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esSmashTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esSmashTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashAbility = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esSmashTeammate[admin][specType].g_iSmashAbility, value, -1, 1, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashEffect = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esSmashTeammate[admin][specType].g_iSmashEffect, value, -1, 7, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashMessage = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esSmashTeammate[admin][specType].g_iSmashMessage, value, -1, 3, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashSight = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esSmashTeammate[admin][specType].g_iSmashSight, value, -1, 2, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashBody = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashBody", "Smash Body", "Smash_Body", "body", g_esSmashTeammate[admin][specType].g_iSmashBody, value, -1, 1, specName, specType);
			g_esSmashTeammate[admin][specType].g_flSmashChance = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashChance", "Smash Chance", "Smash_Chance", "chance", g_esSmashTeammate[admin][specType].g_flSmashChance, value, -1.0, 100.0, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashCooldown = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashCooldown", "Smash Cooldown", "Smash_Cooldown", "cooldown", g_esSmashTeammate[admin][specType].g_iSmashCooldown, value, -1, 99999, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashHit = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashHit", "Smash Hit", "Smash_Hit", "hit", g_esSmashTeammate[admin][specType].g_iSmashHit, value, -1, 1, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashHitMode = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashHitMode", "Smash Hit Mode", "Smash_Hit_Mode", "hitmode", g_esSmashTeammate[admin][specType].g_iSmashHitMode, value, -1, 2, specName, specType);
			g_esSmashTeammate[admin][specType].g_flSmashMeter = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashMeter", "Smash Meter", "Smash_Meter", "meter", g_esSmashTeammate[admin][specType].g_flSmashMeter, value, -1.0, 99999.0, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashMode = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashMode", "Smash Mode", "Smash_Mode", "mode", g_esSmashTeammate[admin][specType].g_iSmashMode, value, -1, 3, specName, specType);
			g_esSmashTeammate[admin][specType].g_flSmashRange = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashRange", "Smash Range", "Smash_Range", "range", g_esSmashTeammate[admin][specType].g_flSmashRange, value, -1.0, 99999.0, specName, specType);
			g_esSmashTeammate[admin][specType].g_flSmashRangeChance = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashRangeChance", "Smash Range Chance", "Smash_Range_Chance", "rangechance", g_esSmashTeammate[admin][specType].g_flSmashRangeChance, value, -1.0, 100.0, specName, specType);
			g_esSmashTeammate[admin][specType].g_iSmashRangeCooldown = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashRangeCooldown", "Smash Range Cooldown", "Smash_Range_Cooldown", "rangecooldown", g_esSmashTeammate[admin][specType].g_iSmashRangeCooldown, value, -1, 99999, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esSmashSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esSmashSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esSmashSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esSmashSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esSmashSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esSmashSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esSmashSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esSmashSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esSmashSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esSmashSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			...
			g_esSmashSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esSmashSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esSmashSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esSmashSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashAbility = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esSmashSpecial[type][specType].g_iSmashAbility, value, -1, 1, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashEffect = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esSmashSpecial[type][specType].g_iSmashEffect, value, -1, 7, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashMessage = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esSmashSpecial[type][specType].g_iSmashMessage, value, -1, 3, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashSight = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esSmashSpecial[type][specType].g_iSmashSight, value, -1, 2, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashBody = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashBody", "Smash Body", "Smash_Body", "body", g_esSmashSpecial[type][specType].g_iSmashBody, value, -1, 1, specName, specType);
			g_esSmashSpecial[type][specType].g_flSmashChance = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashChance", "Smash Chance", "Smash_Chance", "chance", g_esSmashSpecial[type][specType].g_flSmashChance, value, -1.0, 100.0, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashCooldown = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashCooldown", "Smash Cooldown", "Smash_Cooldown", "cooldown", g_esSmashSpecial[type][specType].g_iSmashCooldown, value, -1, 99999, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashHit = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashHit", "Smash Hit", "Smash_Hit", "hit", g_esSmashSpecial[type][specType].g_iSmashHit, value, -1, 1, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashHitMode = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashHitMode", "Smash Hit Mode", "Smash_Hit_Mode", "hitmode", g_esSmashSpecial[type][specType].g_iSmashHitMode, value, -1, 2, specName, specType);
			g_esSmashSpecial[type][specType].g_flSmashMeter = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashMeter", "Smash Meter", "Smash_Meter", "meter", g_esSmashSpecial[type][specType].g_flSmashMeter, value, -1.0, 99999.0, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashMode = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashMode", "Smash Mode", "Smash_Mode", "mode", g_esSmashSpecial[type][specType].g_iSmashMode, value, -1, 3, specName, specType);
			g_esSmashSpecial[type][specType].g_flSmashRange = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashRange", "Smash Range", "Smash_Range", "range", g_esSmashSpecial[type][specType].g_flSmashRange, value, -1.0, 99999.0, specName, specType);
			g_esSmashSpecial[type][specType].g_flSmashRangeChance = flGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashRangeChance", "Smash Range Chance", "Smash_Range_Chance", "rangechance", g_esSmashSpecial[type][specType].g_flSmashRangeChance, value, -1.0, 100.0, specName, specType);
			g_esSmashSpecial[type][specType].g_iSmashRangeCooldown = iGetKeyValue(subsection, MT_SMASH_SECTION, MT_SMASH_SECTION2, MT_SMASH_SECTION3, MT_SMASH_SECTION4, key, "SmashRangeCooldown", "Smash Range Cooldown", "Smash_Range_Cooldown", "rangecooldown", g_esSmashSpecial[type][specType].g_iSmashRangeCooldown, value, -1, 99999, specName, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esSmashCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esSmashPlayer[tank].g_flCloseAreasOnly, g_esSmashSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esSmashAbility[type].g_flCloseAreasOnly, 1);
		g_esSmashCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iComboAbility, g_esSmashPlayer[tank].g_iComboAbility, g_esSmashSpecial[type][iSpecType - 1].g_iComboAbility, g_esSmashAbility[type].g_iComboAbility, 1);
		g_esSmashCache[tank].g_flSmashChance = flGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_flSmashChance, g_esSmashPlayer[tank].g_flSmashChance, g_esSmashSpecial[type][iSpecType - 1].g_flSmashChance, g_esSmashAbility[type].g_flSmashChance, 1);
		g_esSmashCache[tank].g_flSmashMeter = flGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_flSmashMeter, g_esSmashPlayer[tank].g_flSmashMeter, g_esSmashSpecial[type][iSpecType - 1].g_flSmashMeter, g_esSmashAbility[type].g_flSmashMeter, 1);
		g_esSmashCache[tank].g_flSmashRange = flGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_flSmashRange, g_esSmashPlayer[tank].g_flSmashRange, g_esSmashSpecial[type][iSpecType - 1].g_flSmashRange, g_esSmashAbility[type].g_flSmashRange, 1);
		g_esSmashCache[tank].g_flSmashRangeChance = flGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_flSmashRangeChance, g_esSmashPlayer[tank].g_flSmashRangeChance, g_esSmashSpecial[type][iSpecType - 1].g_flSmashRangeChance, g_esSmashAbility[type].g_flSmashRangeChance, 1);
		g_esSmashCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esSmashPlayer[tank].g_iHumanAbility, g_esSmashSpecial[type][iSpecType - 1].g_iHumanAbility, g_esSmashAbility[type].g_iHumanAbility, 1);
		g_esSmashCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iHumanAmmo, g_esSmashPlayer[tank].g_iHumanAmmo, g_esSmashSpecial[type][iSpecType - 1].g_iHumanAmmo, g_esSmashAbility[type].g_iHumanAmmo, 1);
		g_esSmashCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iHumanCooldown, g_esSmashPlayer[tank].g_iHumanCooldown, g_esSmashSpecial[type][iSpecType - 1].g_iHumanCooldown, g_esSmashAbility[type].g_iHumanCooldown, 1);
		g_esSmashCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iHumanRangeCooldown, g_esSmashPlayer[tank].g_iHumanRangeCooldown, g_esSmashSpecial[type][iSpecType - 1].g_iHumanRangeCooldown, g_esSmashAbility[type].g_iHumanRangeCooldown, 1);
		g_esSmashCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esSmashPlayer[tank].g_flOpenAreasOnly, g_esSmashSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esSmashAbility[type].g_flOpenAreasOnly, 1);
		g_esSmashCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esSmashPlayer[tank].g_iRequiresHumans, g_esSmashSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esSmashAbility[type].g_iRequiresHumans, 1);
		g_esSmashCache[tank].g_iSmashAbility = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashAbility, g_esSmashPlayer[tank].g_iSmashAbility, g_esSmashSpecial[type][iSpecType - 1].g_iSmashAbility, g_esSmashAbility[type].g_iSmashAbility, 1);
		g_esSmashCache[tank].g_iSmashBody = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashBody, g_esSmashPlayer[tank].g_iSmashBody, g_esSmashSpecial[type][iSpecType - 1].g_iSmashBody, g_esSmashAbility[type].g_iSmashBody, 1);
		g_esSmashCache[tank].g_iSmashCooldown = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashCooldown, g_esSmashPlayer[tank].g_iSmashCooldown, g_esSmashSpecial[type][iSpecType - 1].g_iSmashCooldown, g_esSmashAbility[type].g_iSmashCooldown, 1);
		g_esSmashCache[tank].g_iSmashEffect = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashEffect, g_esSmashPlayer[tank].g_iSmashEffect, g_esSmashSpecial[type][iSpecType - 1].g_iSmashEffect, g_esSmashAbility[type].g_iSmashEffect, 1);
		g_esSmashCache[tank].g_iSmashHit = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashHit, g_esSmashPlayer[tank].g_iSmashHit, g_esSmashSpecial[type][iSpecType - 1].g_iSmashHit, g_esSmashAbility[type].g_iSmashHit, 1);
		g_esSmashCache[tank].g_iSmashHitMode = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashHitMode, g_esSmashPlayer[tank].g_iSmashHitMode, g_esSmashSpecial[type][iSpecType - 1].g_iSmashHitMode, g_esSmashAbility[type].g_iSmashHitMode, 1);
		g_esSmashCache[tank].g_iSmashMessage = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashMessage, g_esSmashPlayer[tank].g_iSmashMessage, g_esSmashSpecial[type][iSpecType - 1].g_iSmashMessage, g_esSmashAbility[type].g_iSmashMessage, 1);
		g_esSmashCache[tank].g_iSmashMode = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashMode, g_esSmashPlayer[tank].g_iSmashMode, g_esSmashSpecial[type][iSpecType - 1].g_iSmashMode, g_esSmashAbility[type].g_iSmashMode, 1);
		g_esSmashCache[tank].g_iSmashRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashRangeCooldown, g_esSmashPlayer[tank].g_iSmashRangeCooldown, g_esSmashSpecial[type][iSpecType - 1].g_iSmashRangeCooldown, g_esSmashAbility[type].g_iSmashRangeCooldown, 1);
		g_esSmashCache[tank].g_iSmashSight = iGetSubSettingValue(apply, bHuman, g_esSmashTeammate[tank][iSpecType - 1].g_iSmashSight, g_esSmashPlayer[tank].g_iSmashSight, g_esSmashSpecial[type][iSpecType - 1].g_iSmashSight, g_esSmashAbility[type].g_iSmashSight, 1);
	}
	else
	{
