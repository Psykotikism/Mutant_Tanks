...
esNecroTeammate g_esNecroTeammate[MAXPLAYERS + 1][6];
...
esNecroSpecial g_esNecroSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN2
void vNecroConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esNecroTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esNecroTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esNecroTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esNecroTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esNecroTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esNecroTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esNecroTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esNecroTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esNecroTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esNecroTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esNecroTeammate[admin][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esNecroTeammate[admin][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esNecroTeammate[admin][specType].g_iHumanMode = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esNecroTeammate[admin][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esNecroTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esNecroTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esNecroTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esNecroTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esNecroTeammate[admin][specType].g_iNecroAbility = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esNecroTeammate[admin][specType].g_iNecroAbility, value, -1, 1, specName, specType);
			g_esNecroTeammate[admin][specType].g_iNecroMessage = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esNecroTeammate[admin][specType].g_iNecroMessage, value, -1, 1, specName, specType);
			g_esNecroTeammate[admin][specType].g_iNecroSight = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esNecroTeammate[admin][specType].g_iNecroSight, value, -1, 2, specName, specType);
			g_esNecroTeammate[admin][specType].g_flNecroChance = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroChance", "Necro Chance", "Necro_Chance", "chance", g_esNecroTeammate[admin][specType].g_flNecroChance, value, -1.0, 100.0, specName, specType);
			g_esNecroTeammate[admin][specType].g_iNecroCooldown = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroCooldown", "Necro Cooldown", "Necro_Cooldown", "cooldown", g_esNecroTeammate[admin][specType].g_iNecroCooldown, value, -1, 99999, specName, specType);
			g_esNecroTeammate[admin][specType].g_iNecroDuration = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroDuration", "Necro Duration", "Necro_Duration", "duration", g_esNecroTeammate[admin][specType].g_iNecroDuration, value, -1, 99999, specName, specType);
			g_esNecroTeammate[admin][specType].g_flNecroRange = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroRange", "Necro Range", "Necro_Range", "range", g_esNecroTeammate[admin][specType].g_flNecroRange, value, -1.0, 99999.0, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esNecroSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esNecroSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esNecroSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esNecroSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esNecroSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esNecroSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esNecroSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esNecroSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esNecroSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esNecroSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esNecroSpecial[type][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esNecroSpecial[type][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esNecroSpecial[type][specType].g_iHumanMode = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esNecroSpecial[type][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esNecroSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esNecroSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esNecroSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esNecroSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esNecroSpecial[type][specType].g_iNecroAbility = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esNecroSpecial[type][specType].g_iNecroAbility, value, -1, 1, specName, specType);
			g_esNecroSpecial[type][specType].g_iNecroMessage = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esNecroSpecial[type][specType].g_iNecroMessage, value, -1, 1, specName, specType);
			g_esNecroSpecial[type][specType].g_iNecroSight = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esNecroSpecial[type][specType].g_iNecroSight, value, -1, 2, specName, specType);
			g_esNecroSpecial[type][specType].g_flNecroChance = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroChance", "Necro Chance", "Necro_Chance", "chance", g_esNecroSpecial[type][specType].g_flNecroChance, value, -1.0, 100.0, specName, specType);
			g_esNecroSpecial[type][specType].g_iNecroCooldown = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroCooldown", "Necro Cooldown", "Necro_Cooldown", "cooldown", g_esNecroSpecial[type][specType].g_iNecroCooldown, value, -1, 99999, specName, specType);
			g_esNecroSpecial[type][specType].g_iNecroDuration = iGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroDuration", "Necro Duration", "Necro_Duration", "duration", g_esNecroSpecial[type][specType].g_iNecroDuration, value, -1, 99999, specName, specType);
			g_esNecroSpecial[type][specType].g_flNecroRange = flGetKeyValue(subsection, MT_NECRO_SECTION, MT_NECRO_SECTION2, MT_NECRO_SECTION3, MT_NECRO_SECTION4, key, "NecroRange", "Necro Range", "Necro_Range", "range", g_esNecroSpecial[type][specType].g_flNecroRange, value, -1.0, 99999.0, specName, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esNecroCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esNecroPlayer[tank].g_flCloseAreasOnly, g_esNecroSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esNecroAbility[type].g_flCloseAreasOnly, 1);
		g_esNecroCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iComboAbility, g_esNecroPlayer[tank].g_iComboAbility, g_esNecroSpecial[type][iSpecType - 1].g_iComboAbility, g_esNecroAbility[type].g_iComboAbility, 1);
		g_esNecroCache[tank].g_flNecroChance = flGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_flNecroChance, g_esNecroPlayer[tank].g_flNecroChance, g_esNecroSpecial[type][iSpecType - 1].g_flNecroChance, g_esNecroAbility[type].g_flNecroChance, 1);
		g_esNecroCache[tank].g_flNecroRange = flGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_flNecroRange, g_esNecroPlayer[tank].g_flNecroRange, g_esNecroSpecial[type][iSpecType - 1].g_flNecroRange, g_esNecroAbility[type].g_flNecroRange, 1);
		g_esNecroCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esNecroPlayer[tank].g_iHumanAbility, g_esNecroSpecial[type][iSpecType - 1].g_iHumanAbility, g_esNecroAbility[type].g_iHumanAbility, 1);
		g_esNecroCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iHumanAmmo, g_esNecroPlayer[tank].g_iHumanAmmo, g_esNecroSpecial[type][iSpecType - 1].g_iHumanAmmo, g_esNecroAbility[type].g_iHumanAmmo, 1);
		g_esNecroCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iHumanCooldown, g_esNecroPlayer[tank].g_iHumanCooldown, g_esNecroSpecial[type][iSpecType - 1].g_iHumanCooldown, g_esNecroAbility[type].g_iHumanCooldown, 1);
		g_esNecroCache[tank].g_iHumanDuration = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iHumanDuration, g_esNecroPlayer[tank].g_iHumanDuration, g_esNecroSpecial[type][iSpecType - 1].g_iHumanDuration, g_esNecroAbility[type].g_iHumanDuration, 1);
		g_esNecroCache[tank].g_iHumanMode = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iHumanMode, g_esNecroPlayer[tank].g_iHumanMode, g_esNecroSpecial[type][iSpecType - 1].g_iHumanMode, g_esNecroAbility[type].g_iHumanMode, 1);
		g_esNecroCache[tank].g_iNecroAbility = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iNecroAbility, g_esNecroPlayer[tank].g_iNecroAbility, g_esNecroSpecial[type][iSpecType - 1].g_iNecroAbility, g_esNecroAbility[type].g_iNecroAbility, 1);
		g_esNecroCache[tank].g_iNecroCooldown = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iNecroCooldown, g_esNecroPlayer[tank].g_iNecroCooldown, g_esNecroSpecial[type][iSpecType - 1].g_iNecroCooldown, g_esNecroAbility[type].g_iNecroCooldown, 1);
		g_esNecroCache[tank].g_iNecroDuration = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iNecroDuration, g_esNecroPlayer[tank].g_iNecroDuration, g_esNecroSpecial[type][iSpecType - 1].g_iNecroDuration, g_esNecroAbility[type].g_iNecroDuration, 1);
		g_esNecroCache[tank].g_iNecroMessage = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iNecroMessage, g_esNecroPlayer[tank].g_iNecroMessage, g_esNecroSpecial[type][iSpecType - 1].g_iNecroMessage, g_esNecroAbility[type].g_iNecroMessage, 1);
		g_esNecroCache[tank].g_iNecroSight = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iNecroSight, g_esNecroPlayer[tank].g_iNecroSight, g_esNecroSpecial[type][iSpecType - 1].g_iNecroSight, g_esNecroAbility[type].g_iNecroSight, 1);
		g_esNecroCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esNecroPlayer[tank].g_flOpenAreasOnly, g_esNecroSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esNecroAbility[type].g_flOpenAreasOnly, 1);
		g_esNecroCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esNecroTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esNecroPlayer[tank].g_iRequiresHumans, g_esNecroSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esNecroAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esNecroCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esNecroCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esNecroPlayer[tank].g_iTankType, tank) || (g_esNecroCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esNecroCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esNecroAbility[g_esNecroPlayer[tank].g_iTankType].g_iAccessFlags, g_esNecroPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
void tTimerNecroCombo(Handle timer, int userid)
{
	...
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esNecroAbility[g_esNecroPlayer[iTank].g_iTankType].g_iAccessFlags, g_esNecroPlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esNecroPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esNecroCache[iTank].g_iNecroAbility == 0 || g_esNecroPlayer[iTank].g_bActivated)
	{
		return;
	}
