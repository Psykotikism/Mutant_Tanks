...
esSmiteTeammate g_esSmiteTeammate[MAXPLAYERS + 1][7];
...
esSmiteSpecial g_esSmiteSpecial[MT_MAXTYPES + 1][7];
	...
	switch (mode)
	{
		case 1:
		{
			for (int iIndex = MT_GetMinType(); iIndex <= MT_GetMaxType(); iIndex++)
			{
				...
				{
					g_esSmiteSpecial[iIndex][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esSmiteSpecial[iIndex][iSpecType].g_iComboAbility = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iHumanAbility = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iHumanAmmo = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iHumanCooldown = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iHumanRangeCooldown = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esSmiteSpecial[iIndex][iSpecType].g_iRequiresHumans = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteAbility = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteEffect = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteMessage = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteBody = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_flSmiteChance = -1.0;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteCooldown = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_flSmiteCountdown = -1.0;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteHit = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteHitMode = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteMode = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_flSmiteRange = -1.0;
					g_esSmiteSpecial[iIndex][iSpecType].g_flSmiteRangeChance = -1.0;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteRangeCooldown = -1;
					g_esSmiteSpecial[iIndex][iSpecType].g_iSmiteSight = -1;
				}
			}
		}
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				...
				for (int iSpecType = 0; iSpecType < (sizeof g_sSpecialNames); iSpecType++)
				{
					g_esSmiteTeammate[iPlayer][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iComboAbility = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iHumanAbility = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iHumanAmmo = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iHumanCooldown = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iHumanRangeCooldown = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iRequiresHumans = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteAbility = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteEffect = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteMessage = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteBody = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_flSmiteChance = -1.0;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteCooldown = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_flSmiteCountdown = -1.0;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteHit = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteHitMode = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteMode = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_flSmiteRange = -1.0;
					g_esSmiteTeammate[iPlayer][iSpecType].g_flSmiteRangeChance = -1.0;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteRangeCooldown = -1;
					g_esSmiteTeammate[iPlayer][iSpecType].g_iSmiteSight = -1;
				}
			}
		}
	}
...
#if defined MT_ABILITIES_MAIN2
void vSmiteConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esSmiteTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esSmiteTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esSmiteTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esSmiteTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esSmiteTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esSmiteTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esSmiteTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esSmiteTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esSmiteTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esSmiteTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esSmiteTeammate[admin][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esSmiteTeammate[admin][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esSmiteTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esSmiteTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esSmiteTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esSmiteTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteAbility = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esSmiteTeammate[admin][specType].g_iSmiteAbility, value, -1, 1, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteEffect = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esSmiteTeammate[admin][specType].g_iSmiteEffect, value, -1, 7, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteMessage = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esSmiteTeammate[admin][specType].g_iSmiteMessage, value, -1, 3, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteSight = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esSmiteTeammate[admin][specType].g_iSmiteSight, value, -1, 2, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteBody = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteBody", "Smite Body", "Smite_Body", "body", g_esSmiteTeammate[admin][specType].g_iSmiteBody, value, -1, 1, specType);
			g_esSmiteTeammate[admin][specType].g_flSmiteChance = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteChance", "Smite Chance", "Smite_Chance", "chance", g_esSmiteTeammate[admin][specType].g_flSmiteChance, value, -1.0, 100.0, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteCooldown", "Smite Cooldown", "Smite_Cooldown", "cooldown", g_esSmiteTeammate[admin][specType].g_iSmiteCooldown, value, -1, 99999, specType);
			g_esSmiteTeammate[admin][specType].g_flSmiteCountdown = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteCountdown", "Smite Countdown", "Smite_Countdown", "countdown", g_esSmiteTeammate[admin][specType].g_flSmiteCountdown, value, -1.0, 99999.0, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteHit = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteHit", "Smite Hit", "Smite_Hit", "hit", g_esSmiteTeammate[admin][specType].g_iSmiteHit, value, -1, 1, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteHitMode = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteHitMode", "Smite Hit Mode", "Smite_Hit_Mode", "hitmode", g_esSmiteTeammate[admin][specType].g_iSmiteHitMode, value, -1, 2, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteMode = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteMode", "Smite Mode", "Smite_Mode", "mode", g_esSmiteTeammate[admin][specType].g_iSmiteMode, value, -1, 3, specType);
			g_esSmiteTeammate[admin][specType].g_flSmiteRange = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteRange", "Smite Range", "Smite_Range", "range", g_esSmiteTeammate[admin][specType].g_flSmiteRange, value, -1.0, 99999.0, specType);
			g_esSmiteTeammate[admin][specType].g_flSmiteRangeChance = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteRangeChance", "Smite Range Chance", "Smite_Range_Chance", "rangechance", g_esSmiteTeammate[admin][specType].g_flSmiteRangeChance, value, -1.0, 100.0, specType);
			g_esSmiteTeammate[admin][specType].g_iSmiteRangeCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteRangeCooldown", "Smite Range Cooldown", "Smite_Range_Cooldown", "rangecooldown", g_esSmiteTeammate[admin][specType].g_iSmiteRangeCooldown, value, -1, 99999, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esSmiteSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esSmiteSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esSmiteSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esSmiteSpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esSmiteSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esSmiteSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esSmiteSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esSmiteSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esSmiteSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esSmiteSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esSmiteSpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esSmiteSpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esSmiteSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esSmiteSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esSmiteSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esSmiteSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteAbility = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esSmiteSpecial[type][specType].g_iSmiteAbility, value, -1, 1, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteEffect = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esSmiteSpecial[type][specType].g_iSmiteEffect, value, -1, 7, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteMessage = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esSmiteSpecial[type][specType].g_iSmiteMessage, value, -1, 3, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteSight = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esSmiteSpecial[type][specType].g_iSmiteSight, value, -1, 2, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteBody = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteBody", "Smite Body", "Smite_Body", "body", g_esSmiteSpecial[type][specType].g_iSmiteBody, value, -1, 1, specType);
			g_esSmiteSpecial[type][specType].g_flSmiteChance = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteChance", "Smite Chance", "Smite_Chance", "chance", g_esSmiteSpecial[type][specType].g_flSmiteChance, value, -1.0, 100.0, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteCooldown", "Smite Cooldown", "Smite_Cooldown", "cooldown", g_esSmiteSpecial[type][specType].g_iSmiteCooldown, value, -1, 99999, specType);
			g_esSmiteSpecial[type][specType].g_flSmiteCountdown = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteCountdown", "Smite Countdown", "Smite_Countdown", "countdown", g_esSmiteSpecial[type][specType].g_flSmiteCountdown, value, -1.0, 99999.0, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteHit = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteHit", "Smite Hit", "Smite_Hit", "hit", g_esSmiteSpecial[type][specType].g_iSmiteHit, value, -1, 1, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteHitMode = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteHitMode", "Smite Hit Mode", "Smite_Hit_Mode", "hitmode", g_esSmiteSpecial[type][specType].g_iSmiteHitMode, value, -1, 2, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteMode = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteMode", "Smite Mode", "Smite_Mode", "mode", g_esSmiteSpecial[type][specType].g_iSmiteMode, value, -1, 3, specType);
			g_esSmiteSpecial[type][specType].g_flSmiteRange = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteRange", "Smite Range", "Smite_Range", "range", g_esSmiteSpecial[type][specType].g_flSmiteRange, value, -1.0, 99999.0, specType);
			g_esSmiteSpecial[type][specType].g_flSmiteRangeChance = flGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteRangeChance", "Smite Range Chance", "Smite_Range_Chance", "rangechance", g_esSmiteSpecial[type][specType].g_flSmiteRangeChance, value, -1.0, 100.0, specType);
			g_esSmiteSpecial[type][specType].g_iSmiteRangeCooldown = iGetKeyValue(subsection, MT_SMITE_SECTION, MT_SMITE_SECTION2, MT_SMITE_SECTION3, MT_SMITE_SECTION4, key, "SmiteRangeCooldown", "Smite Range Cooldown", "Smite_Range_Cooldown", "rangecooldown", g_esSmiteSpecial[type][specType].g_iSmiteRangeCooldown, value, -1, 99999, specType);
		}
		else
		{
...
#endif
{
	...
	g_esSmitePlayer[tank].g_iInfectedType = iGetInfectedType(tank);
	g_esSmitePlayer[tank].g_iTankType = apply ? type : 0;
	int iSpecType = g_esSmitePlayer[tank].g_iInfectedType;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esSmiteCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_flCloseAreasOnly, g_esSmiteTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esSmitePlayer[tank].g_flCloseAreasOnly, g_esSmiteSpecial[type][0].g_flCloseAreasOnly, g_esSmiteSpecial[type][iSpecType].g_flCloseAreasOnly, g_esSmiteAbility[type].g_flCloseAreasOnly, 1);
		g_esSmiteCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iComboAbility, g_esSmiteTeammate[tank][iSpecType].g_iComboAbility, g_esSmitePlayer[tank].g_iComboAbility, g_esSmiteSpecial[type][0].g_iComboAbility, g_esSmiteSpecial[type][iSpecType].g_iComboAbility, g_esSmiteAbility[type].g_iComboAbility, 1);
		g_esSmiteCache[tank].g_flSmiteChance = flGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_flSmiteChance, g_esSmiteTeammate[tank][iSpecType].g_flSmiteChance, g_esSmitePlayer[tank].g_flSmiteChance, g_esSmiteSpecial[type][0].g_flSmiteChance, g_esSmiteSpecial[type][iSpecType].g_flSmiteChance, g_esSmiteAbility[type].g_flSmiteChance, 1);
		g_esSmiteCache[tank].g_flSmiteCountdown = flGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_flSmiteCountdown, g_esSmiteTeammate[tank][iSpecType].g_flSmiteCountdown, g_esSmitePlayer[tank].g_flSmiteCountdown, g_esSmiteSpecial[type][0].g_flSmiteCountdown, g_esSmiteSpecial[type][iSpecType].g_flSmiteCountdown, g_esSmiteAbility[type].g_flSmiteCountdown, 1);
		g_esSmiteCache[tank].g_flSmiteRange = flGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_flSmiteRange, g_esSmiteTeammate[tank][iSpecType].g_flSmiteRange, g_esSmitePlayer[tank].g_flSmiteRange, g_esSmiteSpecial[type][0].g_flSmiteRange, g_esSmiteSpecial[type][iSpecType].g_flSmiteRange, g_esSmiteAbility[type].g_flSmiteRange, 1);
		g_esSmiteCache[tank].g_flSmiteRangeChance = flGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_flSmiteRangeChance, g_esSmiteTeammate[tank][iSpecType].g_flSmiteRangeChance, g_esSmitePlayer[tank].g_flSmiteRangeChance, g_esSmiteSpecial[type][0].g_flSmiteRangeChance, g_esSmiteSpecial[type][iSpecType].g_flSmiteRangeChance, g_esSmiteAbility[type].g_flSmiteRangeChance, 1);
		g_esSmiteCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iHumanAbility, g_esSmiteTeammate[tank][iSpecType].g_iHumanAbility, g_esSmitePlayer[tank].g_iHumanAbility, g_esSmiteSpecial[type][0].g_iHumanAbility, g_esSmiteSpecial[type][iSpecType].g_iHumanAbility, g_esSmiteAbility[type].g_iHumanAbility, 1);
		g_esSmiteCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iHumanAmmo, g_esSmiteTeammate[tank][iSpecType].g_iHumanAmmo, g_esSmitePlayer[tank].g_iHumanAmmo, g_esSmiteSpecial[type][0].g_iHumanAmmo, g_esSmiteSpecial[type][iSpecType].g_iHumanAmmo, g_esSmiteAbility[type].g_iHumanAmmo, 1);
		g_esSmiteCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iHumanCooldown, g_esSmiteTeammate[tank][iSpecType].g_iHumanCooldown, g_esSmitePlayer[tank].g_iHumanCooldown, g_esSmiteSpecial[type][0].g_iHumanCooldown, g_esSmiteSpecial[type][iSpecType].g_iHumanCooldown, g_esSmiteAbility[type].g_iHumanCooldown, 1);
		g_esSmiteCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iHumanRangeCooldown, g_esSmiteTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esSmitePlayer[tank].g_iHumanRangeCooldown, g_esSmiteSpecial[type][0].g_iHumanRangeCooldown, g_esSmiteSpecial[type][iSpecType].g_iHumanRangeCooldown, g_esSmiteAbility[type].g_iHumanRangeCooldown, 1);
		g_esSmiteCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_flOpenAreasOnly, g_esSmiteTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esSmitePlayer[tank].g_flOpenAreasOnly, g_esSmiteSpecial[type][0].g_flOpenAreasOnly, g_esSmiteSpecial[type][iSpecType].g_flOpenAreasOnly, g_esSmiteAbility[type].g_flOpenAreasOnly, 1);
		g_esSmiteCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iRequiresHumans, g_esSmiteTeammate[tank][iSpecType].g_iRequiresHumans, g_esSmitePlayer[tank].g_iRequiresHumans, g_esSmiteSpecial[type][0].g_iRequiresHumans, g_esSmiteSpecial[type][iSpecType].g_iRequiresHumans, g_esSmiteAbility[type].g_iRequiresHumans, 1);
		g_esSmiteCache[tank].g_iSmiteAbility = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteAbility, g_esSmiteTeammate[tank][iSpecType].g_iSmiteAbility, g_esSmitePlayer[tank].g_iSmiteAbility, g_esSmiteSpecial[type][0].g_iSmiteAbility, g_esSmiteSpecial[type][iSpecType].g_iSmiteAbility, g_esSmiteAbility[type].g_iSmiteAbility, 1);
		g_esSmiteCache[tank].g_iSmiteBody = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteBody, g_esSmiteTeammate[tank][iSpecType].g_iSmiteBody, g_esSmitePlayer[tank].g_iSmiteBody, g_esSmiteSpecial[type][0].g_iSmiteBody, g_esSmiteSpecial[type][iSpecType].g_iSmiteBody, g_esSmiteAbility[type].g_iSmiteBody, 1);
		g_esSmiteCache[tank].g_iSmiteCooldown = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteCooldown, g_esSmiteTeammate[tank][iSpecType].g_iSmiteCooldown, g_esSmitePlayer[tank].g_iSmiteCooldown, g_esSmiteSpecial[type][0].g_iSmiteCooldown, g_esSmiteSpecial[type][iSpecType].g_iSmiteCooldown, g_esSmiteAbility[type].g_iSmiteCooldown, 1);
		g_esSmiteCache[tank].g_iSmiteEffect = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteEffect, g_esSmiteTeammate[tank][iSpecType].g_iSmiteEffect, g_esSmitePlayer[tank].g_iSmiteEffect, g_esSmiteSpecial[type][0].g_iSmiteEffect, g_esSmiteSpecial[type][iSpecType].g_iSmiteEffect, g_esSmiteAbility[type].g_iSmiteEffect, 1);
		g_esSmiteCache[tank].g_iSmiteHit = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteHit, g_esSmiteTeammate[tank][iSpecType].g_iSmiteHit, g_esSmitePlayer[tank].g_iSmiteHit, g_esSmiteSpecial[type][0].g_iSmiteHit, g_esSmiteSpecial[type][iSpecType].g_iSmiteHit, g_esSmiteAbility[type].g_iSmiteHit, 1);
		g_esSmiteCache[tank].g_iSmiteHitMode = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteHitMode, g_esSmiteTeammate[tank][iSpecType].g_iSmiteHitMode, g_esSmitePlayer[tank].g_iSmiteHitMode, g_esSmiteSpecial[type][0].g_iSmiteHitMode, g_esSmiteSpecial[type][iSpecType].g_iSmiteHitMode, g_esSmiteAbility[type].g_iSmiteHitMode, 1);
		g_esSmiteCache[tank].g_iSmiteMessage = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteMessage, g_esSmiteTeammate[tank][iSpecType].g_iSmiteMessage, g_esSmitePlayer[tank].g_iSmiteMessage, g_esSmiteSpecial[type][0].g_iSmiteMessage, g_esSmiteSpecial[type][iSpecType].g_iSmiteMessage, g_esSmiteAbility[type].g_iSmiteMessage, 1);
		g_esSmiteCache[tank].g_iSmiteMode = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteMode, g_esSmiteTeammate[tank][iSpecType].g_iSmiteMode, g_esSmitePlayer[tank].g_iSmiteMode, g_esSmiteSpecial[type][0].g_iSmiteMode, g_esSmiteSpecial[type][iSpecType].g_iSmiteMode, g_esSmiteAbility[type].g_iSmiteMode, 1);
		g_esSmiteCache[tank].g_iSmiteRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteRangeCooldown, g_esSmiteTeammate[tank][iSpecType].g_iSmiteRangeCooldown, g_esSmitePlayer[tank].g_iSmiteRangeCooldown, g_esSmiteSpecial[type][0].g_iSmiteRangeCooldown, g_esSmiteSpecial[type][iSpecType].g_iSmiteRangeCooldown, g_esSmiteAbility[type].g_iSmiteRangeCooldown, 1);
		g_esSmiteCache[tank].g_iSmiteSight = iGetSubSettingValue(apply, bHuman, g_esSmiteTeammate[tank][0].g_iSmiteSight, g_esSmiteTeammate[tank][iSpecType].g_iSmiteSight, g_esSmitePlayer[tank].g_iSmiteSight, g_esSmiteSpecial[type][0].g_iSmiteSight, g_esSmiteSpecial[type][iSpecType].g_iSmiteSight, g_esSmiteAbility[type].g_iSmiteSight, 1);
	}
	else
	{
