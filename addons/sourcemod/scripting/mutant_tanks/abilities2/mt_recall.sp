...
esRecallTeammate g_esRecallTeammate[MAXPLAYERS + 1][7];
...
esRecallSpecial g_esRecallSpecial[MT_MAXTYPES + 1][7];
	...
	switch (mode)
	{
		case 1:
		{
			for (int iIndex = MT_GetMinType(); iIndex <= MT_GetMaxType(); iIndex++)
			{
				...
				{
					g_esRecallSpecial[iIndex][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esRecallSpecial[iIndex][iSpecType].g_iHumanAbility = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iHumanAmmo = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iHumanCooldown = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iHumanRangeCooldown = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esRecallSpecial[iIndex][iSpecType].g_iRequiresHumans = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallAbility = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_flRecallBlinkChance = -1.0;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallBlinkCooldown = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallBlinkCount = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_flRecallBlinkRange = -1.0;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallMessage = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_flRecallRewindChance = -1.0;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallRewindCleanse = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallRewindCooldown = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallRewindLifetime = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_iRecallRewindMode = -1;
					g_esRecallSpecial[iIndex][iSpecType].g_flRecallRewindThreshold = -1.0;
				}
			}
		}
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				...
				for (int iSpecType = 0; iSpecType < (sizeof g_sSpecialNames); iSpecType++)
				{
					g_esRecallTeammate[iPlayer][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esRecallTeammate[iPlayer][iSpecType].g_iHumanAbility = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iHumanAmmo = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iHumanCooldown = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iHumanRangeCooldown = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRequiresHumans = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallAbility = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_flRecallBlinkChance = -1.0;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallBlinkCooldown = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallBlinkCount = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_flRecallBlinkRange = -1.0;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallMessage = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_flRecallRewindChance = -1.0;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallRewindCleanse = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallRewindCooldown = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallRewindLifetime = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_iRecallRewindMode = -1;
					g_esRecallTeammate[iPlayer][iSpecType].g_flRecallRewindThreshold = -1.0;
				}
			}
		}
	}
...
#if defined MT_ABILITIES_MAIN2
void vRecallConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esRecallTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esRecallTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esRecallTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esRecallTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esRecallTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esRecallTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esRecallTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esRecallTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esRecallTeammate[admin][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esRecallTeammate[admin][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esRecallTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esRecallTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esRecallTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esRecallTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esRecallTeammate[admin][specType].g_iRecallAbility = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esRecallTeammate[admin][specType].g_iRecallAbility, value, -1, 3, specType);
			g_esRecallTeammate[admin][specType].g_flRecallBlinkChance = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkChance", "Recall Blink Chance", "Recall_Blink_Chance", "blinkchance", g_esRecallTeammate[admin][specType].g_flRecallBlinkChance, value, -1.0, 100.0, specType);
			g_esRecallTeammate[admin][specType].g_iRecallBlinkCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkCooldown", "Recall Blink Cooldown", "Recall_Blink_Cooldown", "blinkcooldown", g_esRecallTeammate[admin][specType].g_iRecallBlinkCooldown, value, -1, 99999, specType);
			g_esRecallTeammate[admin][specType].g_iRecallBlinkCount = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkCount", "Recall Blink Count", "Recall_Blink_Count", "blinkcount", g_esRecallTeammate[admin][specType].g_iRecallBlinkCount, value, -1, 99999, specType);
			g_esRecallTeammate[admin][specType].g_flRecallBlinkRange = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkRange", "Recall Blink Range", "Recall_Blink_Range", "blinkrange", g_esRecallTeammate[admin][specType].g_flRecallBlinkRange, value, -1.0, 99999.0, specType);
			g_esRecallTeammate[admin][specType].g_iRecallMessage = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esRecallTeammate[admin][specType].g_iRecallMessage, value, -1, 1, specType);
			g_esRecallTeammate[admin][specType].g_flRecallRewindChance = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindChance", "Recall Rewind Chance", "Recall_Rewind_Chance", "rewindchance", g_esRecallTeammate[admin][specType].g_flRecallRewindChance, value, -1.0, 100.0, specType);
			g_esRecallTeammate[admin][specType].g_iRecallRewindCleanse = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindCleanse", "Recall Rewind Cleanse", "Recall_Rewind_Cleanse", "rewindcleanse", g_esRecallTeammate[admin][specType].g_iRecallRewindCleanse, value, -1, 1, specType);
			g_esRecallTeammate[admin][specType].g_iRecallRewindCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindCooldown", "Recall Rewind Cooldown", "Recall_Rewind_Cooldown", "rewindcooldown", g_esRecallTeammate[admin][specType].g_iRecallRewindCooldown, value, -1, 99999, specType);
			g_esRecallTeammate[admin][specType].g_iRecallRewindLifetime = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindLifetime", "Recall Rewind Lifetime", "Recall_Rewind_Lifetime", "rewindlifetime", g_esRecallTeammate[admin][specType].g_iRecallRewindLifetime, value, -1, 30, specType);
			g_esRecallTeammate[admin][specType].g_iRecallRewindMode = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindMode", "Recall Rewind Mode", "Recall_Rewind_Mode", "rewindmode", g_esRecallTeammate[admin][specType].g_iRecallRewindMode, value, -1, 2, specType);
			g_esRecallTeammate[admin][specType].g_flRecallRewindThreshold = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindThreshold", "Recall Rewind Threshold", "Recall_Rewind_Threshold", "rewindthreshold", g_esRecallTeammate[admin][specType].g_flRecallRewindThreshold, value, -1.0, 1.0, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esRecallSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esRecallSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esRecallSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esRecallSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esRecallSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esRecallSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esRecallSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esRecallSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esRecallSpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esRecallSpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esRecallSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esRecallSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esRecallSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esRecallSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esRecallSpecial[type][specType].g_iRecallAbility = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esRecallSpecial[type][specType].g_iRecallAbility, value, -1, 3, specType);
			g_esRecallSpecial[type][specType].g_flRecallBlinkChance = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkChance", "Recall Blink Chance", "Recall_Blink_Chance", "blinkchance", g_esRecallSpecial[type][specType].g_flRecallBlinkChance, value, -1.0, 100.0, specType);
			g_esRecallSpecial[type][specType].g_iRecallBlinkCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkCooldown", "Recall Blink Cooldown", "Recall_Blink_Cooldown", "blinkcooldown", g_esRecallSpecial[type][specType].g_iRecallBlinkCooldown, value, -1, 99999, specType);
			g_esRecallSpecial[type][specType].g_iRecallBlinkCount = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkCount", "Recall Blink Count", "Recall_Blink_Count", "blinkcount", g_esRecallSpecial[type][specType].g_iRecallBlinkCount, value, -1, 99999, specType);
			g_esRecallSpecial[type][specType].g_flRecallBlinkRange = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallBlinkRange", "Recall Blink Range", "Recall_Blink_Range", "blinkrange", g_esRecallSpecial[type][specType].g_flRecallBlinkRange, value, -1.0, 99999.0, specType);
			g_esRecallSpecial[type][specType].g_iRecallMessage = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esRecallSpecial[type][specType].g_iRecallMessage, value, -1, 1, specType);
			g_esRecallSpecial[type][specType].g_flRecallRewindChance = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindChance", "Recall Rewind Chance", "Recall_Rewind_Chance", "rewindchance", g_esRecallSpecial[type][specType].g_flRecallRewindChance, value, -1.0, 100.0, specType);
			g_esRecallSpecial[type][specType].g_iRecallRewindCleanse = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindCleanse", "Recall Rewind Cleanse", "Recall_Rewind_Cleanse", "rewindcleanse", g_esRecallSpecial[type][specType].g_iRecallRewindCleanse, value, -1, 1, specType);
			g_esRecallSpecial[type][specType].g_iRecallRewindCooldown = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindCooldown", "Recall Rewind Cooldown", "Recall_Rewind_Cooldown", "rewindcooldown", g_esRecallSpecial[type][specType].g_iRecallRewindCooldown, value, -1, 99999, specType);
			g_esRecallSpecial[type][specType].g_iRecallRewindLifetime = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindLifetime", "Recall Rewind Lifetime", "Recall_Rewind_Lifetime", "rewindlifetime", g_esRecallSpecial[type][specType].g_iRecallRewindLifetime, value, -1, 30, specType);
			g_esRecallSpecial[type][specType].g_iRecallRewindMode = iGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindMode", "Recall Rewind Mode", "Recall_Rewind_Mode", "rewindmode", g_esRecallSpecial[type][specType].g_iRecallRewindMode, value, -1, 2, specType);
			g_esRecallSpecial[type][specType].g_flRecallRewindThreshold = flGetKeyValue(subsection, MT_RECALL_SECTION, MT_RECALL_SECTION2, MT_RECALL_SECTION3, MT_RECALL_SECTION4, key, "RecallRewindThreshold", "Recall Rewind Threshold", "Recall_Rewind_Threshold", "rewindthreshold", g_esRecallSpecial[type][specType].g_flRecallRewindThreshold, value, -1.0, 1.0, specType);
		}
		else
		{
...
#endif
{
	...
	int iSpecType = g_esRecallPlayer[tank].g_iInfectedType;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esRecallCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_flCloseAreasOnly, g_esRecallTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esRecallPlayer[tank].g_flCloseAreasOnly, g_esRecallSpecial[type][0].g_flCloseAreasOnly, g_esRecallSpecial[type][iSpecType].g_flCloseAreasOnly, g_esRecallAbility[type].g_flCloseAreasOnly, 1);
		g_esRecallCache[tank].g_flRecallBlinkChance = flGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_flRecallBlinkChance, g_esRecallTeammate[tank][iSpecType].g_flRecallBlinkChance, g_esRecallPlayer[tank].g_flRecallBlinkChance, g_esRecallSpecial[type][0].g_flRecallBlinkChance, g_esRecallSpecial[type][iSpecType].g_flRecallBlinkChance, g_esRecallAbility[type].g_flRecallBlinkChance, 1);
		g_esRecallCache[tank].g_flRecallBlinkRange = flGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_flRecallBlinkRange, g_esRecallTeammate[tank][iSpecType].g_flRecallBlinkRange, g_esRecallPlayer[tank].g_flRecallBlinkRange, g_esRecallSpecial[type][0].g_flRecallBlinkRange, g_esRecallSpecial[type][iSpecType].g_flRecallBlinkRange, g_esRecallAbility[type].g_flRecallBlinkRange, 1);
		g_esRecallCache[tank].g_flRecallRewindChance = flGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_flRecallRewindChance, g_esRecallTeammate[tank][iSpecType].g_flRecallRewindChance, g_esRecallPlayer[tank].g_flRecallRewindChance, g_esRecallSpecial[type][0].g_flRecallRewindChance, g_esRecallSpecial[type][iSpecType].g_flRecallRewindChance, g_esRecallAbility[type].g_flRecallRewindChance, 1);
		g_esRecallCache[tank].g_flRecallRewindThreshold = flGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_flRecallRewindThreshold, g_esRecallTeammate[tank][iSpecType].g_flRecallRewindThreshold, g_esRecallPlayer[tank].g_flRecallRewindThreshold, g_esRecallSpecial[type][0].g_flRecallRewindThreshold, g_esRecallSpecial[type][iSpecType].g_flRecallRewindThreshold, g_esRecallAbility[type].g_flRecallRewindThreshold, 1);
		g_esRecallCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iHumanAbility, g_esRecallTeammate[tank][iSpecType].g_iHumanAbility, g_esRecallPlayer[tank].g_iHumanAbility, g_esRecallSpecial[type][0].g_iHumanAbility, g_esRecallSpecial[type][iSpecType].g_iHumanAbility, g_esRecallAbility[type].g_iHumanAbility, 1);
		g_esRecallCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iHumanAmmo, g_esRecallTeammate[tank][iSpecType].g_iHumanAmmo, g_esRecallPlayer[tank].g_iHumanAmmo, g_esRecallSpecial[type][0].g_iHumanAmmo, g_esRecallSpecial[type][iSpecType].g_iHumanAmmo, g_esRecallAbility[type].g_iHumanAmmo, 1);
		g_esRecallCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iHumanCooldown, g_esRecallTeammate[tank][iSpecType].g_iHumanCooldown, g_esRecallPlayer[tank].g_iHumanCooldown, g_esRecallSpecial[type][0].g_iHumanCooldown, g_esRecallSpecial[type][iSpecType].g_iHumanCooldown, g_esRecallAbility[type].g_iHumanCooldown, 1);
		g_esRecallCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iHumanRangeCooldown, g_esRecallTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esRecallPlayer[tank].g_iHumanRangeCooldown, g_esRecallSpecial[type][0].g_iHumanRangeCooldown, g_esRecallSpecial[type][iSpecType].g_iHumanRangeCooldown, g_esRecallAbility[type].g_iHumanRangeCooldown, 1);
		g_esRecallCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_flOpenAreasOnly, g_esRecallTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esRecallPlayer[tank].g_flOpenAreasOnly, g_esRecallSpecial[type][0].g_flOpenAreasOnly, g_esRecallSpecial[type][iSpecType].g_flOpenAreasOnly, g_esRecallAbility[type].g_flOpenAreasOnly, 1);
		g_esRecallCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRequiresHumans, g_esRecallTeammate[tank][iSpecType].g_iRequiresHumans, g_esRecallPlayer[tank].g_iRequiresHumans, g_esRecallSpecial[type][0].g_iRequiresHumans, g_esRecallSpecial[type][iSpecType].g_iRequiresHumans, g_esRecallAbility[type].g_iRequiresHumans, 1);
		g_esRecallCache[tank].g_iRecallAbility = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallAbility, g_esRecallTeammate[tank][iSpecType].g_iRecallAbility, g_esRecallPlayer[tank].g_iRecallAbility, g_esRecallSpecial[type][0].g_iRecallAbility, g_esRecallSpecial[type][iSpecType].g_iRecallAbility, g_esRecallAbility[type].g_iRecallAbility, 1);
		g_esRecallCache[tank].g_iRecallBlinkCooldown = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallBlinkCooldown, g_esRecallTeammate[tank][iSpecType].g_iRecallBlinkCooldown, g_esRecallPlayer[tank].g_iRecallBlinkCooldown, g_esRecallSpecial[type][0].g_iRecallBlinkCooldown, g_esRecallSpecial[type][iSpecType].g_iRecallBlinkCooldown, g_esRecallAbility[type].g_iRecallBlinkCooldown, 1);
		g_esRecallCache[tank].g_iRecallBlinkCount = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallBlinkCount, g_esRecallTeammate[tank][iSpecType].g_iRecallBlinkCount, g_esRecallPlayer[tank].g_iRecallBlinkCount, g_esRecallSpecial[type][0].g_iRecallBlinkCount, g_esRecallSpecial[type][iSpecType].g_iRecallBlinkCount, g_esRecallAbility[type].g_iRecallBlinkCount, 1);
		g_esRecallCache[tank].g_iRecallRewindCleanse = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallRewindCleanse, g_esRecallTeammate[tank][iSpecType].g_iRecallRewindCleanse, g_esRecallPlayer[tank].g_iRecallRewindCleanse, g_esRecallSpecial[type][0].g_iRecallRewindCleanse, g_esRecallSpecial[type][iSpecType].g_iRecallRewindCleanse, g_esRecallAbility[type].g_iRecallRewindCleanse, 1);
		g_esRecallCache[tank].g_iRecallRewindCooldown = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallRewindCooldown, g_esRecallTeammate[tank][iSpecType].g_iRecallRewindCooldown, g_esRecallPlayer[tank].g_iRecallRewindCooldown, g_esRecallSpecial[type][0].g_iRecallRewindCooldown, g_esRecallSpecial[type][iSpecType].g_iRecallRewindCooldown, g_esRecallAbility[type].g_iRecallRewindCooldown, 1);
		g_esRecallCache[tank].g_iRecallRewindLifetime = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallRewindLifetime, g_esRecallTeammate[tank][iSpecType].g_iRecallRewindLifetime, g_esRecallPlayer[tank].g_iRecallRewindLifetime, g_esRecallSpecial[type][0].g_iRecallRewindLifetime, g_esRecallSpecial[type][iSpecType].g_iRecallRewindLifetime, g_esRecallAbility[type].g_iRecallRewindLifetime, 1);
		g_esRecallCache[tank].g_iRecallRewindMode = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallRewindMode, g_esRecallTeammate[tank][iSpecType].g_iRecallRewindMode, g_esRecallPlayer[tank].g_iRecallRewindMode, g_esRecallSpecial[type][0].g_iRecallRewindMode, g_esRecallSpecial[type][iSpecType].g_iRecallRewindMode, g_esRecallAbility[type].g_iRecallRewindMode, 1);
		g_esRecallCache[tank].g_iRecallMessage = iGetSubSettingValue(apply, bHuman, g_esRecallTeammate[tank][0].g_iRecallMessage, g_esRecallTeammate[tank][iSpecType].g_iRecallMessage, g_esRecallPlayer[tank].g_iRecallMessage, g_esRecallSpecial[type][0].g_iRecallMessage, g_esRecallSpecial[type][iSpecType].g_iRecallMessage, g_esRecallAbility[type].g_iRecallMessage, 1);
	}
	else
	{
