...
esZombieTeammate g_esZombieTeammate[MAXPLAYERS + 1][6];
...
esZombieSpecial g_esZombieSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN2
void vZombieConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esZombieTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esZombieTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esZombieTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esZombieTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esZombieTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esZombieTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esZombieTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esZombieTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esZombieTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esZombieTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esZombieTeammate[admin][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esZombieTeammate[admin][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esZombieTeammate[admin][specType].g_iHumanMode = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esZombieTeammate[admin][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esZombieTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esZombieTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esZombieTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esZombieTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esZombieTeammate[admin][specType].g_iZombieAbility = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esZombieTeammate[admin][specType].g_iZombieAbility, value, -1, 1, specName, specType);
			g_esZombieTeammate[admin][specType].g_iZombieMessage = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esZombieTeammate[admin][specType].g_iZombieMessage, value, -1, 1, specName, specType);
			g_esZombieTeammate[admin][specType].g_iZombieAmount = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieAmount", "Zombie Amount", "Zombie_Amount", "amount", g_esZombieTeammate[admin][specType].g_iZombieAmount, value, -1, 100, specName, specType);
			g_esZombieTeammate[admin][specType].g_flZombieChance = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieChance", "Zombie Chance", "Zombie_Chance", "chance", g_esZombieTeammate[admin][specType].g_flZombieChance, value, -1.0, 100.0, specName, specType);
			g_esZombieTeammate[admin][specType].g_iZombieCooldown = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieCooldown", "Zombie Cooldown", "Zombie_Cooldown", "cooldown", g_esZombieTeammate[admin][specType].g_iZombieCooldown, value, -1, 99999, specName, specType);
			g_esZombieTeammate[admin][specType].g_iZombieDuration = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieDuration", "Zombie Duration", "Zombie_Duration", "duration", g_esZombieTeammate[admin][specType].g_iZombieDuration, value, -1, 99999, specName, specType);
			g_esZombieTeammate[admin][specType].g_flZombieInterval = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieInterval", "Zombie Interval", "Zombie_Interval", "interval", g_esZombieTeammate[admin][specType].g_flZombieInterval, value, -1.0, 99999.0, specName, specType);
			g_esZombieTeammate[admin][specType].g_iZombieMode = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieMode", "Zombie Mode", "Zombie_Mode", "mode", g_esZombieTeammate[admin][specType].g_iZombieMode, value, -1, 2, specName, specType);
			g_esZombieTeammate[admin][specType].g_iZombieType = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieType", "Zombie Type", "Zombie_Type", "type", g_esZombieTeammate[admin][specType].g_iZombieType, value, -1, 127, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esZombieSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esZombieSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esZombieSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esZombieSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esZombieSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esZombieSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esZombieSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esZombieSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esZombieSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esZombieSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esZombieSpecial[type][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esZombieSpecial[type][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esZombieSpecial[type][specType].g_iHumanMode = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esZombieSpecial[type][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esZombieSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esZombieSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esZombieSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esZombieSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esZombieSpecial[type][specType].g_iZombieAbility = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esZombieSpecial[type][specType].g_iZombieAbility, value, -1, 1, specName, specType);
			g_esZombieSpecial[type][specType].g_iZombieMessage = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esZombieSpecial[type][specType].g_iZombieMessage, value, -1, 1, specName, specType);
			g_esZombieSpecial[type][specType].g_iZombieAmount = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieAmount", "Zombie Amount", "Zombie_Amount", "amount", g_esZombieSpecial[type][specType].g_iZombieAmount, value, -1, 100, specName, specType);
			g_esZombieSpecial[type][specType].g_flZombieChance = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieChance", "Zombie Chance", "Zombie_Chance", "chance", g_esZombieSpecial[type][specType].g_flZombieChance, value, -1.0, 100.0, specName, specType);
			g_esZombieSpecial[type][specType].g_iZombieCooldown = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieCooldown", "Zombie Cooldown", "Zombie_Cooldown", "cooldown", g_esZombieSpecial[type][specType].g_iZombieCooldown, value, -1, 99999, specName, specType);
			g_esZombieSpecial[type][specType].g_iZombieDuration = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieDuration", "Zombie Duration", "Zombie_Duration", "duration", g_esZombieSpecial[type][specType].g_iZombieDuration, value, -1, 99999, specName, specType);
			g_esZombieSpecial[type][specType].g_flZombieInterval = flGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieInterval", "Zombie Interval", "Zombie_Interval", "interval", g_esZombieSpecial[type][specType].g_flZombieInterval, value, -1.0, 99999.0, specName, specType);
			g_esZombieSpecial[type][specType].g_iZombieMode = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieMode", "Zombie Mode", "Zombie_Mode", "mode", g_esZombieSpecial[type][specType].g_iZombieMode, value, -1, 2, specName, specType);
			g_esZombieSpecial[type][specType].g_iZombieType = iGetKeyValue(subsection, MT_ZOMBIE_SECTION, MT_ZOMBIE_SECTION2, MT_ZOMBIE_SECTION3, MT_ZOMBIE_SECTION4, key, "ZombieType", "Zombie Type", "Zombie_Type", "type", g_esZombieSpecial[type][specType].g_iZombieType, value, -1, 127, specName, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esZombieCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esZombiePlayer[tank].g_flCloseAreasOnly, g_esZombieSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esZombieAbility[type].g_flCloseAreasOnly, 1);
		g_esZombieCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iComboAbility, g_esZombiePlayer[tank].g_iComboAbility, g_esZombieSpecial[type][iSpecType - 1].g_iComboAbility, g_esZombieAbility[type].g_iComboAbility, 1);
		g_esZombieCache[tank].g_flZombieChance = flGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_flZombieChance, g_esZombiePlayer[tank].g_flZombieChance, g_esZombieSpecial[type][iSpecType - 1].g_flZombieChance, g_esZombieAbility[type].g_flZombieChance, 1);
		g_esZombieCache[tank].g_flZombieInterval = flGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_flZombieInterval, g_esZombiePlayer[tank].g_flZombieInterval, g_esZombieSpecial[type][iSpecType - 1].g_flZombieInterval, g_esZombieAbility[type].g_flZombieInterval, 1);
		g_esZombieCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esZombiePlayer[tank].g_iHumanAbility, g_esZombieSpecial[type][iSpecType - 1].g_iHumanAbility, g_esZombieAbility[type].g_iHumanAbility, 1);
		g_esZombieCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iHumanAmmo, g_esZombiePlayer[tank].g_iHumanAmmo, g_esZombieSpecial[type][iSpecType - 1].g_iHumanAmmo, g_esZombieAbility[type].g_iHumanAmmo, 1);
		g_esZombieCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iHumanCooldown, g_esZombiePlayer[tank].g_iHumanCooldown, g_esZombieSpecial[type][iSpecType - 1].g_iHumanCooldown, g_esZombieAbility[type].g_iHumanCooldown, 1);
		g_esZombieCache[tank].g_iHumanDuration = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iHumanDuration, g_esZombiePlayer[tank].g_iHumanDuration, g_esZombieSpecial[type][iSpecType - 1].g_iHumanDuration, g_esZombieAbility[type].g_iHumanDuration, 1);
		g_esZombieCache[tank].g_iHumanMode = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iHumanMode, g_esZombiePlayer[tank].g_iHumanMode, g_esZombieSpecial[type][iSpecType - 1].g_iHumanMode, g_esZombieAbility[type].g_iHumanMode, 1);
		g_esZombieCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esZombiePlayer[tank].g_flOpenAreasOnly, g_esZombieSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esZombieAbility[type].g_flOpenAreasOnly, 1);
		g_esZombieCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esZombiePlayer[tank].g_iRequiresHumans, g_esZombieSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esZombieAbility[type].g_iRequiresHumans, 1);
		g_esZombieCache[tank].g_iZombieAbility = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iZombieAbility, g_esZombiePlayer[tank].g_iZombieAbility, g_esZombieSpecial[type][iSpecType - 1].g_iZombieAbility, g_esZombieAbility[type].g_iZombieAbility, 1);
		g_esZombieCache[tank].g_iZombieAmount = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iZombieAmount, g_esZombiePlayer[tank].g_iZombieAmount, g_esZombieSpecial[type][iSpecType - 1].g_iZombieAmount, g_esZombieAbility[type].g_iZombieAmount, 1);
		g_esZombieCache[tank].g_iZombieCooldown = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iZombieCooldown, g_esZombiePlayer[tank].g_iZombieCooldown, g_esZombieSpecial[type][iSpecType - 1].g_iZombieCooldown, g_esZombieAbility[type].g_iZombieCooldown, 1);
		g_esZombieCache[tank].g_iZombieDuration = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iZombieDuration, g_esZombiePlayer[tank].g_iZombieDuration, g_esZombieSpecial[type][iSpecType - 1].g_iZombieDuration, g_esZombieAbility[type].g_iZombieDuration, 1);
		g_esZombieCache[tank].g_iZombieMessage = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iZombieMessage, g_esZombiePlayer[tank].g_iZombieMessage, g_esZombieSpecial[type][iSpecType - 1].g_iZombieMessage, g_esZombieAbility[type].g_iZombieMessage, 1);
		g_esZombieCache[tank].g_iZombieMode = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iZombieMode, g_esZombiePlayer[tank].g_iZombieMode, g_esZombieSpecial[type][iSpecType - 1].g_iZombieMode, g_esZombieAbility[type].g_iZombieMode, 1);
		g_esZombieCache[tank].g_iZombieType = iGetSubSettingValue(apply, bHuman, g_esZombieTeammate[tank][iSpecType - 1].g_iZombieType, g_esZombiePlayer[tank].g_iZombieType, g_esZombieSpecial[type][iSpecType - 1].g_iZombieType, g_esZombieAbility[type].g_iZombieType, 1);
	}
	else
	{
