...
esEnforceTeammate g_esEnforceTeammate[MAXPLAYERS + 1][6];
...
esEnforceSpecial g_esEnforceSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN
void vEnforceConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esEnforceTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esEnforceTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esEnforceTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esEnforceTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esEnforceTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esEnforceTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			...
			g_esEnforceTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esEnforceTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esEnforceTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceAbility = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esEnforceTeammate[admin][specType].g_iEnforceAbility, value, -1, 1, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceEffect = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esEnforceTeammate[admin][specType].g_iEnforceEffect, value, -1, 7, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceMessage = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esEnforceTeammate[admin][specType].g_iEnforceMessage, value, -1, 3, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceSight = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esEnforceTeammate[admin][specType].g_iEnforceSight, value, -1, 2, specName, specType);
			g_esEnforceTeammate[admin][specType].g_flEnforceChance = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceChance", "Enforce Chance", "Enforce_Chance", "chance", g_esEnforceTeammate[admin][specType].g_flEnforceChance, value, -1.0, 100.0, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceCooldown = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceCooldown", "Enforce Cooldown", "Enforce_Cooldown", "cooldown", g_esEnforceTeammate[admin][specType].g_iEnforceCooldown, value, -1, 99999, specName, specType);
			g_esEnforceTeammate[admin][specType].g_flEnforceDuration = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceDuration", "Enforce Duration", "Enforce_Duration", "duration", g_esEnforceTeammate[admin][specType].g_flEnforceDuration, value, -1.0, 99999.0, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceHit = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceHit", "Enforce Hit", "Enforce_Hit", "hit", g_esEnforceTeammate[admin][specType].g_iEnforceHit, value, -1, 1, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceHitMode = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceHitMode", "Enforce Hit Mode", "Enforce_Hit_Mode", "hitmode", g_esEnforceTeammate[admin][specType].g_iEnforceHitMode, value, -1, 2, specName, specType);
			g_esEnforceTeammate[admin][specType].g_flEnforceRange = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceRange", "Enforce Range", "Enforce_Range", "range", g_esEnforceTeammate[admin][specType].g_flEnforceRange, value, -1.0, 99999.0, specName, specType);
			g_esEnforceTeammate[admin][specType].g_flEnforceRangeChance = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceRangeChance", "Enforce Range Chance", "Enforce_Range_Chance", "rangechance", g_esEnforceTeammate[admin][specType].g_flEnforceRangeChance, value, -1.0, 100.0, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceRangeCooldown = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceRangeCooldown", "Enforce Range Cooldown", "Enforce_Range_Cooldown", "rangecooldown", g_esEnforceTeammate[admin][specType].g_iEnforceRangeCooldown, value, -1, 99999, specName, specType);
			g_esEnforceTeammate[admin][specType].g_iEnforceWeaponSlots = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceWeaponSlots", "Enforce Weapon Slots", "Enforce_Weapon_Slots", "slots", g_esEnforceTeammate[admin][specType].g_iEnforceWeaponSlots, value, -1, 31, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esEnforceSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esEnforceSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esEnforceSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esEnforceSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esEnforceSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esEnforceSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esEnforceSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esEnforceSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esEnforceSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esEnforceSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			...
			g_esEnforceSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esEnforceSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esEnforceSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esEnforceSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceAbility = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esEnforceSpecial[type][specType].g_iEnforceAbility, value, -1, 1, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceEffect = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esEnforceSpecial[type][specType].g_iEnforceEffect, value, -1, 7, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceMessage = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esEnforceSpecial[type][specType].g_iEnforceMessage, value, -1, 3, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceSight = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esEnforceSpecial[type][specType].g_iEnforceSight, value, -1, 2, specName, specType);
			g_esEnforceSpecial[type][specType].g_flEnforceChance = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceChance", "Enforce Chance", "Enforce_Chance", "chance", g_esEnforceSpecial[type][specType].g_flEnforceChance, value, -1.0, 100.0, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceCooldown = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceCooldown", "Enforce Cooldown", "Enforce_Cooldown", "cooldown", g_esEnforceSpecial[type][specType].g_iEnforceCooldown, value, -1, 99999, specName, specType);
			g_esEnforceSpecial[type][specType].g_flEnforceDuration = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceDuration", "Enforce Duration", "Enforce_Duration", "duration", g_esEnforceSpecial[type][specType].g_flEnforceDuration, value, -1.0, 99999.0, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceHit = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceHit", "Enforce Hit", "Enforce_Hit", "hit", g_esEnforceSpecial[type][specType].g_iEnforceHit, value, -1, 1, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceHitMode = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceHitMode", "Enforce Hit Mode", "Enforce_Hit_Mode", "hitmode", g_esEnforceSpecial[type][specType].g_iEnforceHitMode, value, -1, 2, specName, specType);
			g_esEnforceSpecial[type][specType].g_flEnforceRange = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceRange", "Enforce Range", "Enforce_Range", "range", g_esEnforceSpecial[type][specType].g_flEnforceRange, value, -1.0, 99999.0, specName, specType);
			g_esEnforceSpecial[type][specType].g_flEnforceRangeChance = flGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceRangeChance", "Enforce Range Chance", "Enforce_Range_Chance", "rangechance", g_esEnforceSpecial[type][specType].g_flEnforceRangeChance, value, -1.0, 100.0, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceRangeCooldown = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceRangeCooldown", "Enforce Range Cooldown", "Enforce_Range_Cooldown", "rangecooldown", g_esEnforceSpecial[type][specType].g_iEnforceRangeCooldown, value, -1, 99999, specName, specType);
			g_esEnforceSpecial[type][specType].g_iEnforceWeaponSlots = iGetKeyValue(subsection, MT_ENFORCE_SECTION, MT_ENFORCE_SECTION2, MT_ENFORCE_SECTION3, MT_ENFORCE_SECTION4, key, "EnforceWeaponSlots", "Enforce Weapon Slots", "Enforce_Weapon_Slots", "slots", g_esEnforceSpecial[type][specType].g_iEnforceWeaponSlots, value, -1, 31, specName, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esEnforceCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esEnforcePlayer[tank].g_flCloseAreasOnly, g_esEnforceSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esEnforceAbility[type].g_flCloseAreasOnly, 1);
		g_esEnforceCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iComboAbility, g_esEnforcePlayer[tank].g_iComboAbility, g_esEnforceSpecial[type][iSpecType - 1].g_iComboAbility, g_esEnforceAbility[type].g_iComboAbility, 1);
		g_esEnforceCache[tank].g_flEnforceChance = flGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_flEnforceChance, g_esEnforcePlayer[tank].g_flEnforceChance, g_esEnforceSpecial[type][iSpecType - 1].g_flEnforceChance, g_esEnforceAbility[type].g_flEnforceChance, 1);
		g_esEnforceCache[tank].g_flEnforceDuration = flGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_flEnforceDuration, g_esEnforcePlayer[tank].g_flEnforceDuration, g_esEnforceSpecial[type][iSpecType - 1].g_flEnforceDuration, g_esEnforceAbility[type].g_flEnforceDuration, 1);
		g_esEnforceCache[tank].g_flEnforceRange = flGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_flEnforceRange, g_esEnforcePlayer[tank].g_flEnforceRange, g_esEnforceSpecial[type][iSpecType - 1].g_flEnforceRange, g_esEnforceAbility[type].g_flEnforceRange, 1);
		g_esEnforceCache[tank].g_flEnforceRangeChance = flGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_flEnforceRangeChance, g_esEnforcePlayer[tank].g_flEnforceRangeChance, g_esEnforceSpecial[type][iSpecType - 1].g_flEnforceRangeChance, g_esEnforceAbility[type].g_flEnforceRangeChance, 1);
		g_esEnforceCache[tank].g_iEnforceAbility = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceAbility, g_esEnforcePlayer[tank].g_iEnforceAbility, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceAbility, g_esEnforceAbility[type].g_iEnforceAbility, 1);
		g_esEnforceCache[tank].g_iEnforceCooldown = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceCooldown, g_esEnforcePlayer[tank].g_iEnforceCooldown, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceCooldown, g_esEnforceAbility[type].g_iEnforceCooldown, 1);
		g_esEnforceCache[tank].g_iEnforceEffect = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceEffect, g_esEnforcePlayer[tank].g_iEnforceEffect, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceEffect, g_esEnforceAbility[type].g_iEnforceEffect, 1);
		g_esEnforceCache[tank].g_iEnforceHit = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceHit, g_esEnforcePlayer[tank].g_iEnforceHit, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceHit, g_esEnforceAbility[type].g_iEnforceHit, 1);
		g_esEnforceCache[tank].g_iEnforceHitMode = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceHitMode, g_esEnforcePlayer[tank].g_iEnforceHitMode, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceHitMode, g_esEnforceAbility[type].g_iEnforceHitMode, 1);
		g_esEnforceCache[tank].g_iEnforceMessage = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceMessage, g_esEnforcePlayer[tank].g_iEnforceMessage, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceMessage, g_esEnforceAbility[type].g_iEnforceMessage, 1);
		g_esEnforceCache[tank].g_iEnforceRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceRangeCooldown, g_esEnforcePlayer[tank].g_iEnforceRangeCooldown, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceRangeCooldown, g_esEnforceAbility[type].g_iEnforceRangeCooldown, 1);
		g_esEnforceCache[tank].g_iEnforceSight = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceSight, g_esEnforcePlayer[tank].g_iEnforceSight, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceSight, g_esEnforceAbility[type].g_iEnforceSight, 1);
		g_esEnforceCache[tank].g_iEnforceWeaponSlots = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iEnforceWeaponSlots, g_esEnforcePlayer[tank].g_iEnforceWeaponSlots, g_esEnforceSpecial[type][iSpecType - 1].g_iEnforceWeaponSlots, g_esEnforceAbility[type].g_iEnforceWeaponSlots, 1);
		g_esEnforceCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esEnforcePlayer[tank].g_iHumanAbility, g_esEnforceSpecial[type][iSpecType - 1].g_iHumanAbility, g_esEnforceAbility[type].g_iHumanAbility, 1);
		g_esEnforceCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iHumanAmmo, g_esEnforcePlayer[tank].g_iHumanAmmo, g_esEnforceSpecial[type][iSpecType - 1].g_iHumanAmmo, g_esEnforceAbility[type].g_iHumanAmmo, 1);
		g_esEnforceCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iHumanCooldown, g_esEnforcePlayer[tank].g_iHumanCooldown, g_esEnforceSpecial[type][iSpecType - 1].g_iHumanCooldown, g_esEnforceAbility[type].g_iHumanCooldown, 1);
		g_esEnforceCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iHumanRangeCooldown, g_esEnforcePlayer[tank].g_iHumanRangeCooldown, g_esEnforceSpecial[type][iSpecType - 1].g_iHumanRangeCooldown, g_esEnforceAbility[type].g_iHumanRangeCooldown, 1);
		g_esEnforceCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esEnforcePlayer[tank].g_flOpenAreasOnly, g_esEnforceSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esEnforceAbility[type].g_flOpenAreasOnly, 1);
		g_esEnforceCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esEnforceTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esEnforcePlayer[tank].g_iRequiresHumans, g_esEnforceSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esEnforceAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esEnforceCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esEnforceCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esEnforcePlayer[tank].g_iTankType, tank) || (g_esEnforceCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esEnforceCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esEnforceAbility[g_esEnforcePlayer[tank].g_iTankType].g_iAccessFlags, g_esEnforcePlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
void tTimerEnforceCombo(Handle timer, DataPack pack)
{
	...
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esEnforceAbility[g_esEnforcePlayer[iTank].g_iTankType].g_iAccessFlags, g_esEnforcePlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esEnforcePlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esEnforceCache[iTank].g_iEnforceAbility == 0)
	{
		return;
	}
