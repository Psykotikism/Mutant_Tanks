...
esAmmoTeammate g_esAmmoTeammate[MAXPLAYERS + 1][6];
...
esAmmoSpecial g_esAmmoSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN
void vAmmoConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esAmmoTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esAmmoTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esAmmoTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esAmmoTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esAmmoTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esAmmoTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			...
			g_esAmmoTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esAmmoTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esAmmoTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoAbility = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esAmmoTeammate[admin][specType].g_iAmmoAbility, value, -1, 1, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoEffect = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esAmmoTeammate[admin][specType].g_iAmmoEffect, value, -1, 7, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoMessage = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esAmmoTeammate[admin][specType].g_iAmmoMessage, value, -1, 3, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoSight = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esAmmoTeammate[admin][specType].g_iAmmoSight, value, -1, 2, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoAmount = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoCount", "Ammo Count", "Ammo_Count", "count", g_esAmmoTeammate[admin][specType].g_iAmmoAmount, value, -1, 100, specName, specType);
			g_esAmmoTeammate[admin][specType].g_flAmmoChance = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoChance", "Ammo Chance", "Ammo_Chance", "chance", g_esAmmoTeammate[admin][specType].g_flAmmoChance, value, -1.0, 100.0, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoCooldown = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoCooldown", "Ammo Cooldown", "Ammo_Cooldown", "cooldown", g_esAmmoTeammate[admin][specType].g_iAmmoCooldown, value, -1, 99999, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoHit = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoHit", "Ammo Hit", "Ammo_Hit", "hit", g_esAmmoTeammate[admin][specType].g_iAmmoHit, value, -1, 1, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoHitMode = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoHitMode", "Ammo Hit Mode", "Ammo_Hit_Mode", "hitmode", g_esAmmoTeammate[admin][specType].g_iAmmoHitMode, value, -1, 2, specName, specType);
			g_esAmmoTeammate[admin][specType].g_flAmmoRange = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoRange", "Ammo Range", "Ammo_Range", "range", g_esAmmoTeammate[admin][specType].g_flAmmoRange, value, -1.0, 99999.0, specName, specType);
			g_esAmmoTeammate[admin][specType].g_flAmmoRangeChance = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoRangeChance", "Ammo Range Chance", "Ammo_Range_Chance", "rangechance", g_esAmmoTeammate[admin][specType].g_flAmmoRangeChance, value, -1.0, 100.0, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoRangeCooldown = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoRangeCooldown", "Ammo Range Cooldown", "Ammo_Range_Cooldown", "rangecooldown", g_esAmmoTeammate[admin][specType].g_iAmmoRangeCooldown, value, -1, 99999, specName, specType);
			g_esAmmoTeammate[admin][specType].g_iAmmoType = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoType", "Ammo Type", "Ammo_Type", "type", g_esAmmoTeammate[admin][specType].g_iAmmoType, value, -1, 3, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esAmmoSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esAmmoSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esAmmoSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esAmmoSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esAmmoSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esAmmoSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esAmmoSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esAmmoSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esAmmoSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esAmmoSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esAmmoSpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esAmmoSpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specName, specType);
			g_esAmmoSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esAmmoSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esAmmoSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esAmmoSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoAbility = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esAmmoSpecial[type][specType].g_iAmmoAbility, value, -1, 1, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoEffect = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esAmmoSpecial[type][specType].g_iAmmoEffect, value, -1, 7, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoMessage = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esAmmoSpecial[type][specType].g_iAmmoMessage, value, -1, 3, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoSight = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esAmmoSpecial[type][specType].g_iAmmoSight, value, -1, 2, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoAmount = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoCount", "Ammo Count", "Ammo_Count", "count", g_esAmmoSpecial[type][specType].g_iAmmoAmount, value, -1, 100, specName, specType);
			g_esAmmoSpecial[type][specType].g_flAmmoChance = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoChance", "Ammo Chance", "Ammo_Chance", "chance", g_esAmmoSpecial[type][specType].g_flAmmoChance, value, -1.0, 100.0, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoCooldown = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoCooldown", "Ammo Cooldown", "Ammo_Cooldown", "cooldown", g_esAmmoSpecial[type][specType].g_iAmmoCooldown, value, -1, 99999, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoHit = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoHit", "Ammo Hit", "Ammo_Hit", "hit", g_esAmmoSpecial[type][specType].g_iAmmoHit, value, -1, 1, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoHitMode = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoHitMode", "Ammo Hit Mode", "Ammo_Hit_Mode", "hitmode", g_esAmmoSpecial[type][specType].g_iAmmoHitMode, value, -1, 2, specName, specType);
			g_esAmmoSpecial[type][specType].g_flAmmoRange = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoRange", "Ammo Range", "Ammo_Range", "range", g_esAmmoSpecial[type][specType].g_flAmmoRange, value, -1.0, 99999.0, specName, specType);
			g_esAmmoSpecial[type][specType].g_flAmmoRangeChance = flGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoRangeChance", "Ammo Range Chance", "Ammo_Range_Chance", "rangechance", g_esAmmoSpecial[type][specType].g_flAmmoRangeChance, value, -1.0, 100.0, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoRangeCooldown = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoRangeCooldown", "Ammo Range Cooldown", "Ammo_Range_Cooldown", "rangecooldown", g_esAmmoSpecial[type][specType].g_iAmmoRangeCooldown, value, -1, 99999, specName, specType);
			g_esAmmoSpecial[type][specType].g_iAmmoType = iGetKeyValue(subsection, MT_AMMO_SECTION, MT_AMMO_SECTION2, MT_AMMO_SECTION3, MT_AMMO_SECTION4, key, "AmmoType", "Ammo Type", "Ammo_Type", "type", g_esAmmoSpecial[type][specType].g_iAmmoType, value, -1, 3, specName, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esAmmoCache[tank].g_flAmmoChance = flGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_flAmmoChance, g_esAmmoPlayer[tank].g_flAmmoChance, g_esAmmoSpecial[type][iSpecType - 1].g_flAmmoChance, g_esAmmoAbility[type].g_flAmmoChance, 1);
		g_esAmmoCache[tank].g_flAmmoRange = flGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_flAmmoRange, g_esAmmoPlayer[tank].g_flAmmoRange, g_esAmmoSpecial[type][iSpecType - 1].g_flAmmoRange, g_esAmmoAbility[type].g_flAmmoRange, 1);
		g_esAmmoCache[tank].g_flAmmoRangeChance = flGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_flAmmoRangeChance, g_esAmmoPlayer[tank].g_flAmmoRangeChance, g_esAmmoSpecial[type][iSpecType - 1].g_flAmmoRangeChance, g_esAmmoAbility[type].g_flAmmoRangeChance, 1);
		g_esAmmoCache[tank].g_iAmmoAbility = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoAbility, g_esAmmoPlayer[tank].g_iAmmoAbility, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoAbility, g_esAmmoAbility[type].g_iAmmoAbility, 1);
		g_esAmmoCache[tank].g_iAmmoAmount = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoAmount, g_esAmmoPlayer[tank].g_iAmmoAmount, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoAmount, g_esAmmoAbility[type].g_iAmmoAmount, 1);
		g_esAmmoCache[tank].g_iAmmoCooldown = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoCooldown, g_esAmmoPlayer[tank].g_iAmmoCooldown, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoCooldown, g_esAmmoAbility[type].g_iAmmoCooldown, 1);
		g_esAmmoCache[tank].g_iAmmoEffect = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoEffect, g_esAmmoPlayer[tank].g_iAmmoEffect, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoEffect, g_esAmmoAbility[type].g_iAmmoEffect, 1);
		g_esAmmoCache[tank].g_iAmmoHit = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoHit, g_esAmmoPlayer[tank].g_iAmmoHit, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoHit, g_esAmmoAbility[type].g_iAmmoHit, 1);
		g_esAmmoCache[tank].g_iAmmoHitMode = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoHitMode, g_esAmmoPlayer[tank].g_iAmmoHitMode, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoHitMode, g_esAmmoAbility[type].g_iAmmoHitMode, 1);
		g_esAmmoCache[tank].g_iAmmoMessage = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoMessage, g_esAmmoPlayer[tank].g_iAmmoMessage, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoMessage, g_esAmmoAbility[type].g_iAmmoMessage, 1);
		g_esAmmoCache[tank].g_iAmmoRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoRangeCooldown, g_esAmmoPlayer[tank].g_iAmmoRangeCooldown, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoRangeCooldown, g_esAmmoAbility[type].g_iAmmoRangeCooldown, 1);
		g_esAmmoCache[tank].g_iAmmoSight = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoSight, g_esAmmoPlayer[tank].g_iAmmoSight, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoSight, g_esAmmoAbility[type].g_iAmmoSight, 1);
		g_esAmmoCache[tank].g_iAmmoType = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iAmmoType, g_esAmmoPlayer[tank].g_iAmmoType, g_esAmmoSpecial[type][iSpecType - 1].g_iAmmoType, g_esAmmoAbility[type].g_iAmmoType, 1);
		g_esAmmoCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esAmmoPlayer[tank].g_flCloseAreasOnly, g_esAmmoSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esAmmoAbility[type].g_flCloseAreasOnly, 1);
		g_esAmmoCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iComboAbility, g_esAmmoPlayer[tank].g_iComboAbility, g_esAmmoSpecial[type][iSpecType - 1].g_iComboAbility, g_esAmmoAbility[type].g_iComboAbility, 1);
		g_esAmmoCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esAmmoPlayer[tank].g_iHumanAbility, g_esAmmoSpecial[type][iSpecType - 1].g_iHumanAbility, g_esAmmoAbility[type].g_iHumanAbility, 1);
		g_esAmmoCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iHumanAmmo, g_esAmmoPlayer[tank].g_iHumanAmmo, g_esAmmoSpecial[type][iSpecType - 1].g_iHumanAmmo, g_esAmmoAbility[type].g_iHumanAmmo, 1);
		g_esAmmoCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iHumanCooldown, g_esAmmoPlayer[tank].g_iHumanCooldown, g_esAmmoSpecial[type][iSpecType - 1].g_iHumanCooldown, g_esAmmoAbility[type].g_iHumanCooldown, 1);
		g_esAmmoCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iHumanRangeCooldown, g_esAmmoPlayer[tank].g_iHumanRangeCooldown, g_esAmmoSpecial[type][iSpecType - 1].g_iHumanRangeCooldown, g_esAmmoAbility[type].g_iHumanRangeCooldown, 1);
		g_esAmmoCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esAmmoPlayer[tank].g_flOpenAreasOnly, g_esAmmoSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esAmmoAbility[type].g_flOpenAreasOnly, 1);
		g_esAmmoCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esAmmoTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esAmmoPlayer[tank].g_iRequiresHumans, g_esAmmoSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esAmmoAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
