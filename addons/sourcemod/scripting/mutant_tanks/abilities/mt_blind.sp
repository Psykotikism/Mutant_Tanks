...
esBlindTeammate g_esBlindTeammate[MAXPLAYERS + 1][7];
...
esBlindSpecial g_esBlindSpecial[MT_MAXTYPES + 1][7];
	...
	switch (mode)
	{
		case 1:
		{
			for (int iIndex = MT_GetMinType(); iIndex <= MT_GetMaxType(); iIndex++)
			{
				...
				{
					g_esBlindSpecial[iIndex][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esBlindSpecial[iIndex][iSpecType].g_iComboAbility = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iHumanAbility = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iHumanAmmo = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iHumanCooldown = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iHumanRangeCooldown = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esBlindSpecial[iIndex][iSpecType].g_iRequiresHumans = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindAbility = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindEffect = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindMessage = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_flBlindChance = -1.0;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindCooldown = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_flBlindDuration = -1.0;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindHit = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindHitMode = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindIntensity = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindMode = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_flBlindRange = -1.0;
					g_esBlindSpecial[iIndex][iSpecType].g_flBlindRangeChance = -1.0;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindRangeCooldown = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindSight = -1;
					g_esBlindSpecial[iIndex][iSpecType].g_iBlindStagger = -1;
				}
			}
		}
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				...
				for (int iSpecType = 0; iSpecType < (sizeof g_sSpecialNames); iSpecType++)
				{
					g_esBlindTeammate[iPlayer][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esBlindTeammate[iPlayer][iSpecType].g_iComboAbility = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iHumanAbility = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iHumanAmmo = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iHumanCooldown = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iHumanRangeCooldown = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esBlindTeammate[iPlayer][iSpecType].g_iRequiresHumans = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindAbility = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindEffect = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindMessage = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_flBlindChance = -1.0;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindCooldown = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_flBlindDuration = -1.0;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindHit = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindHitMode = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindIntensity = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindMode = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_flBlindRange = -1.0;
					g_esBlindTeammate[iPlayer][iSpecType].g_flBlindRangeChance = -1.0;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindRangeCooldown = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindSight = -1;
					g_esBlindTeammate[iPlayer][iSpecType].g_iBlindStagger = -1;
				}
			}
		}
	}
...
#if defined MT_ABILITIES_MAIN
void vBlindConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esBlindTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esBlindTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esBlindTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esBlindTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esBlindTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esBlindTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esBlindTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esBlindTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esBlindTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esBlindTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esBlindTeammate[admin][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esBlindTeammate[admin][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esBlindTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esBlindTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esBlindTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esBlindTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esBlindTeammate[admin][specType].g_iBlindAbility = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esBlindTeammate[admin][specType].g_iBlindAbility, value, -1, 1, specType);
			g_esBlindTeammate[admin][specType].g_iBlindEffect = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esBlindTeammate[admin][specType].g_iBlindEffect, value, -1, 7, specType);
			g_esBlindTeammate[admin][specType].g_iBlindMessage = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esBlindTeammate[admin][specType].g_iBlindMessage, value, -1, 3, specType);
			g_esBlindTeammate[admin][specType].g_iBlindSight = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esBlindTeammate[admin][specType].g_iBlindSight, value, -1, 2, specType);
			g_esBlindTeammate[admin][specType].g_flBlindChance = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindChance", "Blind Chance", "Blind_Chance", "chance", g_esBlindTeammate[admin][specType].g_flBlindChance, value, -1.0, 100.0, specType);
			g_esBlindTeammate[admin][specType].g_iBlindCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindCooldown", "Blind Cooldown", "Blind_Cooldown", "cooldown", g_esBlindTeammate[admin][specType].g_iBlindCooldown, value, -1, 99999, specType);
			g_esBlindTeammate[admin][specType].g_flBlindDuration = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindDuration", "Blind Duration", "Blind_Duration", "duration", g_esBlindTeammate[admin][specType].g_flBlindDuration, value, -1.0, 99999.0, specType);
			g_esBlindTeammate[admin][specType].g_iBlindHit = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindHit", "Blind Hit", "Blind_Hit", "hit", g_esBlindTeammate[admin][specType].g_iBlindHit, value, -1, 1, specType);
			g_esBlindTeammate[admin][specType].g_iBlindHitMode = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindHitMode", "Blind Hit Mode", "Blind_Hit_Mode", "hitmode", g_esBlindTeammate[admin][specType].g_iBlindHitMode, value, -1, 2, specType);
			g_esBlindTeammate[admin][specType].g_iBlindIntensity = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindIntensity", "Blind Intensity", "Blind_Intensity", "intensity", g_esBlindTeammate[admin][specType].g_iBlindIntensity, value, -1, 255, specType);
			g_esBlindTeammate[admin][specType].g_iBlindMode = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindMode", "Blind Mode", "Blind_Mode", "mode", g_esBlindTeammate[admin][specType].g_iBlindMode, value, -1, 1, specType);
			g_esBlindTeammate[admin][specType].g_flBlindRange = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindRange", "Blind Range", "Blind_Range", "range", g_esBlindTeammate[admin][specType].g_flBlindRange, value, -1.0, 99999.0, specType);
			g_esBlindTeammate[admin][specType].g_flBlindRangeChance = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindRangeChance", "Blind Range Chance", "Blind_Range_Chance", "rangechance", g_esBlindTeammate[admin][specType].g_flBlindRangeChance, value, -1.0, 100.0, specType);
			g_esBlindTeammate[admin][specType].g_iBlindRangeCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindRangeCooldown", "Blind Range Cooldown", "Blind_Range_Cooldown", "rangecooldown", g_esBlindTeammate[admin][specType].g_iBlindRangeCooldown, value, -1, 99999, specType);
			g_esBlindTeammate[admin][specType].g_iBlindStagger = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindStagger", "Blind Stagger", "Blind_Stagger", "stagger", g_esBlindTeammate[admin][specType].g_iBlindStagger, value, -1, 3, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esBlindSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "openareas", g_esBlindSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esBlindSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esBlindSpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esBlindSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esBlindSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esBlindSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esBlindSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esBlindSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esBlindSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esBlindSpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esBlindSpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esBlindSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esBlindSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esBlindSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esBlindSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esBlindSpecial[type][specType].g_iBlindAbility = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esBlindSpecial[type][specType].g_iBlindAbility, value, -1, 1, specType);
			g_esBlindSpecial[type][specType].g_iBlindEffect = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esBlindSpecial[type][specType].g_iBlindEffect, value, -1, 7, specType);
			g_esBlindSpecial[type][specType].g_iBlindMessage = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esBlindSpecial[type][specType].g_iBlindMessage, value, -1, 3, specType);
			g_esBlindSpecial[type][specType].g_iBlindSight = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esBlindSpecial[type][specType].g_iBlindSight, value, -1, 2, specType);
			g_esBlindSpecial[type][specType].g_flBlindChance = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindChance", "Blind Chance", "Blind_Chance", "chance", g_esBlindSpecial[type][specType].g_flBlindChance, value, -1.0, 100.0, specType);
			g_esBlindSpecial[type][specType].g_iBlindCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindCooldown", "Blind Cooldown", "Blind_Cooldown", "cooldown", g_esBlindSpecial[type][specType].g_iBlindCooldown, value, -1, 99999, specType);
			g_esBlindSpecial[type][specType].g_flBlindDuration = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindDuration", "Blind Duration", "Blind_Duration", "duration", g_esBlindSpecial[type][specType].g_flBlindDuration, value, -1.0, 99999.0, specType);
			g_esBlindSpecial[type][specType].g_iBlindHit = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindHit", "Blind Hit", "Blind_Hit", "hit", g_esBlindSpecial[type][specType].g_iBlindHit, value, -1, 1, specType);
			g_esBlindSpecial[type][specType].g_iBlindHitMode = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindHitMode", "Blind Hit Mode", "Blind_Hit_Mode", "hitmode", g_esBlindSpecial[type][specType].g_iBlindHitMode, value, -1, 2, specType);
			g_esBlindSpecial[type][specType].g_iBlindIntensity = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindIntensity", "Blind Intensity", "Blind_Intensity", "intensity", g_esBlindSpecial[type][specType].g_iBlindIntensity, value, -1, 255, specType);
			g_esBlindSpecial[type][specType].g_iBlindMode = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindMode", "Blind Mode", "Blind_Mode", "mode", g_esBlindSpecial[type][specType].g_iBlindMode, value, -1, 1, specType);
			g_esBlindSpecial[type][specType].g_flBlindRange = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindRange", "Blind Range", "Blind_Range", "range", g_esBlindSpecial[type][specType].g_flBlindRange, value, -1.0, 99999.0, specType);
			g_esBlindSpecial[type][specType].g_flBlindRangeChance = flGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindRangeChance", "Blind Range Chance", "Blind_Range_Chance", "rangechance", g_esBlindSpecial[type][specType].g_flBlindRangeChance, value, -1.0, 100.0, specType);
			g_esBlindSpecial[type][specType].g_iBlindRangeCooldown = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindRangeCooldown", "Blind Range Cooldown", "Blind_Range_Cooldown", "rangecooldown", g_esBlindSpecial[type][specType].g_iBlindRangeCooldown, value, -1, 99999, specType);
			g_esBlindSpecial[type][specType].g_iBlindStagger = iGetKeyValue(subsection, MT_BLIND_SECTION, MT_BLIND_SECTION2, MT_BLIND_SECTION3, MT_BLIND_SECTION4, key, "BlindStagger", "Blind Stagger", "Blind_Stagger", "stagger", g_esBlindSpecial[type][specType].g_iBlindStagger, value, -1, 3, specType);
		}
		else
		{
...
#endif
{
	...
	g_esBlindPlayer[tank].g_iInfectedType = iGetInfectedType(tank);
	g_esBlindPlayer[tank].g_iTankType = apply ? type : 0;
	int iSpecType = g_esBlindPlayer[tank].g_iInfectedType;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esBlindCache[tank].g_flBlindChance = flGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_flBlindChance, g_esBlindTeammate[tank][iSpecType].g_flBlindChance, g_esBlindPlayer[tank].g_flBlindChance, g_esBlindSpecial[type][0].g_flBlindChance, g_esBlindSpecial[type][iSpecType].g_flBlindChance, g_esBlindAbility[type].g_flBlindChance, 1);
		g_esBlindCache[tank].g_flBlindDuration = flGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_flBlindDuration, g_esBlindTeammate[tank][iSpecType].g_flBlindDuration, g_esBlindPlayer[tank].g_flBlindDuration, g_esBlindSpecial[type][0].g_flBlindDuration, g_esBlindSpecial[type][iSpecType].g_flBlindDuration, g_esBlindAbility[type].g_flBlindDuration, 1);
		g_esBlindCache[tank].g_flBlindRange = flGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_flBlindRange, g_esBlindTeammate[tank][iSpecType].g_flBlindRange, g_esBlindPlayer[tank].g_flBlindRange, g_esBlindSpecial[type][0].g_flBlindRange, g_esBlindSpecial[type][iSpecType].g_flBlindRange, g_esBlindAbility[type].g_flBlindRange, 1);
		g_esBlindCache[tank].g_flBlindRangeChance = flGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_flBlindRangeChance, g_esBlindTeammate[tank][iSpecType].g_flBlindRangeChance, g_esBlindPlayer[tank].g_flBlindRangeChance, g_esBlindSpecial[type][0].g_flBlindRangeChance, g_esBlindSpecial[type][iSpecType].g_flBlindRangeChance, g_esBlindAbility[type].g_flBlindRangeChance, 1);
		g_esBlindCache[tank].g_iBlindAbility = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindAbility, g_esBlindTeammate[tank][iSpecType].g_iBlindAbility, g_esBlindPlayer[tank].g_iBlindAbility, g_esBlindSpecial[type][0].g_iBlindAbility, g_esBlindSpecial[type][iSpecType].g_iBlindAbility, g_esBlindAbility[type].g_iBlindAbility, 1);
		g_esBlindCache[tank].g_iBlindCooldown = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindCooldown, g_esBlindTeammate[tank][iSpecType].g_iBlindCooldown, g_esBlindPlayer[tank].g_iBlindCooldown, g_esBlindSpecial[type][0].g_iBlindCooldown, g_esBlindSpecial[type][iSpecType].g_iBlindCooldown, g_esBlindAbility[type].g_iBlindCooldown, 1);
		g_esBlindCache[tank].g_iBlindEffect = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindEffect, g_esBlindTeammate[tank][iSpecType].g_iBlindEffect, g_esBlindPlayer[tank].g_iBlindEffect, g_esBlindSpecial[type][0].g_iBlindEffect, g_esBlindSpecial[type][iSpecType].g_iBlindEffect, g_esBlindAbility[type].g_iBlindEffect, 1);
		g_esBlindCache[tank].g_iBlindHit = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindHit, g_esBlindTeammate[tank][iSpecType].g_iBlindHit, g_esBlindPlayer[tank].g_iBlindHit, g_esBlindSpecial[type][0].g_iBlindHit, g_esBlindSpecial[type][iSpecType].g_iBlindHit, g_esBlindAbility[type].g_iBlindHit, 1);
		g_esBlindCache[tank].g_iBlindHitMode = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindHitMode, g_esBlindTeammate[tank][iSpecType].g_iBlindHitMode, g_esBlindPlayer[tank].g_iBlindHitMode, g_esBlindSpecial[type][0].g_iBlindHitMode, g_esBlindSpecial[type][iSpecType].g_iBlindHitMode, g_esBlindAbility[type].g_iBlindHitMode, 1);
		g_esBlindCache[tank].g_iBlindIntensity = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindIntensity, g_esBlindTeammate[tank][iSpecType].g_iBlindIntensity, g_esBlindPlayer[tank].g_iBlindIntensity, g_esBlindSpecial[type][0].g_iBlindIntensity, g_esBlindSpecial[type][iSpecType].g_iBlindIntensity, g_esBlindAbility[type].g_iBlindIntensity, 1);
		g_esBlindCache[tank].g_iBlindMessage = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindMessage, g_esBlindTeammate[tank][iSpecType].g_iBlindMessage, g_esBlindPlayer[tank].g_iBlindMessage, g_esBlindSpecial[type][0].g_iBlindMessage, g_esBlindSpecial[type][iSpecType].g_iBlindMessage, g_esBlindAbility[type].g_iBlindMessage, 1);
		g_esBlindCache[tank].g_iBlindMode = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindMode, g_esBlindTeammate[tank][iSpecType].g_iBlindMode, g_esBlindPlayer[tank].g_iBlindMode, g_esBlindSpecial[type][0].g_iBlindMode, g_esBlindSpecial[type][iSpecType].g_iBlindMode, g_esBlindAbility[type].g_iBlindMode, 1);
		g_esBlindCache[tank].g_iBlindRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindRangeCooldown, g_esBlindTeammate[tank][iSpecType].g_iBlindRangeCooldown, g_esBlindPlayer[tank].g_iBlindRangeCooldown, g_esBlindSpecial[type][0].g_iBlindRangeCooldown, g_esBlindSpecial[type][iSpecType].g_iBlindRangeCooldown, g_esBlindAbility[type].g_iBlindRangeCooldown, 1);
		g_esBlindCache[tank].g_iBlindSight = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindSight, g_esBlindTeammate[tank][iSpecType].g_iBlindSight, g_esBlindPlayer[tank].g_iBlindSight, g_esBlindSpecial[type][0].g_iBlindSight, g_esBlindSpecial[type][iSpecType].g_iBlindSight, g_esBlindAbility[type].g_iBlindSight, 1);
		g_esBlindCache[tank].g_iBlindStagger = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iBlindStagger, g_esBlindTeammate[tank][iSpecType].g_iBlindStagger, g_esBlindPlayer[tank].g_iBlindStagger, g_esBlindSpecial[type][0].g_iBlindStagger, g_esBlindSpecial[type][iSpecType].g_iBlindStagger, g_esBlindAbility[type].g_iBlindStagger, 1);
		g_esBlindCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_flCloseAreasOnly, g_esBlindTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esBlindPlayer[tank].g_flCloseAreasOnly, g_esBlindSpecial[type][0].g_flCloseAreasOnly, g_esBlindSpecial[type][iSpecType].g_flCloseAreasOnly, g_esBlindAbility[type].g_flCloseAreasOnly, 1);
		g_esBlindCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iComboAbility, g_esBlindTeammate[tank][iSpecType].g_iComboAbility, g_esBlindPlayer[tank].g_iComboAbility, g_esBlindSpecial[type][0].g_iComboAbility, g_esBlindSpecial[type][iSpecType].g_iComboAbility, g_esBlindAbility[type].g_iComboAbility, 1);
		g_esBlindCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iHumanAbility, g_esBlindTeammate[tank][iSpecType].g_iHumanAbility, g_esBlindPlayer[tank].g_iHumanAbility, g_esBlindSpecial[type][0].g_iHumanAbility, g_esBlindSpecial[type][iSpecType].g_iHumanAbility, g_esBlindAbility[type].g_iHumanAbility, 1);
		g_esBlindCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iHumanAmmo, g_esBlindTeammate[tank][iSpecType].g_iHumanAmmo, g_esBlindPlayer[tank].g_iHumanAmmo, g_esBlindSpecial[type][0].g_iHumanAmmo, g_esBlindSpecial[type][iSpecType].g_iHumanAmmo, g_esBlindAbility[type].g_iHumanAmmo, 1);
		g_esBlindCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iHumanCooldown, g_esBlindTeammate[tank][iSpecType].g_iHumanCooldown, g_esBlindPlayer[tank].g_iHumanCooldown, g_esBlindSpecial[type][0].g_iHumanCooldown, g_esBlindSpecial[type][iSpecType].g_iHumanCooldown, g_esBlindAbility[type].g_iHumanCooldown, 1);
		g_esBlindCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iHumanRangeCooldown, g_esBlindTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esBlindPlayer[tank].g_iHumanRangeCooldown, g_esBlindSpecial[type][0].g_iHumanRangeCooldown, g_esBlindSpecial[type][iSpecType].g_iHumanRangeCooldown, g_esBlindAbility[type].g_iHumanRangeCooldown, 1);
		g_esBlindCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_flOpenAreasOnly, g_esBlindTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esBlindPlayer[tank].g_flOpenAreasOnly, g_esBlindSpecial[type][0].g_flOpenAreasOnly, g_esBlindSpecial[type][iSpecType].g_flOpenAreasOnly, g_esBlindAbility[type].g_flOpenAreasOnly, 1);
		g_esBlindCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esBlindTeammate[tank][0].g_iRequiresHumans, g_esBlindTeammate[tank][iSpecType].g_iRequiresHumans, g_esBlindPlayer[tank].g_iRequiresHumans, g_esBlindSpecial[type][0].g_iRequiresHumans, g_esBlindSpecial[type][iSpecType].g_iRequiresHumans, g_esBlindAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
		g_esBlindCache[tank].g_flBlindChance = flGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_flBlindChance, g_esBlindAbility[type].g_flBlindChance, 1);
		g_esBlindCache[tank].g_flBlindDuration = flGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_flBlindDuration, g_esBlindAbility[type].g_flBlindDuration, 1);
		g_esBlindCache[tank].g_flBlindRange = flGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_flBlindRange, g_esBlindAbility[type].g_flBlindRange, 1);
		g_esBlindCache[tank].g_flBlindRangeChance = flGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_flBlindRangeChance, g_esBlindAbility[type].g_flBlindRangeChance, 1);
		g_esBlindCache[tank].g_iBlindAbility = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindAbility, g_esBlindAbility[type].g_iBlindAbility, 1);
		g_esBlindCache[tank].g_iBlindCooldown = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindCooldown, g_esBlindAbility[type].g_iBlindCooldown, 1);
		g_esBlindCache[tank].g_iBlindEffect = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindEffect, g_esBlindAbility[type].g_iBlindEffect, 1);
		g_esBlindCache[tank].g_iBlindHit = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindHit, g_esBlindAbility[type].g_iBlindHit, 1);
		g_esBlindCache[tank].g_iBlindHitMode = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindHitMode, g_esBlindAbility[type].g_iBlindHitMode, 1);
		g_esBlindCache[tank].g_iBlindIntensity = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindIntensity, g_esBlindAbility[type].g_iBlindIntensity, 1);
		g_esBlindCache[tank].g_iBlindMessage = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindMessage, g_esBlindAbility[type].g_iBlindMessage, 1);
		g_esBlindCache[tank].g_iBlindMode = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindMode, g_esBlindAbility[type].g_iBlindMode, 1);
		g_esBlindCache[tank].g_iBlindRangeCooldown = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindRangeCooldown, g_esBlindAbility[type].g_iBlindRangeCooldown, 1);
		g_esBlindCache[tank].g_iBlindSight = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindSight, g_esBlindAbility[type].g_iBlindSight, 1);
		g_esBlindCache[tank].g_iBlindStagger = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iBlindStagger, g_esBlindAbility[type].g_iBlindStagger, 1);
		g_esBlindCache[tank].g_flCloseAreasOnly = flGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_flCloseAreasOnly, g_esBlindAbility[type].g_flCloseAreasOnly, 1);
		g_esBlindCache[tank].g_iComboAbility = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iComboAbility, g_esBlindAbility[type].g_iComboAbility, 1);
		g_esBlindCache[tank].g_iHumanAbility = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iHumanAbility, g_esBlindAbility[type].g_iHumanAbility, 1);
		g_esBlindCache[tank].g_iHumanAmmo = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iHumanAmmo, g_esBlindAbility[type].g_iHumanAmmo, 1);
		g_esBlindCache[tank].g_iHumanCooldown = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iHumanCooldown, g_esBlindAbility[type].g_iHumanCooldown, 1);
		g_esBlindCache[tank].g_iHumanRangeCooldown = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iHumanRangeCooldown, g_esBlindAbility[type].g_iHumanRangeCooldown, 1);
		g_esBlindCache[tank].g_flOpenAreasOnly = flGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_flOpenAreasOnly, g_esBlindAbility[type].g_flOpenAreasOnly, 1);
		g_esBlindCache[tank].g_iRequiresHumans = iGetSettingValue(apply, bHuman, g_esBlindPlayer[tank].g_iRequiresHumans, g_esBlindAbility[type].g_iRequiresHumans, 1);
	}
}
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esBlindCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esBlindCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esBlindPlayer[tank].g_iTankType, tank) || (g_esBlindCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esBlindCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esBlindAbility[g_esBlindPlayer[tank].g_iTankType].g_iAccessFlags, g_esBlindPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
void tTimerBlind(Handle timer, DataPack pack)
{
	...
	if (!MT_IsTankSupported(iTank) || bIsAreaNarrow(iTank, g_esBlindCache[iTank].g_flOpenAreasOnly) || bIsAreaWide(iTank, g_esBlindCache[iTank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esBlindPlayer[iTank].g_iTankType, iTank) || (g_esBlindCache[iTank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esBlindCache[iTank].g_iRequiresHumans) || !MT_HasAdminAccess(iTank) || !bHasAdminAccess(iTank, g_esBlindAbility[g_esBlindPlayer[iTank].g_iTankType].g_iAccessFlags, g_esBlindPlayer[iTank].g_iAccessFlags) || !MT_IsTypeEnabled(g_esBlindPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || iType != g_esBlindPlayer[iTank].g_iTankType || MT_IsAdminImmune(iSurvivor, iTank) || bIsAdminImmune(iSurvivor, g_esBlindPlayer[iTank].g_iTankType, g_esBlindAbility[g_esBlindPlayer[iTank].g_iTankType].g_iImmunityFlags, g_esBlindPlayer[iSurvivor].g_iImmunityFlags) || iBlindEnabled == 0)
	{
		g_esBlindPlayer[iSurvivor].g_bAffected = false;
		g_esBlindPlayer[iSurvivor].g_iOwner = -1;
...
void tTimerBlindCombo(Handle timer, DataPack pack)
{
	...
	int iTank = GetClientOfUserId(pack.ReadCell());
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esBlindAbility[g_esBlindPlayer[iTank].g_iTankType].g_iAccessFlags, g_esBlindPlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esBlindPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esBlindCache[iTank].g_iBlindAbility == 0)
	{
		return;
	}
