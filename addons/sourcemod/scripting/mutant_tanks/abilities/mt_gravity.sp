...
esGravityTeammate g_esGravityTeammate[MAXPLAYERS + 1][7];
...
esGravitySpecial g_esGravitySpecial[MT_MAXTYPES + 1][7];
	...
	switch (mode)
	{
		case 1:
		{
			for (int iIndex = MT_GetMinType(); iIndex <= MT_GetMaxType(); iIndex++)
			{
				...
				{
					g_esGravitySpecial[iIndex][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_iComboAbility = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iHumanAbility = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iHumanAmmo = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iHumanCooldown = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iHumanDuration = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iHumanMode = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iHumanRangeCooldown = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iHumanRockCooldown = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_iRequiresHumans = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityAbility = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityEffect = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityMessage = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_flGravityChance = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityCooldown = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityDuration = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityFlags = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_flGravityForce = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityHit = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityHitMode = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_flGravityRadius = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_flGravityRange = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_flGravityRangeChance = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityRangeCooldown = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityRockBreak = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_flGravityRockChance = -1.0;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravityRockCooldown = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_iGravitySight = -1;
					g_esGravitySpecial[iIndex][iSpecType].g_flGravityValue = -1.0;
				}
			}
		}
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				...
				for (int iSpecType = 0; iSpecType < (sizeof g_sSpecialNames); iSpecType++)
				{
					g_esGravityTeammate[iPlayer][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_iComboAbility = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iHumanAbility = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iHumanAmmo = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iHumanCooldown = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iHumanDuration = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iHumanMode = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iHumanRangeCooldown = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iHumanRockCooldown = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_iRequiresHumans = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityAbility = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityEffect = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityMessage = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_flGravityChance = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityCooldown = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityDuration = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityFlags = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_flGravityForce = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityHit = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityHitMode = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_flGravityRadius = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_flGravityRange = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_flGravityRangeChance = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityRangeCooldown = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityRockBreak = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_flGravityRockChance = -1.0;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravityRockCooldown = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_iGravitySight = -1;
					g_esGravityTeammate[iPlayer][iSpecType].g_flGravityValue = -1.0;
				}
			}
		}
	}
...
#if defined MT_ABILITIES_MAIN
void vGravityConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esGravityTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esGravityTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esGravityTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esGravityTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esGravityTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esGravityTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esGravityTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esGravityTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esGravityTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esGravityTeammate[admin][specType].g_iHumanDuration, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_iHumanMode = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esGravityTeammate[admin][specType].g_iHumanMode, value, -1, 1, specType);
			g_esGravityTeammate[admin][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esGravityTeammate[admin][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_iHumanRockCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanRockCooldown", "Human Rock Cooldown", "Human_Rock_Cooldown", "hrockcooldown", g_esGravityTeammate[admin][specType].g_iHumanRockCooldown, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esGravityTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esGravityTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esGravityTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esGravityTeammate[admin][specType].g_iGravityAbility = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esGravityTeammate[admin][specType].g_iGravityAbility, value, -1, 3, specType);
			g_esGravityTeammate[admin][specType].g_iGravityEffect = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esGravityTeammate[admin][specType].g_iGravityEffect, value, -1, 7, specType);
			g_esGravityTeammate[admin][specType].g_iGravityMessage = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esGravityTeammate[admin][specType].g_iGravityMessage, value, -1, 7, specType);
			g_esGravityTeammate[admin][specType].g_iGravitySight = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esGravityTeammate[admin][specType].g_iGravitySight, value, -1, 2, specType);
			g_esGravityTeammate[admin][specType].g_flGravityChance = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityChance", "Gravity Chance", "Gravity_Chance", "chance", g_esGravityTeammate[admin][specType].g_flGravityChance, value, -1.0, 100.0, specType);
			g_esGravityTeammate[admin][specType].g_iGravityCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityCooldown", "Gravity Cooldown", "Gravity_Cooldown", "cooldown", g_esGravityTeammate[admin][specType].g_iGravityCooldown, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_iGravityDuration = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityDuration", "Gravity Duration", "Gravity_Duration", "duration", g_esGravityTeammate[admin][specType].g_iGravityDuration, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_iGravityFlags = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityFlags", "Gravity Flags", "Gravity_Flags", "flags", g_esGravityTeammate[admin][specType].g_iGravityFlags, value, -1, 31, specType);
			g_esGravityTeammate[admin][specType].g_flGravityForce = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityForce", "Gravity Force", "Gravity_Force", "force", g_esGravityTeammate[admin][specType].g_flGravityForce, value, -100.0, 100.0, specType);
			g_esGravityTeammate[admin][specType].g_iGravityHit = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityHit", "Gravity Hit", "Gravity_Hit", "hit", g_esGravityTeammate[admin][specType].g_iGravityHit, value, -1, 1, specType);
			g_esGravityTeammate[admin][specType].g_iGravityHitMode = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityHitMode", "Gravity Hit Mode", "Gravity_Hit_Mode", "hitmode", g_esGravityTeammate[admin][specType].g_iGravityHitMode, value, -1, 2, specType);
			g_esGravityTeammate[admin][specType].g_flGravityRadius = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRadius", "Gravity Radius", "Gravity_Radius", "radius", g_esGravityTeammate[admin][specType].g_flGravityRadius, value, -1.0, 99999.0, specType);
			g_esGravityTeammate[admin][specType].g_flGravityRange = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRange", "Gravity Range", "Gravity_Range", "range", g_esGravityTeammate[admin][specType].g_flGravityRange, value, -1.0, 99999.0, specType);
			g_esGravityTeammate[admin][specType].g_flGravityRangeChance = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRangeChance", "Gravity Range Chance", "Gravity_Range_Chance", "rangechance", g_esGravityTeammate[admin][specType].g_flGravityRangeChance, value, -1.0, 100.0, specType);
			g_esGravityTeammate[admin][specType].g_iGravityRangeCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRangeCooldown", "Gravity Range Cooldown", "Gravity_Range_Cooldown", "rangecooldown", g_esGravityTeammate[admin][specType].g_iGravityRangeCooldown, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_iGravityRockBreak = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRockBreak", "Gravity Rock Break", "Gravity_Rock_Break", "rock", g_esGravityTeammate[admin][specType].g_iGravityRockBreak, value, -1, 1, specType);
			g_esGravityTeammate[admin][specType].g_flGravityRockChance = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRockChance", "Gravity Rock Chance", "Gravity_Rock_Chance", "rockchance", g_esGravityTeammate[admin][specType].g_flGravityRockChance, value, -1.0, 100.0, specType);
			g_esGravityTeammate[admin][specType].g_iGravityRockCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRockCooldown", "Gravity Rock Cooldown", "Gravity_Rock_Cooldown", "rockcooldown", g_esGravityTeammate[admin][specType].g_iGravityRockCooldown, value, -1, 99999, specType);
			g_esGravityTeammate[admin][specType].g_flGravityValue = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityValue", "Gravity Value", "Gravity_Value", "value", g_esGravityTeammate[admin][specType].g_flGravityValue, value, -1.0, 99999.0, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esGravitySpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esGravitySpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esGravitySpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esGravitySpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esGravitySpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esGravitySpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esGravitySpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esGravitySpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esGravitySpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esGravitySpecial[type][specType].g_iHumanDuration, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_iHumanMode = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esGravitySpecial[type][specType].g_iHumanMode, value, -1, 1, specType);
			g_esGravitySpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esGravitySpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_iHumanRockCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "HumanRockCooldown", "Human Rock Cooldown", "Human_Rock_Cooldown", "hrockcooldown", g_esGravitySpecial[type][specType].g_iHumanRockCooldown, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esGravitySpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esGravitySpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esGravitySpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esGravitySpecial[type][specType].g_iGravityAbility = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esGravitySpecial[type][specType].g_iGravityAbility, value, -1, 3, specType);
			g_esGravitySpecial[type][specType].g_iGravityEffect = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esGravitySpecial[type][specType].g_iGravityEffect, value, -1, 7, specType);
			g_esGravitySpecial[type][specType].g_iGravityMessage = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esGravitySpecial[type][specType].g_iGravityMessage, value, -1, 7, specType);
			g_esGravitySpecial[type][specType].g_iGravitySight = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esGravitySpecial[type][specType].g_iGravitySight, value, -1, 2, specType);
			g_esGravitySpecial[type][specType].g_flGravityChance = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityChance", "Gravity Chance", "Gravity_Chance", "chance", g_esGravitySpecial[type][specType].g_flGravityChance, value, -1.0, 100.0, specType);
			g_esGravitySpecial[type][specType].g_iGravityCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityCooldown", "Gravity Cooldown", "Gravity_Cooldown", "cooldown", g_esGravitySpecial[type][specType].g_iGravityCooldown, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_iGravityDuration = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityDuration", "Gravity Duration", "Gravity_Duration", "duration", g_esGravitySpecial[type][specType].g_iGravityDuration, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_iGravityFlags = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityFlags", "Gravity Flags", "Gravity_Flags", "flags", g_esGravitySpecial[type][specType].g_iGravityFlags, value, -1, 31, specType);
			g_esGravitySpecial[type][specType].g_flGravityForce = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityForce", "Gravity Force", "Gravity_Force", "force", g_esGravitySpecial[type][specType].g_flGravityForce, value, -100.0, 100.0, specType);
			g_esGravitySpecial[type][specType].g_iGravityHit = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityHit", "Gravity Hit", "Gravity_Hit", "hit", g_esGravitySpecial[type][specType].g_iGravityHit, value, -1, 1, specType);
			g_esGravitySpecial[type][specType].g_iGravityHitMode = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityHitMode", "Gravity Hit Mode", "Gravity_Hit_Mode", "hitmode", g_esGravitySpecial[type][specType].g_iGravityHitMode, value, -1, 2, specType);
			g_esGravitySpecial[type][specType].g_flGravityRadius = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRadius", "Gravity Radius", "Gravity_Radius", "radius", g_esGravitySpecial[type][specType].g_flGravityRadius, value, -1.0, 99999.0, specType);
			g_esGravitySpecial[type][specType].g_flGravityRange = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRange", "Gravity Range", "Gravity_Range", "range", g_esGravitySpecial[type][specType].g_flGravityRange, value, -1.0, 99999.0, specType);
			g_esGravitySpecial[type][specType].g_flGravityRangeChance = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRangeChance", "Gravity Range Chance", "Gravity_Range_Chance", "rangechance", g_esGravitySpecial[type][specType].g_flGravityRangeChance, value, -1.0, 100.0, specType);
			g_esGravitySpecial[type][specType].g_iGravityRangeCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRangeCooldown", "Gravity Range Cooldown", "Gravity_Range_Cooldown", "rangecooldown", g_esGravitySpecial[type][specType].g_iGravityRangeCooldown, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_iGravityRockBreak = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRockBreak", "Gravity Rock Break", "Gravity_Rock_Break", "rock", g_esGravitySpecial[type][specType].g_iGravityRockBreak, value, -1, 1, specType);
			g_esGravitySpecial[type][specType].g_flGravityRockChance = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRockChance", "Gravity Rock Chance", "Gravity_Rock_Chance", "rockchance", g_esGravitySpecial[type][specType].g_flGravityRockChance, value, -1.0, 100.0, specType);
			g_esGravitySpecial[type][specType].g_iGravityRockCooldown = iGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityRockCooldown", "Gravity Rock Cooldown", "Gravity_Rock_Cooldown", "rockcooldown", g_esGravitySpecial[type][specType].g_iGravityRockCooldown, value, -1, 99999, specType);
			g_esGravitySpecial[type][specType].g_flGravityValue = flGetKeyValue(subsection, MT_GRAVITY_SECTION, MT_GRAVITY_SECTION2, MT_GRAVITY_SECTION3, MT_GRAVITY_SECTION4, key, "GravityValue", "Gravity Value", "Gravity_Value", "value", g_esGravitySpecial[type][specType].g_flGravityValue, value, -1.0, 99999.0, specType);
		}
		else
		{
...
#endif
{
	...
	g_esGravityPlayer[tank].g_iInfectedType = iGetInfectedType(tank);
	g_esGravityPlayer[tank].g_iTankType = apply ? type : 0;
	int iSpecType = g_esGravityPlayer[tank].g_iInfectedType;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esGravityCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flCloseAreasOnly, g_esGravityTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esGravityPlayer[tank].g_flCloseAreasOnly, g_esGravitySpecial[type][0].g_flCloseAreasOnly, g_esGravitySpecial[type][iSpecType].g_flCloseAreasOnly, g_esGravityAbility[type].g_flCloseAreasOnly, 1);
		g_esGravityCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iComboAbility, g_esGravityTeammate[tank][iSpecType].g_iComboAbility, g_esGravityPlayer[tank].g_iComboAbility, g_esGravitySpecial[type][0].g_iComboAbility, g_esGravitySpecial[type][iSpecType].g_iComboAbility, g_esGravityAbility[type].g_iComboAbility, 1);
		g_esGravityCache[tank].g_flGravityChance = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flGravityChance, g_esGravityTeammate[tank][iSpecType].g_flGravityChance, g_esGravityPlayer[tank].g_flGravityChance, g_esGravitySpecial[type][0].g_flGravityChance, g_esGravitySpecial[type][iSpecType].g_flGravityChance, g_esGravityAbility[type].g_flGravityChance, 1);
		g_esGravityCache[tank].g_flGravityForce = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flGravityForce, g_esGravityTeammate[tank][iSpecType].g_flGravityForce, g_esGravityPlayer[tank].g_flGravityForce, g_esGravitySpecial[type][0].g_flGravityForce, g_esGravitySpecial[type][iSpecType].g_flGravityForce, g_esGravityAbility[type].g_flGravityForce, 2, -1.0);
		g_esGravityCache[tank].g_flGravityRadius = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flGravityRadius, g_esGravityTeammate[tank][iSpecType].g_flGravityRadius, g_esGravityPlayer[tank].g_flGravityRadius, g_esGravitySpecial[type][0].g_flGravityRadius, g_esGravitySpecial[type][iSpecType].g_flGravityRadius, g_esGravityAbility[type].g_flGravityRadius, 1);
		g_esGravityCache[tank].g_flGravityRange = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flGravityRange, g_esGravityTeammate[tank][iSpecType].g_flGravityRange, g_esGravityPlayer[tank].g_flGravityRange, g_esGravitySpecial[type][0].g_flGravityRange, g_esGravitySpecial[type][iSpecType].g_flGravityRange, g_esGravityAbility[type].g_flGravityRange, 1);
		g_esGravityCache[tank].g_flGravityRangeChance = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flGravityRangeChance, g_esGravityTeammate[tank][iSpecType].g_flGravityRangeChance, g_esGravityPlayer[tank].g_flGravityRangeChance, g_esGravitySpecial[type][0].g_flGravityRangeChance, g_esGravitySpecial[type][iSpecType].g_flGravityRangeChance, g_esGravityAbility[type].g_flGravityRangeChance, 1);
		g_esGravityCache[tank].g_flGravityRockChance = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flGravityRockChance, g_esGravityTeammate[tank][iSpecType].g_flGravityRockChance, g_esGravityPlayer[tank].g_flGravityRockChance, g_esGravitySpecial[type][0].g_flGravityRockChance, g_esGravitySpecial[type][iSpecType].g_flGravityRockChance, g_esGravityAbility[type].g_flGravityRockChance, 1);
		g_esGravityCache[tank].g_flGravityValue = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flGravityValue, g_esGravityTeammate[tank][iSpecType].g_flGravityValue, g_esGravityPlayer[tank].g_flGravityValue, g_esGravitySpecial[type][0].g_flGravityValue, g_esGravitySpecial[type][iSpecType].g_flGravityValue, g_esGravityAbility[type].g_flGravityValue, 1);
		g_esGravityCache[tank].g_iGravityAbility = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityAbility, g_esGravityTeammate[tank][iSpecType].g_iGravityAbility, g_esGravityPlayer[tank].g_iGravityAbility, g_esGravitySpecial[type][0].g_iGravityAbility, g_esGravitySpecial[type][iSpecType].g_iGravityAbility, g_esGravityAbility[type].g_iGravityAbility, 1);
		g_esGravityCache[tank].g_iGravityCooldown = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityCooldown, g_esGravityTeammate[tank][iSpecType].g_iGravityCooldown, g_esGravityPlayer[tank].g_iGravityCooldown, g_esGravitySpecial[type][0].g_iGravityCooldown, g_esGravitySpecial[type][iSpecType].g_iGravityCooldown, g_esGravityAbility[type].g_iGravityCooldown, 1);
		g_esGravityCache[tank].g_iGravityDuration = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityDuration, g_esGravityTeammate[tank][iSpecType].g_iGravityDuration, g_esGravityPlayer[tank].g_iGravityDuration, g_esGravitySpecial[type][0].g_iGravityDuration, g_esGravitySpecial[type][iSpecType].g_iGravityDuration, g_esGravityAbility[type].g_iGravityDuration, 1);
		g_esGravityCache[tank].g_iGravityEffect = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityEffect, g_esGravityTeammate[tank][iSpecType].g_iGravityEffect, g_esGravityPlayer[tank].g_iGravityEffect, g_esGravitySpecial[type][0].g_iGravityEffect, g_esGravitySpecial[type][iSpecType].g_iGravityEffect, g_esGravityAbility[type].g_iGravityEffect, 1);
		g_esGravityCache[tank].g_iGravityFlags = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityFlags, g_esGravityTeammate[tank][iSpecType].g_iGravityFlags, g_esGravityPlayer[tank].g_iGravityFlags, g_esGravitySpecial[type][0].g_iGravityFlags, g_esGravitySpecial[type][iSpecType].g_iGravityFlags, g_esGravityAbility[type].g_iGravityFlags, 1);
		g_esGravityCache[tank].g_iGravityHit = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityHit, g_esGravityTeammate[tank][iSpecType].g_iGravityHit, g_esGravityPlayer[tank].g_iGravityHit, g_esGravitySpecial[type][0].g_iGravityHit, g_esGravitySpecial[type][iSpecType].g_iGravityHit, g_esGravityAbility[type].g_iGravityHit, 1);
		g_esGravityCache[tank].g_iGravityHitMode = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityHitMode, g_esGravityTeammate[tank][iSpecType].g_iGravityHitMode, g_esGravityPlayer[tank].g_iGravityHitMode, g_esGravitySpecial[type][0].g_iGravityHitMode, g_esGravitySpecial[type][iSpecType].g_iGravityHitMode, g_esGravityAbility[type].g_iGravityHitMode, 1);
		g_esGravityCache[tank].g_iGravityMessage = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityMessage, g_esGravityTeammate[tank][iSpecType].g_iGravityMessage, g_esGravityPlayer[tank].g_iGravityMessage, g_esGravitySpecial[type][0].g_iGravityMessage, g_esGravitySpecial[type][iSpecType].g_iGravityMessage, g_esGravityAbility[type].g_iGravityMessage, 1);
		g_esGravityCache[tank].g_iGravityRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityRangeCooldown, g_esGravityTeammate[tank][iSpecType].g_iGravityRangeCooldown, g_esGravityPlayer[tank].g_iGravityRangeCooldown, g_esGravitySpecial[type][0].g_iGravityRangeCooldown, g_esGravitySpecial[type][iSpecType].g_iGravityRangeCooldown, g_esGravityAbility[type].g_iGravityRangeCooldown, 1);
		g_esGravityCache[tank].g_iGravityRockBreak = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityRockBreak, g_esGravityTeammate[tank][iSpecType].g_iGravityRockBreak, g_esGravityPlayer[tank].g_iGravityRockBreak, g_esGravitySpecial[type][0].g_iGravityRockBreak, g_esGravitySpecial[type][iSpecType].g_iGravityRockBreak, g_esGravityAbility[type].g_iGravityRockBreak, 1);
		g_esGravityCache[tank].g_iGravityRockCooldown = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravityRockCooldown, g_esGravityTeammate[tank][iSpecType].g_iGravityRockCooldown, g_esGravityPlayer[tank].g_iGravityRockCooldown, g_esGravitySpecial[type][0].g_iGravityRockCooldown, g_esGravitySpecial[type][iSpecType].g_iGravityRockCooldown, g_esGravityAbility[type].g_iGravityRockCooldown, 1);
		g_esGravityCache[tank].g_iGravitySight = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iGravitySight, g_esGravityTeammate[tank][iSpecType].g_iGravitySight, g_esGravityPlayer[tank].g_iGravitySight, g_esGravitySpecial[type][0].g_iGravitySight, g_esGravitySpecial[type][iSpecType].g_iGravitySight, g_esGravityAbility[type].g_iGravitySight, 1);
		g_esGravityCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iHumanAbility, g_esGravityTeammate[tank][iSpecType].g_iHumanAbility, g_esGravityPlayer[tank].g_iHumanAbility, g_esGravitySpecial[type][0].g_iHumanAbility, g_esGravitySpecial[type][iSpecType].g_iHumanAbility, g_esGravityAbility[type].g_iHumanAbility, 1);
		g_esGravityCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iHumanAmmo, g_esGravityTeammate[tank][iSpecType].g_iHumanAmmo, g_esGravityPlayer[tank].g_iHumanAmmo, g_esGravitySpecial[type][0].g_iHumanAmmo, g_esGravitySpecial[type][iSpecType].g_iHumanAmmo, g_esGravityAbility[type].g_iHumanAmmo, 1);
		g_esGravityCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iHumanCooldown, g_esGravityTeammate[tank][iSpecType].g_iHumanCooldown, g_esGravityPlayer[tank].g_iHumanCooldown, g_esGravitySpecial[type][0].g_iHumanCooldown, g_esGravitySpecial[type][iSpecType].g_iHumanCooldown, g_esGravityAbility[type].g_iHumanCooldown, 1);
		g_esGravityCache[tank].g_iHumanDuration = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iHumanDuration, g_esGravityTeammate[tank][iSpecType].g_iHumanDuration, g_esGravityPlayer[tank].g_iHumanDuration, g_esGravitySpecial[type][0].g_iHumanDuration, g_esGravitySpecial[type][iSpecType].g_iHumanDuration, g_esGravityAbility[type].g_iHumanDuration, 1);
		g_esGravityCache[tank].g_iHumanMode = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iHumanMode, g_esGravityTeammate[tank][iSpecType].g_iHumanMode, g_esGravityPlayer[tank].g_iHumanMode, g_esGravitySpecial[type][0].g_iHumanMode, g_esGravitySpecial[type][iSpecType].g_iHumanMode, g_esGravityAbility[type].g_iHumanMode, 1);
		g_esGravityCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iHumanRangeCooldown, g_esGravityTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esGravityPlayer[tank].g_iHumanRangeCooldown, g_esGravitySpecial[type][0].g_iHumanRangeCooldown, g_esGravitySpecial[type][iSpecType].g_iHumanRangeCooldown, g_esGravityAbility[type].g_iHumanRangeCooldown, 1);
		g_esGravityCache[tank].g_iHumanRockCooldown = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iHumanRockCooldown, g_esGravityTeammate[tank][iSpecType].g_iHumanRockCooldown, g_esGravityPlayer[tank].g_iHumanRockCooldown, g_esGravitySpecial[type][0].g_iHumanRockCooldown, g_esGravitySpecial[type][iSpecType].g_iHumanRockCooldown, g_esGravityAbility[type].g_iHumanRockCooldown, 1);
		g_esGravityCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_flOpenAreasOnly, g_esGravityTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esGravityPlayer[tank].g_flOpenAreasOnly, g_esGravitySpecial[type][0].g_flOpenAreasOnly, g_esGravitySpecial[type][iSpecType].g_flOpenAreasOnly, g_esGravityAbility[type].g_flOpenAreasOnly, 1);
		g_esGravityCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esGravityTeammate[tank][0].g_iRequiresHumans, g_esGravityTeammate[tank][iSpecType].g_iRequiresHumans, g_esGravityPlayer[tank].g_iRequiresHumans, g_esGravitySpecial[type][0].g_iRequiresHumans, g_esGravitySpecial[type][iSpecType].g_iRequiresHumans, g_esGravityAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esGravityCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esGravityCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esGravityPlayer[tank].g_iTankType, tank) || (g_esGravityCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esGravityCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esGravityAbility[g_esGravityPlayer[tank].g_iTankType].g_iAccessFlags, g_esGravityPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
