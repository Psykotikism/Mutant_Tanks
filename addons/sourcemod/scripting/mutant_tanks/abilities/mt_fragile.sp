...
esFragileTeammate g_esFragileTeammate[MAXPLAYERS + 1][6];
...
esFragileSpecial g_esFragileSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN
void vFragileConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esFragileTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esFragileTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esFragileTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esFragileTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esFragileTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esFragileTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esFragileTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esFragileTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esFragileTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esFragileTeammate[admin][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esFragileTeammate[admin][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esFragileTeammate[admin][specType].g_iHumanMode = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esFragileTeammate[admin][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esFragileTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esFragileTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esFragileTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esFragileTeammate[admin][specType].g_iFragileAbility = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esFragileTeammate[admin][specType].g_iFragileAbility, value, -1, 1, specName, specType);
			g_esFragileTeammate[admin][specType].g_iFragileMessage = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esFragileTeammate[admin][specType].g_iFragileMessage, value, -1, 1, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileBulletMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileBulletMultiplier", "Fragile Bullet Multiplier", "Fragile_Bullet_Multiplier", "bullet", g_esFragileTeammate[admin][specType].g_flFragileBulletMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileChance = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileChance", "Fragile Chance", "Fragile_Chance", "chance", g_esFragileTeammate[admin][specType].g_flFragileChance, value, -1.0, 100.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_iFragileCooldown = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileCooldown", "Fragile Cooldown", "Fragile_Cooldown", "cooldown", g_esFragileTeammate[admin][specType].g_iFragileCooldown, value, -1, 99999, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileDamageBoost = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileDamageBoost", "Fragile Damage Boost", "Fragile_Damage_Boost", "dmgboost", g_esFragileTeammate[admin][specType].g_flFragileDamageBoost, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_iFragileDuration = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileDuration", "Fragile Duration", "Fragile_Duration", "duration", g_esFragileTeammate[admin][specType].g_iFragileDuration, value, -1, 99999, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileExplosiveMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileExplosiveMultiplier", "Fragile Explosive Multiplier", "Fragile_Explosive_Multiplier", "explosive", g_esFragileTeammate[admin][specType].g_flFragileExplosiveMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileFireMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileFireMultiplier", "Fragile Fire Multiplier", "Fragile_Fire_Multiplier", "fire", g_esFragileTeammate[admin][specType].g_flFragileFireMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileHittableMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileHittableMultiplier", "Fragile Hittable Multiplier", "Fragile_Hittable_Multiplier", "hittable", g_esFragileTeammate[admin][specType].g_flFragileHittableMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileMeleeMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileMeleeMultiplier", "Fragile Melee Multiplier", "Fragile_Melee_Multiplier", "melee", g_esFragileTeammate[admin][specType].g_flFragileMeleeMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileTeammate[admin][specType].g_iFragileMode = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileMode", "Fragile Mode", "Fragile_Mode", "mode", g_esFragileTeammate[admin][specType].g_iFragileMode, value, -1, 1, specName, specType);
			g_esFragileTeammate[admin][specType].g_flFragileSpeedBoost = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileSpeedBoost", "Fragile Speed Boost", "Fragile_Speed_Boost", "speedboost", g_esFragileTeammate[admin][specType].g_flFragileSpeedBoost, value, -1.0, 3.0, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esFragileSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esFragileSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esFragileSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esFragileSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esFragileSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esFragileSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esFragileSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esFragileSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esFragileSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esFragileSpecial[type][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esFragileSpecial[type][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esFragileSpecial[type][specType].g_iHumanMode = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esFragileSpecial[type][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esFragileSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esFragileSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esFragileSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esFragileSpecial[type][specType].g_iFragileAbility = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esFragileSpecial[type][specType].g_iFragileAbility, value, -1, 1, specName, specType);
			g_esFragileSpecial[type][specType].g_iFragileMessage = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esFragileSpecial[type][specType].g_iFragileMessage, value, -1, 1, specName, specType);
			g_esFragileSpecial[type][specType].g_flFragileBulletMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileBulletMultiplier", "Fragile Bullet Multiplier", "Fragile_Bullet_Multiplier", "bullet", g_esFragileSpecial[type][specType].g_flFragileBulletMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_flFragileChance = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileChance", "Fragile Chance", "Fragile_Chance", "chance", g_esFragileSpecial[type][specType].g_flFragileChance, value, -1.0, 100.0, specName, specType);
			g_esFragileSpecial[type][specType].g_iFragileCooldown = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileCooldown", "Fragile Cooldown", "Fragile_Cooldown", "cooldown", g_esFragileSpecial[type][specType].g_iFragileCooldown, value, -1, 99999, specName, specType);
			g_esFragileSpecial[type][specType].g_flFragileDamageBoost = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileDamageBoost", "Fragile Damage Boost", "Fragile_Damage_Boost", "dmgboost", g_esFragileSpecial[type][specType].g_flFragileDamageBoost, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_iFragileDuration = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileDuration", "Fragile Duration", "Fragile_Duration", "duration", g_esFragileSpecial[type][specType].g_iFragileDuration, value, -1, 99999, specName, specType);
			g_esFragileSpecial[type][specType].g_flFragileExplosiveMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileExplosiveMultiplier", "Fragile Explosive Multiplier", "Fragile_Explosive_Multiplier", "explosive", g_esFragileSpecial[type][specType].g_flFragileExplosiveMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_flFragileFireMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileFireMultiplier", "Fragile Fire Multiplier", "Fragile_Fire_Multiplier", "fire", g_esFragileSpecial[type][specType].g_flFragileFireMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_flFragileHittableMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileHittableMultiplier", "Fragile Hittable Multiplier", "Fragile_Hittable_Multiplier", "hittable", g_esFragileSpecial[type][specType].g_flFragileHittableMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_flFragileMeleeMultiplier = flGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileMeleeMultiplier", "Fragile Melee Multiplier", "Fragile_Melee_Multiplier", "melee", g_esFragileSpecial[type][specType].g_flFragileMeleeMultiplier, value, -1.0, 99999.0, specName, specType);
			g_esFragileSpecial[type][specType].g_iFragileMode = iGetKeyValue(subsection, MT_FRAGILE_SECTION, MT_FRAGILE_SECTION2, MT_FRAGILE_SECTION3, MT_FRAGILE_SECTION4, key, "FragileMode", "Fragile Mode", "Fragile_Mode", "mode", g_esFragileSpecial[type][specType].g_iFragileMode, value, -1, 1, specName, specType);
...
#endif
{
	...
	{
		g_esFragileCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esFragilePlayer[tank].g_flCloseAreasOnly, g_esFragileSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esFragileAbility[type].g_flCloseAreasOnly, 1);
		g_esFragileCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iComboAbility, g_esFragilePlayer[tank].g_iComboAbility, g_esFragileSpecial[type][iSpecType - 1].g_iComboAbility, g_esFragileAbility[type].g_iComboAbility, 1);
		g_esFragileCache[tank].g_flFragileBulletMultiplier = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileBulletMultiplier, g_esFragilePlayer[tank].g_flFragileBulletMultiplier, g_esFragileSpecial[type][iSpecType - 1].g_flFragileBulletMultiplier, g_esFragileAbility[type].g_flFragileBulletMultiplier, 1);
		g_esFragileCache[tank].g_flFragileChance = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileChance, g_esFragilePlayer[tank].g_flFragileChance, g_esFragileSpecial[type][iSpecType - 1].g_flFragileChance, g_esFragileAbility[type].g_flFragileChance, 1);
		g_esFragileCache[tank].g_flFragileDamageBoost = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileDamageBoost, g_esFragilePlayer[tank].g_flFragileDamageBoost, g_esFragileSpecial[type][iSpecType - 1].g_flFragileDamageBoost, g_esFragileAbility[type].g_flFragileDamageBoost, 1);
		g_esFragileCache[tank].g_flFragileExplosiveMultiplier = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileExplosiveMultiplier, g_esFragilePlayer[tank].g_flFragileExplosiveMultiplier, g_esFragileSpecial[type][iSpecType - 1].g_flFragileExplosiveMultiplier, g_esFragileAbility[type].g_flFragileExplosiveMultiplier, 1);
		g_esFragileCache[tank].g_flFragileFireMultiplier = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileFireMultiplier, g_esFragilePlayer[tank].g_flFragileFireMultiplier, g_esFragileSpecial[type][iSpecType - 1].g_flFragileFireMultiplier, g_esFragileAbility[type].g_flFragileFireMultiplier, 1);
		g_esFragileCache[tank].g_flFragileHittableMultiplier = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileHittableMultiplier, g_esFragilePlayer[tank].g_flFragileHittableMultiplier, g_esFragileSpecial[type][iSpecType - 1].g_flFragileHittableMultiplier, g_esFragileAbility[type].g_flFragileHittableMultiplier, 1);
		g_esFragileCache[tank].g_flFragileMeleeMultiplier = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileMeleeMultiplier, g_esFragilePlayer[tank].g_flFragileMeleeMultiplier, g_esFragileSpecial[type][iSpecType - 1].g_flFragileMeleeMultiplier, g_esFragileAbility[type].g_flFragileMeleeMultiplier, 1);
		g_esFragileCache[tank].g_flFragileSpeedBoost = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flFragileSpeedBoost, g_esFragilePlayer[tank].g_flFragileSpeedBoost, g_esFragileSpecial[type][iSpecType - 1].g_flFragileSpeedBoost, g_esFragileAbility[type].g_flFragileSpeedBoost, 1);
		g_esFragileCache[tank].g_iFragileAbility = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iFragileAbility, g_esFragilePlayer[tank].g_iFragileAbility, g_esFragileSpecial[type][iSpecType - 1].g_iFragileAbility, g_esFragileAbility[type].g_iFragileAbility, 1);
		g_esFragileCache[tank].g_iFragileCooldown = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iFragileCooldown, g_esFragilePlayer[tank].g_iFragileCooldown, g_esFragileSpecial[type][iSpecType - 1].g_iFragileCooldown, g_esFragileAbility[type].g_iFragileCooldown, 1);
		g_esFragileCache[tank].g_iFragileDuration = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iFragileDuration, g_esFragilePlayer[tank].g_iFragileDuration, g_esFragileSpecial[type][iSpecType - 1].g_iFragileDuration, g_esFragileAbility[type].g_iFragileDuration, 1);
		g_esFragileCache[tank].g_iFragileMessage = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iFragileMessage, g_esFragilePlayer[tank].g_iFragileMessage, g_esFragileSpecial[type][iSpecType - 1].g_iFragileMessage, g_esFragileAbility[type].g_iFragileMessage, 1);
		g_esFragileCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esFragilePlayer[tank].g_iHumanAbility, g_esFragileSpecial[type][iSpecType - 1].g_iHumanAbility, g_esFragileAbility[type].g_iHumanAbility, 1);
		g_esFragileCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iHumanAmmo, g_esFragilePlayer[tank].g_iHumanAmmo, g_esFragileSpecial[type][iSpecType - 1].g_iHumanAmmo, g_esFragileAbility[type].g_iHumanAmmo, 1);
		g_esFragileCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iHumanCooldown, g_esFragilePlayer[tank].g_iHumanCooldown, g_esFragileSpecial[type][iSpecType - 1].g_iHumanCooldown, g_esFragileAbility[type].g_iHumanCooldown, 1);
		g_esFragileCache[tank].g_iHumanDuration = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iHumanDuration, g_esFragilePlayer[tank].g_iHumanDuration, g_esFragileSpecial[type][iSpecType - 1].g_iHumanDuration, g_esFragileAbility[type].g_iHumanDuration, 1);
		g_esFragileCache[tank].g_iHumanMode = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iHumanMode, g_esFragilePlayer[tank].g_iHumanMode, g_esFragileSpecial[type][iSpecType - 1].g_iHumanMode, g_esFragileAbility[type].g_iHumanMode, 1);
		g_esFragileCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esFragilePlayer[tank].g_flOpenAreasOnly, g_esFragileSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esFragileAbility[type].g_flOpenAreasOnly, 1);
		g_esFragileCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esFragileTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esFragilePlayer[tank].g_iRequiresHumans, g_esFragileSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esFragileAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
