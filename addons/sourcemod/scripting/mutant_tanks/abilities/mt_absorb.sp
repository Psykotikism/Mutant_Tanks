...
esAbsorbTeammate g_esAbsorbTeammate[MAXPLAYERS + 1][7];
...
esAbsorbSpecial g_esAbsorbSpecial[MT_MAXTYPES + 1][7];
...
#if defined MT_ABILITIES_MAIN
void vAbsorbConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esAbsorbTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esAbsorbTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esAbsorbTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esAbsorbTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esAbsorbTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esAbsorbTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esAbsorbTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esAbsorbTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esAbsorbTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esAbsorbTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esAbsorbTeammate[admin][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esAbsorbTeammate[admin][specType].g_iHumanDuration, value, -1, 99999, specType);
			g_esAbsorbTeammate[admin][specType].g_iHumanMode = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esAbsorbTeammate[admin][specType].g_iHumanMode, value, -1, 1, specType);
			g_esAbsorbTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esAbsorbTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esAbsorbTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esAbsorbTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esAbsorbTeammate[admin][specType].g_iAbsorbAbility = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esAbsorbTeammate[admin][specType].g_iAbsorbAbility, value, -1, 1, specType);
			g_esAbsorbTeammate[admin][specType].g_iAbsorbMessage = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esAbsorbTeammate[admin][specType].g_iAbsorbMessage, value, -1, 1, specType);
			g_esAbsorbTeammate[admin][specType].g_flAbsorbBulletDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbBulletDivisor", "Absorb Bullet Divisor", "Absorb_Bullet_Divisor", "bullet", g_esAbsorbTeammate[admin][specType].g_flAbsorbBulletDivisor, value, -1.0, 99999.0, specType);
			g_esAbsorbTeammate[admin][specType].g_flAbsorbChance = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbChance", "Absorb Chance", "Absorb_Chance", "chance", g_esAbsorbTeammate[admin][specType].g_flAbsorbChance, value, -1.0, 100.0, specType);
			g_esAbsorbTeammate[admin][specType].g_flAbsorbConvertPercentage = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbConvertPercentage", "Absorb Convert Percentage", "Absorb_Convert_Percentage", "convertpercent", g_esAbsorbTeammate[admin][specType].g_flAbsorbConvertPercentage, value, -1.0, 1.0, specType);
			g_esAbsorbTeammate[admin][specType].g_iAbsorbCooldown = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbCooldown", "Absorb Cooldown", "Absorb_Cooldown", "cooldown", g_esAbsorbTeammate[admin][specType].g_iAbsorbCooldown, value, -1, 99999, specType);
			g_esAbsorbTeammate[admin][specType].g_iAbsorbDuration = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbDuration", "Absorb Duration", "Absorb_Duration", "duration", g_esAbsorbTeammate[admin][specType].g_iAbsorbDuration, value, -1, 99999, specType);
			g_esAbsorbTeammate[admin][specType].g_flAbsorbExplosiveDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbExplosiveDivisor", "Absorb Explosive Divisor", "Absorb_Explosive_Divisor", "explosive", g_esAbsorbTeammate[admin][specType].g_flAbsorbExplosiveDivisor, value, -1.0, 99999.0, specType);
			g_esAbsorbTeammate[admin][specType].g_flAbsorbFireDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbFireDivisor", "Absorb Fire Divisor", "Absorb_Fire_Divisor", "fire", g_esAbsorbTeammate[admin][specType].g_flAbsorbFireDivisor, value, -1.0, 99999.0, specType);
			...
			g_esAbsorbTeammate[admin][specType].g_flAbsorbMeleeDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbMeleeDivisor", "Absorb Melee Divisor", "Absorb_Melee_Divisor", "melee", g_esAbsorbTeammate[admin][specType].g_flAbsorbMeleeDivisor, value, -1.0, 99999.0, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esAbsorbSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esAbsorbSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esAbsorbSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esAbsorbSpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esAbsorbSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esAbsorbSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esAbsorbSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esAbsorbSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esAbsorbSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esAbsorbSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esAbsorbSpecial[type][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esAbsorbSpecial[type][specType].g_iHumanDuration, value, -1, 99999, specType);
			g_esAbsorbSpecial[type][specType].g_iHumanMode = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esAbsorbSpecial[type][specType].g_iHumanMode, value, -1, 1, specType);
			g_esAbsorbSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esAbsorbSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esAbsorbSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esAbsorbSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esAbsorbSpecial[type][specType].g_iAbsorbAbility = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esAbsorbSpecial[type][specType].g_iAbsorbAbility, value, -1, 1, specType);
			g_esAbsorbSpecial[type][specType].g_iAbsorbMessage = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esAbsorbSpecial[type][specType].g_iAbsorbMessage, value, -1, 1, specType);
			g_esAbsorbSpecial[type][specType].g_flAbsorbBulletDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbBulletDivisor", "Absorb Bullet Divisor", "Absorb_Bullet_Divisor", "bullet", g_esAbsorbSpecial[type][specType].g_flAbsorbBulletDivisor, value, -1.0, 99999.0, specType);
			g_esAbsorbSpecial[type][specType].g_flAbsorbChance = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbChance", "Absorb Chance", "Absorb_Chance", "chance", g_esAbsorbSpecial[type][specType].g_flAbsorbChance, value, -1.0, 100.0, specType);
			g_esAbsorbSpecial[type][specType].g_flAbsorbConvertPercentage = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbConvertPercentage", "Absorb Convert Percentage", "Absorb_Convert_Percentage", "convertpercent", g_esAbsorbSpecial[type][specType].g_flAbsorbConvertPercentage, value, -1.0, 1.0, specType);
			g_esAbsorbSpecial[type][specType].g_iAbsorbCooldown = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbCooldown", "Absorb Cooldown", "Absorb_Cooldown", "cooldown", g_esAbsorbSpecial[type][specType].g_iAbsorbCooldown, value, -1, 99999, specType);
			g_esAbsorbSpecial[type][specType].g_iAbsorbDuration = iGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbDuration", "Absorb Duration", "Absorb_Duration", "duration", g_esAbsorbSpecial[type][specType].g_iAbsorbDuration, value, -1, 99999, specType);
			g_esAbsorbSpecial[type][specType].g_flAbsorbExplosiveDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbExplosiveDivisor", "Absorb Explosive Divisor", "Absorb_Explosive_Divisor", "explosive", g_esAbsorbSpecial[type][specType].g_flAbsorbExplosiveDivisor, value, -1.0, 99999.0, specType);
			g_esAbsorbSpecial[type][specType].g_flAbsorbFireDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbFireDivisor", "Absorb Fire Divisor", "Absorb_Fire_Divisor", "fire", g_esAbsorbSpecial[type][specType].g_flAbsorbFireDivisor, value, -1.0, 99999.0, specType);
			...
			g_esAbsorbSpecial[type][specType].g_flAbsorbMeleeDivisor = flGetKeyValue(subsection, MT_ABSORB_SECTION, MT_ABSORB_SECTION2, MT_ABSORB_SECTION3, MT_ABSORB_SECTION4, key, "AbsorbMeleeDivisor", "Absorb Melee Divisor", "Absorb_Melee_Divisor", "melee", g_esAbsorbSpecial[type][specType].g_flAbsorbMeleeDivisor, value, -1.0, 99999.0, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esAbsorbCache[tank].g_flAbsorbBulletDivisor = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flAbsorbBulletDivisor, g_esAbsorbTeammate[tank][iSpecType].g_flAbsorbBulletDivisor, g_esAbsorbPlayer[tank].g_flAbsorbBulletDivisor, g_esAbsorbSpecial[type][0].g_flAbsorbBulletDivisor, g_esAbsorbSpecial[type][iSpecType].g_flAbsorbBulletDivisor, g_esAbsorbAbility[type].g_flAbsorbBulletDivisor, 1);
		g_esAbsorbCache[tank].g_flAbsorbChance = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flAbsorbChance, g_esAbsorbTeammate[tank][iSpecType].g_flAbsorbChance, g_esAbsorbPlayer[tank].g_flAbsorbChance, g_esAbsorbSpecial[type][0].g_flAbsorbChance, g_esAbsorbSpecial[type][iSpecType].g_flAbsorbChance, g_esAbsorbAbility[type].g_flAbsorbChance, 1);
		g_esAbsorbCache[tank].g_flAbsorbConvertPercentage = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flAbsorbConvertPercentage, g_esAbsorbTeammate[tank][iSpecType].g_flAbsorbConvertPercentage, g_esAbsorbPlayer[tank].g_flAbsorbConvertPercentage, g_esAbsorbSpecial[type][0].g_flAbsorbConvertPercentage, g_esAbsorbSpecial[type][iSpecType].g_flAbsorbConvertPercentage, g_esAbsorbAbility[type].g_flAbsorbConvertPercentage, 1);
		g_esAbsorbCache[tank].g_flAbsorbExplosiveDivisor = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flAbsorbExplosiveDivisor, g_esAbsorbTeammate[tank][iSpecType].g_flAbsorbExplosiveDivisor, g_esAbsorbPlayer[tank].g_flAbsorbExplosiveDivisor, g_esAbsorbSpecial[type][0].g_flAbsorbExplosiveDivisor, g_esAbsorbSpecial[type][iSpecType].g_flAbsorbExplosiveDivisor, g_esAbsorbAbility[type].g_flAbsorbExplosiveDivisor, 1);
		g_esAbsorbCache[tank].g_flAbsorbFireDivisor = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flAbsorbFireDivisor, g_esAbsorbTeammate[tank][iSpecType].g_flAbsorbFireDivisor, g_esAbsorbPlayer[tank].g_flAbsorbFireDivisor, g_esAbsorbSpecial[type][0].g_flAbsorbFireDivisor, g_esAbsorbSpecial[type][iSpecType].g_flAbsorbFireDivisor, g_esAbsorbAbility[type].g_flAbsorbFireDivisor, 1);
		g_esAbsorbCache[tank].g_flAbsorbHittableDivisor = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flAbsorbHittableDivisor, g_esAbsorbTeammate[tank][iSpecType].g_flAbsorbHittableDivisor, g_esAbsorbPlayer[tank].g_flAbsorbHittableDivisor, g_esAbsorbSpecial[type][0].g_flAbsorbHittableDivisor, g_esAbsorbSpecial[type][iSpecType].g_flAbsorbHittableDivisor, g_esAbsorbAbility[type].g_flAbsorbHittableDivisor, 1);
		g_esAbsorbCache[tank].g_flAbsorbMeleeDivisor = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flAbsorbMeleeDivisor, g_esAbsorbTeammate[tank][iSpecType].g_flAbsorbMeleeDivisor, g_esAbsorbPlayer[tank].g_flAbsorbMeleeDivisor, g_esAbsorbSpecial[type][0].g_flAbsorbMeleeDivisor, g_esAbsorbSpecial[type][iSpecType].g_flAbsorbMeleeDivisor, g_esAbsorbAbility[type].g_flAbsorbMeleeDivisor, 1);
		g_esAbsorbCache[tank].g_iAbsorbAbility = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iAbsorbAbility, g_esAbsorbTeammate[tank][iSpecType].g_iAbsorbAbility, g_esAbsorbPlayer[tank].g_iAbsorbAbility, g_esAbsorbSpecial[type][0].g_iAbsorbAbility, g_esAbsorbSpecial[type][iSpecType].g_iAbsorbAbility, g_esAbsorbAbility[type].g_iAbsorbAbility, 1);
		g_esAbsorbCache[tank].g_iAbsorbCooldown = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iAbsorbCooldown, g_esAbsorbTeammate[tank][iSpecType].g_iAbsorbCooldown, g_esAbsorbPlayer[tank].g_iAbsorbCooldown, g_esAbsorbSpecial[type][0].g_iAbsorbCooldown, g_esAbsorbSpecial[type][iSpecType].g_iAbsorbCooldown, g_esAbsorbAbility[type].g_iAbsorbCooldown, 1);
		g_esAbsorbCache[tank].g_iAbsorbDuration = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iAbsorbDuration, g_esAbsorbTeammate[tank][iSpecType].g_iAbsorbDuration, g_esAbsorbPlayer[tank].g_iAbsorbDuration, g_esAbsorbSpecial[type][0].g_iAbsorbDuration, g_esAbsorbSpecial[type][iSpecType].g_iAbsorbDuration, g_esAbsorbAbility[type].g_iAbsorbDuration, 1);
		g_esAbsorbCache[tank].g_iAbsorbMessage = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iAbsorbMessage, g_esAbsorbTeammate[tank][iSpecType].g_iAbsorbMessage, g_esAbsorbPlayer[tank].g_iAbsorbMessage, g_esAbsorbSpecial[type][0].g_iAbsorbMessage, g_esAbsorbSpecial[type][iSpecType].g_iAbsorbMessage, g_esAbsorbAbility[type].g_iAbsorbMessage, 1);
		g_esAbsorbCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flCloseAreasOnly, g_esAbsorbTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esAbsorbPlayer[tank].g_flCloseAreasOnly, g_esAbsorbSpecial[type][0].g_flCloseAreasOnly, g_esAbsorbSpecial[type][iSpecType].g_flCloseAreasOnly, g_esAbsorbAbility[type].g_flCloseAreasOnly, 1);
		g_esAbsorbCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iComboAbility, g_esAbsorbTeammate[tank][iSpecType].g_iComboAbility, g_esAbsorbPlayer[tank].g_iComboAbility, g_esAbsorbSpecial[type][0].g_iComboAbility, g_esAbsorbSpecial[type][iSpecType].g_iComboAbility, g_esAbsorbAbility[type].g_iComboAbility, 1);
		g_esAbsorbCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iHumanAbility, g_esAbsorbTeammate[tank][iSpecType].g_iHumanAbility, g_esAbsorbPlayer[tank].g_iHumanAbility, g_esAbsorbSpecial[type][0].g_iHumanAbility, g_esAbsorbSpecial[type][iSpecType].g_iHumanAbility, g_esAbsorbAbility[type].g_iHumanAbility, 1);
		g_esAbsorbCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iHumanAmmo, g_esAbsorbTeammate[tank][iSpecType].g_iHumanAmmo, g_esAbsorbPlayer[tank].g_iHumanAmmo, g_esAbsorbSpecial[type][0].g_iHumanAmmo, g_esAbsorbSpecial[type][iSpecType].g_iHumanAmmo, g_esAbsorbAbility[type].g_iHumanAmmo, 1);
		g_esAbsorbCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iHumanCooldown, g_esAbsorbTeammate[tank][iSpecType].g_iHumanCooldown, g_esAbsorbPlayer[tank].g_iHumanCooldown, g_esAbsorbSpecial[type][0].g_iHumanCooldown, g_esAbsorbSpecial[type][iSpecType].g_iHumanCooldown, g_esAbsorbAbility[type].g_iHumanCooldown, 1);
		g_esAbsorbCache[tank].g_iHumanDuration = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iHumanDuration, g_esAbsorbTeammate[tank][iSpecType].g_iHumanDuration, g_esAbsorbPlayer[tank].g_iHumanDuration, g_esAbsorbSpecial[type][0].g_iHumanDuration, g_esAbsorbSpecial[type][iSpecType].g_iHumanDuration, g_esAbsorbAbility[type].g_iHumanDuration, 1);
		g_esAbsorbCache[tank].g_iHumanMode = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iHumanMode, g_esAbsorbTeammate[tank][iSpecType].g_iHumanMode, g_esAbsorbPlayer[tank].g_iHumanMode, g_esAbsorbSpecial[type][0].g_iHumanMode, g_esAbsorbSpecial[type][iSpecType].g_iHumanMode, g_esAbsorbAbility[type].g_iHumanMode, 1);
		g_esAbsorbCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_flOpenAreasOnly, g_esAbsorbTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esAbsorbPlayer[tank].g_flOpenAreasOnly, g_esAbsorbSpecial[type][0].g_flOpenAreasOnly, g_esAbsorbSpecial[type][iSpecType].g_flOpenAreasOnly, g_esAbsorbAbility[type].g_flOpenAreasOnly, 1);
		g_esAbsorbCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esAbsorbTeammate[tank][0].g_iRequiresHumans, g_esAbsorbTeammate[tank][iSpecType].g_iRequiresHumans, g_esAbsorbPlayer[tank].g_iRequiresHumans, g_esAbsorbSpecial[type][0].g_iRequiresHumans, g_esAbsorbSpecial[type][iSpecType].g_iRequiresHumans, g_esAbsorbAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esAbsorbCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esAbsorbCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esAbsorbPlayer[tank].g_iTankType, tank) || (g_esAbsorbCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esAbsorbCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esAbsorbAbility[g_esAbsorbPlayer[tank].g_iTankType].g_iAccessFlags, g_esAbsorbPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
void tTimerAbsorbCombo(Handle timer, DataPack pack)
{
	...
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esAbsorbAbility[g_esAbsorbPlayer[iTank].g_iTankType].g_iAccessFlags, g_esAbsorbPlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esAbsorbPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esAbsorbCache[iTank].g_iAbsorbAbility == 0 || g_esAbsorbPlayer[iTank].g_bActivated)
	{
		return;
	}
