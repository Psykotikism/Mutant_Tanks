...
esElectricTeammate g_esElectricTeammate[MAXPLAYERS + 1][7];
...
esElectricSpecial g_esElectricSpecial[MT_MAXTYPES + 1][7];
	...
	switch (mode)
	{
		case 1:
		{
			for (int iIndex = MT_GetMinType(); iIndex <= MT_GetMaxType(); iIndex++)
			{
				...
				{
					g_esElectricSpecial[iIndex][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esElectricSpecial[iIndex][iSpecType].g_iComboAbility = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iHumanAbility = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iHumanAmmo = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iHumanCooldown = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iHumanRangeCooldown = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esElectricSpecial[iIndex][iSpecType].g_iRequiresHumans = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricAbility = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricEffect = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricMessage = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_flElectricChance = -1.0;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricCooldown = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_flElectricDamage = -1.0;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricDuration = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricHit = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricHitMode = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_flElectricInterval = -1.0;
					g_esElectricSpecial[iIndex][iSpecType].g_flElectricRange = -1.0;
					g_esElectricSpecial[iIndex][iSpecType].g_flElectricRangeChance = -1.0;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricRangeCooldown = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_iElectricSight = -1;
					g_esElectricSpecial[iIndex][iSpecType].g_flElectricStunSpeed = -1.0;
				}
			}
		}
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				...
				for (int iSpecType = 0; iSpecType < (sizeof g_sSpecialNames); iSpecType++)
				{
					g_esElectricTeammate[iPlayer][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esElectricTeammate[iPlayer][iSpecType].g_iComboAbility = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iHumanAbility = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iHumanAmmo = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iHumanCooldown = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iHumanRangeCooldown = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esElectricTeammate[iPlayer][iSpecType].g_iRequiresHumans = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricAbility = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricEffect = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricMessage = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_flElectricChance = -1.0;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricCooldown = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_flElectricDamage = -1.0;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricDuration = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricHit = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricHitMode = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_flElectricInterval = -1.0;
					g_esElectricTeammate[iPlayer][iSpecType].g_flElectricRange = -1.0;
					g_esElectricTeammate[iPlayer][iSpecType].g_flElectricRangeChance = -1.0;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricRangeCooldown = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_iElectricSight = -1;
					g_esElectricTeammate[iPlayer][iSpecType].g_flElectricStunSpeed = -1.0;
				}
			}
		}
	}
...
#if defined MT_ABILITIES_MAIN
void vElectricConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esElectricTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esElectricTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esElectricTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esElectricTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esElectricTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esElectricTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esElectricTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esElectricTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esElectricTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esElectricTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esElectricTeammate[admin][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esElectricTeammate[admin][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esElectricTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esElectricTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esElectricTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esElectricTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esElectricTeammate[admin][specType].g_iElectricAbility = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esElectricTeammate[admin][specType].g_iElectricAbility, value, -1, 1, specType);
			g_esElectricTeammate[admin][specType].g_iElectricEffect = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esElectricTeammate[admin][specType].g_iElectricEffect, value, -1, 7, specType);
			g_esElectricTeammate[admin][specType].g_iElectricMessage = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esElectricTeammate[admin][specType].g_iElectricMessage, value, -1, 3, specType);
			g_esElectricTeammate[admin][specType].g_iElectricSight = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esElectricTeammate[admin][specType].g_iElectricSight, value, -1, 2, specType);
			g_esElectricTeammate[admin][specType].g_flElectricChance = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricChance", "Electric Chance", "Electric_Chance", "chance", g_esElectricTeammate[admin][specType].g_flElectricChance, value, -1.0, 100.0, specType);
			g_esElectricTeammate[admin][specType].g_iElectricCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricCooldown", "Electric Cooldown", "Electric_Cooldown", "cooldown", g_esElectricTeammate[admin][specType].g_iElectricCooldown, value, -1, 99999, specType);
			g_esElectricTeammate[admin][specType].g_flElectricDamage = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricDamage", "Electric Damage", "Electric_Damage", "damage", g_esElectricTeammate[admin][specType].g_flElectricDamage, value, -1.0, 99999.0, specType);
			g_esElectricTeammate[admin][specType].g_iElectricDuration = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricDuration", "Electric Duration", "Electric_Duration", "duration", g_esElectricTeammate[admin][specType].g_iElectricDuration, value, -1, 99999, specType);
			g_esElectricTeammate[admin][specType].g_iElectricHit = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricHit", "Electric Hit", "Electric_Hit", "hit", g_esElectricTeammate[admin][specType].g_iElectricHit, value, -1, 1, specType);
			g_esElectricTeammate[admin][specType].g_iElectricHitMode = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricHitMode", "Electric Hit Mode", "Electric_Hit_Mode", "hitmode", g_esElectricTeammate[admin][specType].g_iElectricHitMode, value, -1, 2, specType);
			g_esElectricTeammate[admin][specType].g_flElectricInterval = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricInterval", "Electric Interval", "Electric_Interval", "interval", g_esElectricTeammate[admin][specType].g_flElectricInterval, value, -1.0, 99999.0, specType);
			g_esElectricTeammate[admin][specType].g_flElectricRange = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricRange", "Electric Range", "Electric_Range", "range", g_esElectricTeammate[admin][specType].g_flElectricRange, value, -1.0, 99999.0, specType);
			g_esElectricTeammate[admin][specType].g_flElectricRangeChance = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricRangeChance", "Electric Range Chance", "Electric_Range_Chance", "rangechance", g_esElectricTeammate[admin][specType].g_flElectricRangeChance, value, -1.0, 100.0, specType);
			g_esElectricTeammate[admin][specType].g_iElectricRangeCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricRangeCooldown", "Electric Range Cooldown", "Electric_Range_Cooldown", "rangecooldown", g_esElectricTeammate[admin][specType].g_iElectricRangeCooldown, value, -1, 99999, specType);
			g_esElectricTeammate[admin][specType].g_flElectricStunSpeed = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricStunSpeed", "Electric Stun Speed", "Electric_Stun_Speed", "stunspeed", g_esElectricTeammate[admin][specType].g_flElectricStunSpeed, value, -1.0, 0.99, specType);
		}
		else
		{
			...
			g_esElectricPlayer[admin].g_iElectricSight = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esElectricPlayer[admin].g_iElectricSight, value, -1, 2);
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esElectricSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esElectricSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esElectricSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esElectricSpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esElectricSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esElectricSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esElectricSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esElectricSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esElectricSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esElectricSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esElectricSpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esElectricSpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esElectricSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esElectricSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esElectricSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esElectricSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esElectricSpecial[type][specType].g_iElectricAbility = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esElectricSpecial[type][specType].g_iElectricAbility, value, -1, 1, specType);
			g_esElectricSpecial[type][specType].g_iElectricEffect = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esElectricSpecial[type][specType].g_iElectricEffect, value, -1, 7, specType);
			g_esElectricSpecial[type][specType].g_iElectricMessage = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esElectricSpecial[type][specType].g_iElectricMessage, value, -1, 3, specType);
			g_esElectricSpecial[type][specType].g_iElectricSight = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esElectricSpecial[type][specType].g_iElectricSight, value, -1, 2, specType);
			g_esElectricSpecial[type][specType].g_flElectricChance = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricChance", "Electric Chance", "Electric_Chance", "chance", g_esElectricSpecial[type][specType].g_flElectricChance, value, -1.0, 100.0, specType);
			g_esElectricSpecial[type][specType].g_iElectricCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricCooldown", "Electric Cooldown", "Electric_Cooldown", "cooldown", g_esElectricSpecial[type][specType].g_iElectricCooldown, value, -1, 99999, specType);
			g_esElectricSpecial[type][specType].g_flElectricDamage = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricDamage", "Electric Damage", "Electric_Damage", "damage", g_esElectricSpecial[type][specType].g_flElectricDamage, value, -1.0, 99999.0, specType);
			g_esElectricSpecial[type][specType].g_iElectricDuration = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricDuration", "Electric Duration", "Electric_Duration", "duration", g_esElectricSpecial[type][specType].g_iElectricDuration, value, -1, 99999, specType);
			g_esElectricSpecial[type][specType].g_iElectricHit = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricHit", "Electric Hit", "Electric_Hit", "hit", g_esElectricSpecial[type][specType].g_iElectricHit, value, -1, 1, specType);
			g_esElectricSpecial[type][specType].g_iElectricHitMode = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricHitMode", "Electric Hit Mode", "Electric_Hit_Mode", "hitmode", g_esElectricSpecial[type][specType].g_iElectricHitMode, value, -1, 2, specType);
			g_esElectricSpecial[type][specType].g_flElectricInterval = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricInterval", "Electric Interval", "Electric_Interval", "interval", g_esElectricSpecial[type][specType].g_flElectricInterval, value, -1.0, 99999.0, specType);
			g_esElectricSpecial[type][specType].g_flElectricRange = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricRange", "Electric Range", "Electric_Range", "range", g_esElectricSpecial[type][specType].g_flElectricRange, value, -1.0, 99999.0, specType);
			g_esElectricSpecial[type][specType].g_flElectricRangeChance = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricRangeChance", "Electric Range Chance", "Electric_Range_Chance", "rangechance", g_esElectricSpecial[type][specType].g_flElectricRangeChance, value, -1.0, 100.0, specType);
			g_esElectricSpecial[type][specType].g_iElectricRangeCooldown = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricRangeCooldown", "Electric Range Cooldown", "Electric_Range_Cooldown", "rangecooldown", g_esElectricSpecial[type][specType].g_iElectricRangeCooldown, value, -1, 99999, specType);
			g_esElectricSpecial[type][specType].g_flElectricStunSpeed = flGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "ElectricStunSpeed", "Electric Stun Speed", "Electric_Stun_Speed", "stunspeed", g_esElectricSpecial[type][specType].g_flElectricStunSpeed, value, -1.0, 0.99, specType);
		}
		else
		{
			...
			g_esElectricAbility[type].g_iElectricSight = iGetKeyValue(subsection, MT_ELECTRIC_SECTION, MT_ELECTRIC_SECTION2, MT_ELECTRIC_SECTION3, MT_ELECTRIC_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esElectricAbility[type].g_iElectricSight, value, -1, 2);
...
#endif
{
	...
	g_esElectricPlayer[tank].g_iInfectedType = iGetInfectedType(tank);
	g_esElectricPlayer[tank].g_iTankType = apply ? type : 0;
	int iSpecType = g_esElectricPlayer[tank].g_iInfectedType;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esElectricCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flCloseAreasOnly, g_esElectricTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esElectricPlayer[tank].g_flCloseAreasOnly, g_esElectricSpecial[type][0].g_flCloseAreasOnly, g_esElectricSpecial[type][iSpecType].g_flCloseAreasOnly, g_esElectricAbility[type].g_flCloseAreasOnly, 1);
		g_esElectricCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iComboAbility, g_esElectricTeammate[tank][iSpecType].g_iComboAbility, g_esElectricPlayer[tank].g_iComboAbility, g_esElectricSpecial[type][0].g_iComboAbility, g_esElectricSpecial[type][iSpecType].g_iComboAbility, g_esElectricAbility[type].g_iComboAbility, 1);
		g_esElectricCache[tank].g_flElectricChance = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flElectricChance, g_esElectricTeammate[tank][iSpecType].g_flElectricChance, g_esElectricPlayer[tank].g_flElectricChance, g_esElectricSpecial[type][0].g_flElectricChance, g_esElectricSpecial[type][iSpecType].g_flElectricChance, g_esElectricAbility[type].g_flElectricChance, 1);
		g_esElectricCache[tank].g_flElectricDamage = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flElectricDamage, g_esElectricTeammate[tank][iSpecType].g_flElectricDamage, g_esElectricPlayer[tank].g_flElectricDamage, g_esElectricSpecial[type][0].g_flElectricDamage, g_esElectricSpecial[type][iSpecType].g_flElectricDamage, g_esElectricAbility[type].g_flElectricDamage, 1);
		g_esElectricCache[tank].g_iElectricDuration = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricDuration, g_esElectricTeammate[tank][iSpecType].g_iElectricDuration, g_esElectricPlayer[tank].g_iElectricDuration, g_esElectricSpecial[type][0].g_iElectricDuration, g_esElectricSpecial[type][iSpecType].g_iElectricDuration, g_esElectricAbility[type].g_iElectricDuration, 1);
		g_esElectricCache[tank].g_flElectricInterval = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flElectricInterval, g_esElectricTeammate[tank][iSpecType].g_flElectricInterval, g_esElectricPlayer[tank].g_flElectricInterval, g_esElectricSpecial[type][0].g_flElectricInterval, g_esElectricSpecial[type][iSpecType].g_flElectricInterval, g_esElectricAbility[type].g_flElectricInterval, 1);
		g_esElectricCache[tank].g_flElectricRange = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flElectricRange, g_esElectricTeammate[tank][iSpecType].g_flElectricRange, g_esElectricPlayer[tank].g_flElectricRange, g_esElectricSpecial[type][0].g_flElectricRange, g_esElectricSpecial[type][iSpecType].g_flElectricRange, g_esElectricAbility[type].g_flElectricRange, 1);
		g_esElectricCache[tank].g_flElectricRangeChance = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flElectricRangeChance, g_esElectricTeammate[tank][iSpecType].g_flElectricRangeChance, g_esElectricPlayer[tank].g_flElectricRangeChance, g_esElectricSpecial[type][0].g_flElectricRangeChance, g_esElectricSpecial[type][iSpecType].g_flElectricRangeChance, g_esElectricAbility[type].g_flElectricRangeChance, 1);
		g_esElectricCache[tank].g_flElectricStunSpeed = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flElectricStunSpeed, g_esElectricTeammate[tank][iSpecType].g_flElectricStunSpeed, g_esElectricPlayer[tank].g_flElectricStunSpeed, g_esElectricSpecial[type][0].g_flElectricStunSpeed, g_esElectricSpecial[type][iSpecType].g_flElectricStunSpeed, g_esElectricAbility[type].g_flElectricStunSpeed, 1);
		g_esElectricCache[tank].g_iElectricAbility = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricAbility, g_esElectricTeammate[tank][iSpecType].g_iElectricAbility, g_esElectricPlayer[tank].g_iElectricAbility, g_esElectricSpecial[type][0].g_iElectricAbility, g_esElectricSpecial[type][iSpecType].g_iElectricAbility, g_esElectricAbility[type].g_iElectricAbility, 1);
		g_esElectricCache[tank].g_iElectricCooldown = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricCooldown, g_esElectricTeammate[tank][iSpecType].g_iElectricCooldown, g_esElectricPlayer[tank].g_iElectricCooldown, g_esElectricSpecial[type][0].g_iElectricCooldown, g_esElectricSpecial[type][iSpecType].g_iElectricCooldown, g_esElectricAbility[type].g_iElectricCooldown, 1);
		g_esElectricCache[tank].g_iElectricEffect = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricEffect, g_esElectricTeammate[tank][iSpecType].g_iElectricEffect, g_esElectricPlayer[tank].g_iElectricEffect, g_esElectricSpecial[type][0].g_iElectricEffect, g_esElectricSpecial[type][iSpecType].g_iElectricEffect, g_esElectricAbility[type].g_iElectricEffect, 1);
		g_esElectricCache[tank].g_iElectricHit = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricHit, g_esElectricTeammate[tank][iSpecType].g_iElectricHit, g_esElectricPlayer[tank].g_iElectricHit, g_esElectricSpecial[type][0].g_iElectricHit, g_esElectricSpecial[type][iSpecType].g_iElectricHit, g_esElectricAbility[type].g_iElectricHit, 1);
		g_esElectricCache[tank].g_iElectricHitMode = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricHitMode, g_esElectricTeammate[tank][iSpecType].g_iElectricHitMode, g_esElectricPlayer[tank].g_iElectricHitMode, g_esElectricSpecial[type][0].g_iElectricHitMode, g_esElectricSpecial[type][iSpecType].g_iElectricHitMode, g_esElectricAbility[type].g_iElectricHitMode, 1);
		g_esElectricCache[tank].g_iElectricMessage = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricMessage, g_esElectricTeammate[tank][iSpecType].g_iElectricMessage, g_esElectricPlayer[tank].g_iElectricMessage, g_esElectricSpecial[type][0].g_iElectricMessage, g_esElectricSpecial[type][iSpecType].g_iElectricMessage, g_esElectricAbility[type].g_iElectricMessage, 1);
		g_esElectricCache[tank].g_iElectricRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricRangeCooldown, g_esElectricTeammate[tank][iSpecType].g_iElectricRangeCooldown, g_esElectricPlayer[tank].g_iElectricRangeCooldown, g_esElectricSpecial[type][0].g_iElectricRangeCooldown, g_esElectricSpecial[type][iSpecType].g_iElectricRangeCooldown, g_esElectricAbility[type].g_iElectricRangeCooldown, 1);
		g_esElectricCache[tank].g_iElectricSight = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iElectricSight, g_esElectricTeammate[tank][iSpecType].g_iElectricSight, g_esElectricPlayer[tank].g_iElectricSight, g_esElectricSpecial[type][0].g_iElectricSight, g_esElectricSpecial[type][iSpecType].g_iElectricSight, g_esElectricAbility[type].g_iElectricSight, 1);
		g_esElectricCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iHumanAbility, g_esElectricTeammate[tank][iSpecType].g_iHumanAbility, g_esElectricPlayer[tank].g_iHumanAbility, g_esElectricSpecial[type][0].g_iHumanAbility, g_esElectricSpecial[type][iSpecType].g_iHumanAbility, g_esElectricAbility[type].g_iHumanAbility, 1);
		g_esElectricCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iHumanAmmo, g_esElectricTeammate[tank][iSpecType].g_iHumanAmmo, g_esElectricPlayer[tank].g_iHumanAmmo, g_esElectricSpecial[type][0].g_iHumanAmmo, g_esElectricSpecial[type][iSpecType].g_iHumanAmmo, g_esElectricAbility[type].g_iHumanAmmo, 1);
		g_esElectricCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iHumanCooldown, g_esElectricTeammate[tank][iSpecType].g_iHumanCooldown, g_esElectricPlayer[tank].g_iHumanCooldown, g_esElectricSpecial[type][0].g_iHumanCooldown, g_esElectricSpecial[type][iSpecType].g_iHumanCooldown, g_esElectricAbility[type].g_iHumanCooldown, 1);
		g_esElectricCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iHumanRangeCooldown, g_esElectricTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esElectricPlayer[tank].g_iHumanRangeCooldown, g_esElectricSpecial[type][0].g_iHumanRangeCooldown, g_esElectricSpecial[type][iSpecType].g_iHumanRangeCooldown, g_esElectricAbility[type].g_iHumanRangeCooldown, 1);
		g_esElectricCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_flOpenAreasOnly, g_esElectricTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esElectricPlayer[tank].g_flOpenAreasOnly, g_esElectricSpecial[type][0].g_flOpenAreasOnly, g_esElectricSpecial[type][iSpecType].g_flOpenAreasOnly, g_esElectricAbility[type].g_flOpenAreasOnly, 1);
		g_esElectricCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esElectricTeammate[tank][0].g_iRequiresHumans, g_esElectricTeammate[tank][iSpecType].g_iRequiresHumans, g_esElectricPlayer[tank].g_iRequiresHumans, g_esElectricSpecial[type][0].g_iRequiresHumans, g_esElectricSpecial[type][iSpecType].g_iRequiresHumans, g_esElectricAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
...
#endif
{
	...
	else if (StrEqual(name, "player_now_it"))
	{
		...
		{
			vElectricHit(iSurvivor, iBoomer, GetRandomFloat(0.1, 100.0), g_esElectricCache[iBoomer].g_flElectricChance, g_esElectricCache[iBoomer].g_iElectricHit, MT_MESSAGE_MELEE, MT_ATTACK_CLAW);
		}
	}
}
