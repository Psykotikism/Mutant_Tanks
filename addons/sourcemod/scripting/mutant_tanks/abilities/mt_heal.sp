...
esHealTeammate g_esHealTeammate[MAXPLAYERS + 1][7];
...
esHealSpecial g_esHealSpecial[MT_MAXTYPES + 1][7];
...
#if defined MT_ABILITIES_MAIN
void vHealConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esHealTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esHealTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esHealTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esHealTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esHealTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esHealTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esHealTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esHealTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esHealTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esHealTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esHealTeammate[admin][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esHealTeammate[admin][specType].g_iHumanDuration, value, -1, 99999, specType);
			g_esHealTeammate[admin][specType].g_iHumanMode = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esHealTeammate[admin][specType].g_iHumanMode, value, -1, 1, specType);
			...
			g_esHealTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esHealTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esHealTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esHealTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esHealTeammate[admin][specType].g_iHealAbility = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esHealTeammate[admin][specType].g_iHealAbility, value, -1, 3, specType);
			g_esHealTeammate[admin][specType].g_iHealEffect = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esHealTeammate[admin][specType].g_iHealEffect, value, -1, 7, specType);
			g_esHealTeammate[admin][specType].g_iHealMessage = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esHealTeammate[admin][specType].g_iHealMessage, value, -1, 7, specType);
			g_esHealTeammate[admin][specType].g_iHealSight = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esHealTeammate[admin][specType].g_iHealSight, value, -1, 2, specType);
			g_esHealTeammate[admin][specType].g_flHealAbsorbRange = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealAbsorbRange", "Heal Absorb Range", "Heal_Absorb_Range", "absorbrange", g_esHealTeammate[admin][specType].g_flHealAbsorbRange, value, -1.0, 99999.0, specType);
			g_esHealTeammate[admin][specType].g_flHealBuffer = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealBuffer", "Heal Buffer", "Heal_Buffer", "buffer", g_esHealTeammate[admin][specType].g_flHealBuffer, value, -1.0, float(MT_MAXHEALTH), specType);
			g_esHealTeammate[admin][specType].g_flHealChance = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealChance", "Heal Chance", "Heal_Chance", "chance", g_esHealTeammate[admin][specType].g_flHealChance, value, -1.0, 100.0, specType);
			g_esHealTeammate[admin][specType].g_iHealCooldown = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealCooldown", "Heal Cooldown", "Heal_Cooldown", "cooldown", g_esHealTeammate[admin][specType].g_iHealCooldown, value, -1, 99999, specType);
			g_esHealTeammate[admin][specType].g_iHealDuration = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealDuration", "Heal Duration", "Heal_Duration", "duration", g_esHealTeammate[admin][specType].g_iHealDuration, value, -1, 99999, specType);
			g_esHealTeammate[admin][specType].g_iHealHit = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealHit", "Heal Hit", "Heal_Hit", "hit", g_esHealTeammate[admin][specType].g_iHealHit, value, -1, 1, specType);
			g_esHealTeammate[admin][specType].g_iHealHitMode = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealHitMode", "Heal Hit Mode", "Heal_Hit_Mode", "hitmode", g_esHealTeammate[admin][specType].g_iHealHitMode, value, -1, 2, specType);
			g_esHealTeammate[admin][specType].g_flHealInterval = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealInterval", "Heal Interval", "Heal_Interval", "interval", g_esHealTeammate[admin][specType].g_flHealInterval, value, -1.0, 99999.0, specType);
			g_esHealTeammate[admin][specType].g_flHealRange = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealRange", "Heal Range", "Heal_Range", "range", g_esHealTeammate[admin][specType].g_flHealRange, value, -1.0, 99999.0, specType);
			g_esHealTeammate[admin][specType].g_flHealRangeChance = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealRangeChance", "Heal Range Chance", "Heal_Range_Chance", "rangechance", g_esHealTeammate[admin][specType].g_flHealRangeChance, value, -1.0, 100.0, specType);
			g_esHealTeammate[admin][specType].g_iHealRangeCooldown = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealRangeCooldown", "Heal Range Cooldown", "Heal_Range_Cooldown", "rangecooldown", g_esHealTeammate[admin][specType].g_iHealRangeCooldown, value, -1, 99999, specType);
			g_esHealTeammate[admin][specType].g_iHealCommon = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealthFromCommons", "Health From Commons", "Health_From_Commons", "commons", g_esHealTeammate[admin][specType].g_iHealCommon, value, MT_MAX_HEALTH_REDUCTION, MT_MAXHEALTH, specType);
			g_esHealTeammate[admin][specType].g_iHealGlow = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealGlow", "Heal Glow", "Heal_Glow", "glow", g_esHealTeammate[admin][specType].g_iHealGlow, value, -1, 1, specType);
			g_esHealTeammate[admin][specType].g_iHealSpecial = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealthFromSpecials", "Health From Specials", "Health_From_Specials", "specials", g_esHealTeammate[admin][specType].g_iHealSpecial, value, MT_MAX_HEALTH_REDUCTION, MT_MAXHEALTH, specType);
			g_esHealTeammate[admin][specType].g_iHealTank = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealthFromTanks", "Health From Tanks", "Health_From_Tanks", "tanks", g_esHealTeammate[admin][specType].g_iHealTank, value, MT_MAX_HEALTH_REDUCTION, MT_MAXHEALTH, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esHealSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esHealSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esHealSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esHealSpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esHealSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esHealSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esHealSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esHealSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esHealSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esHealSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esHealSpecial[type][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esHealSpecial[type][specType].g_iHumanDuration, value, -1, 99999, specType);
			g_esHealSpecial[type][specType].g_iHumanMode = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esHealSpecial[type][specType].g_iHumanMode, value, -1, 1, specType);
			g_esHealSpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esHealSpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esHealSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esHealSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esHealSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esHealSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esHealSpecial[type][specType].g_iHealAbility = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esHealSpecial[type][specType].g_iHealAbility, value, -1, 3, specType);
			g_esHealSpecial[type][specType].g_iHealEffect = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esHealSpecial[type][specType].g_iHealEffect, value, -1, 7, specType);
			g_esHealSpecial[type][specType].g_iHealMessage = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esHealSpecial[type][specType].g_iHealMessage, value, -1, 7, specType);
			g_esHealSpecial[type][specType].g_iHealSight = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esHealSpecial[type][specType].g_iHealSight, value, -1, 2, specType);
			g_esHealSpecial[type][specType].g_flHealAbsorbRange = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealAbsorbRange", "Heal Absorb Range", "Heal_Absorb_Range", "absorbrange", g_esHealSpecial[type][specType].g_flHealAbsorbRange, value, -1.0, 99999.0, specType);
			g_esHealSpecial[type][specType].g_flHealBuffer = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealBuffer", "Heal Buffer", "Heal_Buffer", "buffer", g_esHealSpecial[type][specType].g_flHealBuffer, value, -1.0, float(MT_MAXHEALTH), specType);
			g_esHealSpecial[type][specType].g_flHealChance = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealChance", "Heal Chance", "Heal_Chance", "chance", g_esHealSpecial[type][specType].g_flHealChance, value, -1.0, 100.0, specType);
			g_esHealSpecial[type][specType].g_iHealCooldown = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealCooldown", "Heal Cooldown", "Heal_Cooldown", "cooldown", g_esHealSpecial[type][specType].g_iHealCooldown, value, -1, 99999, specType);
			g_esHealSpecial[type][specType].g_iHealDuration = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealDuration", "Heal Duration", "Heal_Duration", "duration", g_esHealSpecial[type][specType].g_iHealDuration, value, -1, 99999, specType);
			g_esHealSpecial[type][specType].g_iHealHit = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealHit", "Heal Hit", "Heal_Hit", "hit", g_esHealSpecial[type][specType].g_iHealHit, value, -1, 1, specType);
			g_esHealSpecial[type][specType].g_iHealHitMode = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealHitMode", "Heal Hit Mode", "Heal_Hit_Mode", "hitmode", g_esHealSpecial[type][specType].g_iHealHitMode, value, -1, 2, specType);
			g_esHealSpecial[type][specType].g_flHealInterval = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealInterval", "Heal Interval", "Heal_Interval", "interval", g_esHealSpecial[type][specType].g_flHealInterval, value, -1.0, 99999.0, specType);
			g_esHealSpecial[type][specType].g_flHealRange = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealRange", "Heal Range", "Heal_Range", "range", g_esHealSpecial[type][specType].g_flHealRange, value, -1.0, 99999.0, specType);
			g_esHealSpecial[type][specType].g_flHealRangeChance = flGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealRangeChance", "Heal Range Chance", "Heal_Range_Chance", "rangechance", g_esHealSpecial[type][specType].g_flHealRangeChance, value, -1.0, 100.0, specType);
			g_esHealSpecial[type][specType].g_iHealRangeCooldown = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealRangeCooldown", "Heal Range Cooldown", "Heal_Range_Cooldown", "rangecooldown", g_esHealSpecial[type][specType].g_iHealRangeCooldown, value, -1, 99999, specType);
			g_esHealSpecial[type][specType].g_iHealCommon = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealthFromCommons", "Health From Commons", "Health_From_Commons", "commons", g_esHealSpecial[type][specType].g_iHealCommon, value, MT_MAX_HEALTH_REDUCTION, MT_MAXHEALTH, specType);
			g_esHealSpecial[type][specType].g_iHealGlow = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealGlow", "Heal Glow", "Heal_Glow", "glow", g_esHealSpecial[type][specType].g_iHealGlow, value, -1, 1, specType);
			g_esHealSpecial[type][specType].g_iHealSpecial = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealthFromSpecials", "Health From Specials", "Health_From_Specials", "specials", g_esHealSpecial[type][specType].g_iHealSpecial, value, MT_MAX_HEALTH_REDUCTION, MT_MAXHEALTH, specType);
			g_esHealSpecial[type][specType].g_iHealTank = iGetKeyValue(subsection, MT_HEAL_SECTION, MT_HEAL_SECTION2, MT_HEAL_SECTION3, MT_HEAL_SECTION4, key, "HealthFromTanks", "Health From Tanks", "Health_From_Tanks", "tanks", g_esHealSpecial[type][specType].g_iHealTank, value, MT_MAX_HEALTH_REDUCTION, MT_MAXHEALTH, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esHealCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flCloseAreasOnly, g_esHealTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esHealPlayer[tank].g_flCloseAreasOnly, g_esHealSpecial[type][0].g_flCloseAreasOnly, g_esHealSpecial[type][iSpecType].g_flCloseAreasOnly, g_esHealAbility[type].g_flCloseAreasOnly, 1);
		g_esHealCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iComboAbility, g_esHealTeammate[tank][iSpecType].g_iComboAbility, g_esHealPlayer[tank].g_iComboAbility, g_esHealSpecial[type][0].g_iComboAbility, g_esHealSpecial[type][iSpecType].g_iComboAbility, g_esHealAbility[type].g_iComboAbility, 1);
		g_esHealCache[tank].g_flHealAbsorbRange = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flHealAbsorbRange, g_esHealTeammate[tank][iSpecType].g_flHealAbsorbRange, g_esHealPlayer[tank].g_flHealAbsorbRange, g_esHealSpecial[type][0].g_flHealAbsorbRange, g_esHealSpecial[type][iSpecType].g_flHealAbsorbRange, g_esHealAbility[type].g_flHealAbsorbRange, 1);
		g_esHealCache[tank].g_flHealBuffer = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flHealBuffer, g_esHealTeammate[tank][iSpecType].g_flHealBuffer, g_esHealPlayer[tank].g_flHealBuffer, g_esHealSpecial[type][0].g_flHealBuffer, g_esHealSpecial[type][iSpecType].g_flHealBuffer, g_esHealAbility[type].g_flHealBuffer, 1);
		g_esHealCache[tank].g_flHealChance = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flHealChance, g_esHealTeammate[tank][iSpecType].g_flHealChance, g_esHealPlayer[tank].g_flHealChance, g_esHealSpecial[type][0].g_flHealChance, g_esHealSpecial[type][iSpecType].g_flHealChance, g_esHealAbility[type].g_flHealChance, 1);
		g_esHealCache[tank].g_flHealInterval = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flHealInterval, g_esHealTeammate[tank][iSpecType].g_flHealInterval, g_esHealPlayer[tank].g_flHealInterval, g_esHealSpecial[type][0].g_flHealInterval, g_esHealSpecial[type][iSpecType].g_flHealInterval, g_esHealAbility[type].g_flHealInterval, 1);
		g_esHealCache[tank].g_flHealRange = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flHealRange, g_esHealTeammate[tank][iSpecType].g_flHealRange, g_esHealPlayer[tank].g_flHealRange, g_esHealSpecial[type][0].g_flHealRange, g_esHealSpecial[type][iSpecType].g_flHealRange, g_esHealAbility[type].g_flHealRange, 1);
		g_esHealCache[tank].g_flHealRangeChance = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flHealRangeChance, g_esHealTeammate[tank][iSpecType].g_flHealRangeChance, g_esHealPlayer[tank].g_flHealRangeChance, g_esHealSpecial[type][0].g_flHealRangeChance, g_esHealSpecial[type][iSpecType].g_flHealRangeChance, g_esHealAbility[type].g_flHealRangeChance, 1);
		g_esHealCache[tank].g_iHealAbility = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealAbility, g_esHealTeammate[tank][iSpecType].g_iHealAbility, g_esHealPlayer[tank].g_iHealAbility, g_esHealSpecial[type][0].g_iHealAbility, g_esHealSpecial[type][iSpecType].g_iHealAbility, g_esHealAbility[type].g_iHealAbility, 1);
		g_esHealCache[tank].g_iHealCommon = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealCommon, g_esHealTeammate[tank][iSpecType].g_iHealCommon, g_esHealPlayer[tank].g_iHealCommon, g_esHealSpecial[type][0].g_iHealCommon, g_esHealSpecial[type][iSpecType].g_iHealCommon, g_esHealAbility[type].g_iHealCommon, 2, 1);
		g_esHealCache[tank].g_iHealCooldown = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealCooldown, g_esHealTeammate[tank][iSpecType].g_iHealCooldown, g_esHealPlayer[tank].g_iHealCooldown, g_esHealSpecial[type][0].g_iHealCooldown, g_esHealSpecial[type][iSpecType].g_iHealCooldown, g_esHealAbility[type].g_iHealCooldown, 1);
		g_esHealCache[tank].g_iHealDuration = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealDuration, g_esHealTeammate[tank][iSpecType].g_iHealDuration, g_esHealPlayer[tank].g_iHealDuration, g_esHealSpecial[type][0].g_iHealDuration, g_esHealSpecial[type][iSpecType].g_iHealDuration, g_esHealAbility[type].g_iHealDuration, 1);
		g_esHealCache[tank].g_iHealEffect = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealEffect, g_esHealTeammate[tank][iSpecType].g_iHealEffect, g_esHealPlayer[tank].g_iHealEffect, g_esHealSpecial[type][0].g_iHealEffect, g_esHealSpecial[type][iSpecType].g_iHealEffect, g_esHealAbility[type].g_iHealEffect, 1);
		g_esHealCache[tank].g_iHealGlow = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealGlow, g_esHealTeammate[tank][iSpecType].g_iHealGlow, g_esHealPlayer[tank].g_iHealGlow, g_esHealSpecial[type][0].g_iHealGlow, g_esHealSpecial[type][iSpecType].g_iHealGlow, g_esHealAbility[type].g_iHealGlow, 1);
		g_esHealCache[tank].g_iHealHit = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealHit, g_esHealTeammate[tank][iSpecType].g_iHealHit, g_esHealPlayer[tank].g_iHealHit, g_esHealSpecial[type][0].g_iHealHit, g_esHealSpecial[type][iSpecType].g_iHealHit, g_esHealAbility[type].g_iHealHit, 1);
		g_esHealCache[tank].g_iHealHitMode = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealHitMode, g_esHealTeammate[tank][iSpecType].g_iHealHitMode, g_esHealPlayer[tank].g_iHealHitMode, g_esHealSpecial[type][0].g_iHealHitMode, g_esHealSpecial[type][iSpecType].g_iHealHitMode, g_esHealAbility[type].g_iHealHitMode, 1);
		g_esHealCache[tank].g_iHealMessage = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealMessage, g_esHealTeammate[tank][iSpecType].g_iHealMessage, g_esHealPlayer[tank].g_iHealMessage, g_esHealSpecial[type][0].g_iHealMessage, g_esHealSpecial[type][iSpecType].g_iHealMessage, g_esHealAbility[type].g_iHealMessage, 1);
		g_esHealCache[tank].g_iHealRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealRangeCooldown, g_esHealTeammate[tank][iSpecType].g_iHealRangeCooldown, g_esHealPlayer[tank].g_iHealRangeCooldown, g_esHealSpecial[type][0].g_iHealRangeCooldown, g_esHealSpecial[type][iSpecType].g_iHealRangeCooldown, g_esHealAbility[type].g_iHealRangeCooldown, 1);
		g_esHealCache[tank].g_iHealSight = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealSight, g_esHealTeammate[tank][iSpecType].g_iHealSight, g_esHealPlayer[tank].g_iHealSight, g_esHealSpecial[type][0].g_iHealSight, g_esHealSpecial[type][iSpecType].g_iHealSight, g_esHealAbility[type].g_iHealSight, 1);
		g_esHealCache[tank].g_iHealSpecial = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealSpecial, g_esHealTeammate[tank][iSpecType].g_iHealSpecial, g_esHealPlayer[tank].g_iHealSpecial, g_esHealSpecial[type][0].g_iHealSpecial, g_esHealSpecial[type][iSpecType].g_iHealSpecial, g_esHealAbility[type].g_iHealSpecial, 2, 1);
		g_esHealCache[tank].g_iHealTank = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHealTank, g_esHealTeammate[tank][iSpecType].g_iHealTank, g_esHealPlayer[tank].g_iHealTank, g_esHealSpecial[type][0].g_iHealTank, g_esHealSpecial[type][iSpecType].g_iHealTank, g_esHealAbility[type].g_iHealTank, 2, 1);
		g_esHealCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHumanAbility, g_esHealTeammate[tank][iSpecType].g_iHumanAbility, g_esHealPlayer[tank].g_iHumanAbility, g_esHealSpecial[type][0].g_iHumanAbility, g_esHealSpecial[type][iSpecType].g_iHumanAbility, g_esHealAbility[type].g_iHumanAbility, 1);
		g_esHealCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHumanAmmo, g_esHealTeammate[tank][iSpecType].g_iHumanAmmo, g_esHealPlayer[tank].g_iHumanAmmo, g_esHealSpecial[type][0].g_iHumanAmmo, g_esHealSpecial[type][iSpecType].g_iHumanAmmo, g_esHealAbility[type].g_iHumanAmmo, 1);
		g_esHealCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHumanCooldown, g_esHealTeammate[tank][iSpecType].g_iHumanCooldown, g_esHealPlayer[tank].g_iHumanCooldown, g_esHealSpecial[type][0].g_iHumanCooldown, g_esHealSpecial[type][iSpecType].g_iHumanCooldown, g_esHealAbility[type].g_iHumanCooldown, 1);
		g_esHealCache[tank].g_iHumanDuration = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHumanDuration, g_esHealTeammate[tank][iSpecType].g_iHumanDuration, g_esHealPlayer[tank].g_iHumanDuration, g_esHealSpecial[type][0].g_iHumanDuration, g_esHealSpecial[type][iSpecType].g_iHumanDuration, g_esHealAbility[type].g_iHumanDuration, 1);
		g_esHealCache[tank].g_iHumanMode = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHumanMode, g_esHealTeammate[tank][iSpecType].g_iHumanMode, g_esHealPlayer[tank].g_iHumanMode, g_esHealSpecial[type][0].g_iHumanMode, g_esHealSpecial[type][iSpecType].g_iHumanMode, g_esHealAbility[type].g_iHumanMode, 1);
		g_esHealCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iHumanRangeCooldown, g_esHealTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esHealPlayer[tank].g_iHumanRangeCooldown, g_esHealSpecial[type][0].g_iHumanRangeCooldown, g_esHealSpecial[type][iSpecType].g_iHumanRangeCooldown, g_esHealAbility[type].g_iHumanRangeCooldown, 1);
		g_esHealCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_flOpenAreasOnly, g_esHealTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esHealPlayer[tank].g_flOpenAreasOnly, g_esHealSpecial[type][0].g_flOpenAreasOnly, g_esHealSpecial[type][iSpecType].g_flOpenAreasOnly, g_esHealAbility[type].g_flOpenAreasOnly, 1);
		g_esHealCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esHealTeammate[tank][0].g_iRequiresHumans, g_esHealTeammate[tank][iSpecType].g_iRequiresHumans, g_esHealPlayer[tank].g_iRequiresHumans, g_esHealSpecial[type][0].g_iRequiresHumans, g_esHealSpecial[type][iSpecType].g_iRequiresHumans, g_esHealAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
		g_esHealCache[tank].g_flCloseAreasOnly = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flCloseAreasOnly, g_esHealAbility[type].g_flCloseAreasOnly, 1);
		g_esHealCache[tank].g_iComboAbility = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iComboAbility, g_esHealAbility[type].g_iComboAbility, 1);
		g_esHealCache[tank].g_flHealAbsorbRange = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flHealAbsorbRange, g_esHealAbility[type].g_flHealAbsorbRange, 1);
		g_esHealCache[tank].g_flHealBuffer = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flHealBuffer, g_esHealAbility[type].g_flHealBuffer, 1);
		g_esHealCache[tank].g_flHealChance = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flHealChance, g_esHealAbility[type].g_flHealChance, 1);
		g_esHealCache[tank].g_flHealInterval = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flHealInterval, g_esHealAbility[type].g_flHealInterval, 1);
		g_esHealCache[tank].g_flHealRange = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flHealRange, g_esHealAbility[type].g_flHealRange, 1);
		g_esHealCache[tank].g_flHealRangeChance = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flHealRangeChance, g_esHealAbility[type].g_flHealRangeChance, 1);
		g_esHealCache[tank].g_iHealAbility = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealAbility, g_esHealAbility[type].g_iHealAbility, 1);
		g_esHealCache[tank].g_iHealCommon = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealCommon, g_esHealAbility[type].g_iHealCommon, 2, 1);
		g_esHealCache[tank].g_iHealCooldown = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealCooldown, g_esHealAbility[type].g_iHealCooldown, 1);
		g_esHealCache[tank].g_iHealDuration = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealDuration, g_esHealAbility[type].g_iHealDuration, 1);
		g_esHealCache[tank].g_iHealEffect = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealEffect, g_esHealAbility[type].g_iHealEffect, 1);
		g_esHealCache[tank].g_iHealGlow = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealGlow, g_esHealAbility[type].g_iHealGlow, 1);
		g_esHealCache[tank].g_iHealHit = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealHit, g_esHealAbility[type].g_iHealHit, 1);
		g_esHealCache[tank].g_iHealHitMode = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealHitMode, g_esHealAbility[type].g_iHealHitMode, 1);
		g_esHealCache[tank].g_iHealMessage = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealMessage, g_esHealAbility[type].g_iHealMessage, 1);
		g_esHealCache[tank].g_iHealRangeCooldown = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealRangeCooldown, g_esHealAbility[type].g_iHealRangeCooldown, 1);
		g_esHealCache[tank].g_iHealSight = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealSight, g_esHealAbility[type].g_iHealSight, 1);
		g_esHealCache[tank].g_iHealSpecial = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealSpecial, g_esHealAbility[type].g_iHealSpecial, 2, 1);
		g_esHealCache[tank].g_iHealTank = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHealTank, g_esHealAbility[type].g_iHealTank, 2, 1);
		g_esHealCache[tank].g_iHumanAbility = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHumanAbility, g_esHealAbility[type].g_iHumanAbility, 1);
		g_esHealCache[tank].g_iHumanAmmo = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHumanAmmo, g_esHealAbility[type].g_iHumanAmmo, 1);
		g_esHealCache[tank].g_iHumanCooldown = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHumanCooldown, g_esHealAbility[type].g_iHumanCooldown, 1);
		g_esHealCache[tank].g_iHumanDuration = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHumanDuration, g_esHealAbility[type].g_iHumanDuration, 1);
		g_esHealCache[tank].g_iHumanMode = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHumanMode, g_esHealAbility[type].g_iHumanMode, 1);
		g_esHealCache[tank].g_iHumanRangeCooldown = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iHumanRangeCooldown, g_esHealAbility[type].g_iHumanRangeCooldown, 1);
		g_esHealCache[tank].g_flOpenAreasOnly = flGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_flOpenAreasOnly, g_esHealAbility[type].g_flOpenAreasOnly, 1);
		g_esHealCache[tank].g_iRequiresHumans = iGetSettingValue(apply, bHuman, g_esHealPlayer[tank].g_iRequiresHumans, g_esHealAbility[type].g_iRequiresHumans, 1);
	}
}
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esHealCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esHealCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esHealPlayer[tank].g_iTankType, tank) || (g_esHealCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esHealCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esHealAbility[g_esHealPlayer[tank].g_iTankType].g_iAccessFlags, g_esHealPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
void tTimerHealCombo(Handle timer, DataPack pack)
{
	...
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esHealAbility[g_esHealPlayer[iTank].g_iTankType].g_iAccessFlags, g_esHealPlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esHealPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esHealCache[iTank].g_iHealAbility == 0 || g_esHealCache[iTank].g_iHealAbility == 2)
	{
		return;
	}
