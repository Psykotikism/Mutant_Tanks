...
esBuryTeammate g_esBuryTeammate[MAXPLAYERS + 1][7];
...
esBurySpecial g_esBurySpecial[MT_MAXTYPES + 1][7];
...
#if defined MT_ABILITIES_MAIN
void vBuryConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esBuryTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esBuryTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esBuryTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esBuryTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esBuryTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esBuryTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esBuryTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esBuryTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esBuryTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esBuryTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			...
			g_esBuryTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esBuryTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esBuryTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esBuryTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esBuryTeammate[admin][specType].g_iBuryAbility = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esBuryTeammate[admin][specType].g_iBuryAbility, value, -1, 1, specType);
			g_esBuryTeammate[admin][specType].g_iBuryEffect = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esBuryTeammate[admin][specType].g_iBuryEffect, value, -1, 7, specType);
			g_esBuryTeammate[admin][specType].g_iBuryMessage = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esBuryTeammate[admin][specType].g_iBuryMessage, value, -1, 3, specType);
			g_esBuryTeammate[admin][specType].g_iBurySight = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esBuryTeammate[admin][specType].g_iBurySight, value, -1, 2, specType);
			g_esBuryTeammate[admin][specType].g_flBuryBuffer = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryBuffer", "Bury Buffer", "Bury_Buffer", "buffer", g_esBuryTeammate[admin][specType].g_flBuryBuffer, value, -1.0,float(MT_MAXHEALTH), specType);
			g_esBuryTeammate[admin][specType].g_flBuryChance = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryChance", "Bury Chance", "Bury_Chance", "chance", g_esBuryTeammate[admin][specType].g_flBuryChance, value, -1.0, 100.0, specType);
			g_esBuryTeammate[admin][specType].g_iBuryCooldown = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryCooldown", "Bury Cooldown", "Bury_Cooldown", "cooldown", g_esBuryTeammate[admin][specType].g_iBuryCooldown, value, -1, 99999, specType);
			g_esBuryTeammate[admin][specType].g_flBuryDuration = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryDuration", "Bury Duration", "Bury_Duration", "duration", g_esBuryTeammate[admin][specType].g_flBuryDuration, value, -1.0, 99999.0, specType);
			g_esBuryTeammate[admin][specType].g_flBuryHeight = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryHeight", "Bury Height", "Bury_Height", "height", g_esBuryTeammate[admin][specType].g_flBuryHeight, value, -1.0, 99999.0, specType);
			g_esBuryTeammate[admin][specType].g_iBuryHit = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryHit", "Bury Hit", "Bury_Hit", "hit", g_esBuryTeammate[admin][specType].g_iBuryHit, value, -1, 1, specType);
			g_esBuryTeammate[admin][specType].g_iBuryHitMode = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryHitMode", "Bury Hit Mode", "Bury_Hit_Mode", "hitmode", g_esBuryTeammate[admin][specType].g_iBuryHitMode, value, -1, 2, specType);
			g_esBuryTeammate[admin][specType].g_flBuryRange = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryRange", "Bury Range", "Bury_Range", "range", g_esBuryTeammate[admin][specType].g_flBuryRange, value, -1.0, 99999.0, specType);
			g_esBuryTeammate[admin][specType].g_flBuryRangeChance = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryRangeChance", "Bury Range Chance", "Bury_Range_Chance", "rangechance", g_esBuryTeammate[admin][specType].g_flBuryRangeChance, value, -1.0, 100.0, specType);
			g_esBuryTeammate[admin][specType].g_iBuryRangeCooldown = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryRangeCooldown", "Bury Range Cooldown", "Bury_Range_Cooldown", "rangecooldown", g_esBuryTeammate[admin][specType].g_iBuryRangeCooldown, value, -1, 99999, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esBurySpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esBurySpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esBurySpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esBurySpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esBurySpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esBurySpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esBurySpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esBurySpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esBurySpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esBurySpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esBurySpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esBurySpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esBurySpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esBurySpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esBurySpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esBurySpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esBurySpecial[type][specType].g_iBuryAbility = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esBurySpecial[type][specType].g_iBuryAbility, value, -1, 1, specType);
			g_esBurySpecial[type][specType].g_iBuryEffect = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esBurySpecial[type][specType].g_iBuryEffect, value, -1, 7, specType);
			g_esBurySpecial[type][specType].g_iBuryMessage = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esBurySpecial[type][specType].g_iBuryMessage, value, -1, 3, specType);
			g_esBurySpecial[type][specType].g_iBurySight = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esBurySpecial[type][specType].g_iBurySight, value, -1, 2, specType);
			g_esBurySpecial[type][specType].g_flBuryBuffer = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryBuffer", "Bury Buffer", "Bury_Buffer", "buffer", g_esBurySpecial[type][specType].g_flBuryBuffer, value, -1.0,float(MT_MAXHEALTH), specType);
			g_esBurySpecial[type][specType].g_flBuryChance = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryChance", "Bury Chance", "Bury_Chance", "chance", g_esBurySpecial[type][specType].g_flBuryChance, value, -1.0, 100.0, specType);
			g_esBurySpecial[type][specType].g_iBuryCooldown = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryCooldown", "Bury Cooldown", "Bury_Cooldown", "cooldown", g_esBurySpecial[type][specType].g_iBuryCooldown, value, -1, 99999, specType);
			g_esBurySpecial[type][specType].g_flBuryDuration = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryDuration", "Bury Duration", "Bury_Duration", "duration", g_esBurySpecial[type][specType].g_flBuryDuration, value, -1.0, 99999.0, specType);
			g_esBurySpecial[type][specType].g_flBuryHeight = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryHeight", "Bury Height", "Bury_Height", "height", g_esBurySpecial[type][specType].g_flBuryHeight, value, -1.0, 99999.0, specType);
			g_esBurySpecial[type][specType].g_iBuryHit = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryHit", "Bury Hit", "Bury_Hit", "hit", g_esBurySpecial[type][specType].g_iBuryHit, value, -1, 1, specType);
			g_esBurySpecial[type][specType].g_iBuryHitMode = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryHitMode", "Bury Hit Mode", "Bury_Hit_Mode", "hitmode", g_esBurySpecial[type][specType].g_iBuryHitMode, value, -1, 2, specType);
			g_esBurySpecial[type][specType].g_flBuryRange = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryRange", "Bury Range", "Bury_Range", "range", g_esBurySpecial[type][specType].g_flBuryRange, value, -1.0, 99999.0, specType);
			g_esBurySpecial[type][specType].g_flBuryRangeChance = flGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryRangeChance", "Bury Range Chance", "Bury_Range_Chance", "rangechance", g_esBurySpecial[type][specType].g_flBuryRangeChance, value, -1.0, 100.0, specType);
			g_esBurySpecial[type][specType].g_iBuryRangeCooldown = iGetKeyValue(subsection, MT_BURY_SECTION, MT_BURY_SECTION2, MT_BURY_SECTION3, MT_BURY_SECTION4, key, "BuryRangeCooldown", "Bury Range Cooldown", "Bury_Range_Cooldown", "rangecooldown", g_esBurySpecial[type][specType].g_iBuryRangeCooldown, value, -1, 99999, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esBuryCache[tank].g_flBuryBuffer = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flBuryBuffer, g_esBuryTeammate[tank][iSpecType].g_flBuryBuffer, g_esBuryPlayer[tank].g_flBuryBuffer, g_esBurySpecial[type][0].g_flBuryBuffer, g_esBurySpecial[type][iSpecType].g_flBuryBuffer, g_esBuryAbility[type].g_flBuryBuffer, 1);
		g_esBuryCache[tank].g_flBuryChance = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flBuryChance, g_esBuryTeammate[tank][iSpecType].g_flBuryChance, g_esBuryPlayer[tank].g_flBuryChance, g_esBurySpecial[type][0].g_flBuryChance, g_esBurySpecial[type][iSpecType].g_flBuryChance, g_esBuryAbility[type].g_flBuryChance, 1);
		g_esBuryCache[tank].g_flBuryDuration = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flBuryDuration, g_esBuryTeammate[tank][iSpecType].g_flBuryDuration, g_esBuryPlayer[tank].g_flBuryDuration, g_esBurySpecial[type][0].g_flBuryDuration, g_esBurySpecial[type][iSpecType].g_flBuryDuration, g_esBuryAbility[type].g_flBuryDuration, 1);
		g_esBuryCache[tank].g_flBuryHeight = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flBuryHeight, g_esBuryTeammate[tank][iSpecType].g_flBuryHeight, g_esBuryPlayer[tank].g_flBuryHeight, g_esBurySpecial[type][0].g_flBuryHeight, g_esBurySpecial[type][iSpecType].g_flBuryHeight, g_esBuryAbility[type].g_flBuryHeight, 1);
		g_esBuryCache[tank].g_flBuryRange = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flBuryRange, g_esBuryTeammate[tank][iSpecType].g_flBuryRange, g_esBuryPlayer[tank].g_flBuryRange, g_esBurySpecial[type][0].g_flBuryRange, g_esBurySpecial[type][iSpecType].g_flBuryRange, g_esBuryAbility[type].g_flBuryRange, 1);
		g_esBuryCache[tank].g_flBuryRangeChance = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flBuryRangeChance, g_esBuryTeammate[tank][iSpecType].g_flBuryRangeChance, g_esBuryPlayer[tank].g_flBuryRangeChance, g_esBurySpecial[type][0].g_flBuryRangeChance, g_esBurySpecial[type][iSpecType].g_flBuryRangeChance, g_esBuryAbility[type].g_flBuryRangeChance, 1);
		g_esBuryCache[tank].g_iBuryAbility = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBuryAbility, g_esBuryTeammate[tank][iSpecType].g_iBuryAbility, g_esBuryPlayer[tank].g_iBuryAbility, g_esBurySpecial[type][0].g_iBuryAbility, g_esBurySpecial[type][iSpecType].g_iBuryAbility, g_esBuryAbility[type].g_iBuryAbility, 1);
		g_esBuryCache[tank].g_iBuryCooldown = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBuryCooldown, g_esBuryTeammate[tank][iSpecType].g_iBuryCooldown, g_esBuryPlayer[tank].g_iBuryCooldown, g_esBurySpecial[type][0].g_iBuryCooldown, g_esBurySpecial[type][iSpecType].g_iBuryCooldown, g_esBuryAbility[type].g_iBuryCooldown, 1);
		g_esBuryCache[tank].g_iBuryEffect = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBuryEffect, g_esBuryTeammate[tank][iSpecType].g_iBuryEffect, g_esBuryPlayer[tank].g_iBuryEffect, g_esBurySpecial[type][0].g_iBuryEffect, g_esBurySpecial[type][iSpecType].g_iBuryEffect, g_esBuryAbility[type].g_iBuryEffect, 1);
		g_esBuryCache[tank].g_iBuryHit = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBuryHit, g_esBuryTeammate[tank][iSpecType].g_iBuryHit, g_esBuryPlayer[tank].g_iBuryHit, g_esBurySpecial[type][0].g_iBuryHit, g_esBurySpecial[type][iSpecType].g_iBuryHit, g_esBuryAbility[type].g_iBuryHit, 1);
		g_esBuryCache[tank].g_iBuryHitMode = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBuryHitMode, g_esBuryTeammate[tank][iSpecType].g_iBuryHitMode, g_esBuryPlayer[tank].g_iBuryHitMode, g_esBurySpecial[type][0].g_iBuryHitMode, g_esBurySpecial[type][iSpecType].g_iBuryHitMode, g_esBuryAbility[type].g_iBuryHitMode, 1);
		g_esBuryCache[tank].g_iBuryMessage = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBuryMessage, g_esBuryTeammate[tank][iSpecType].g_iBuryMessage, g_esBuryPlayer[tank].g_iBuryMessage, g_esBurySpecial[type][0].g_iBuryMessage, g_esBurySpecial[type][iSpecType].g_iBuryMessage, g_esBuryAbility[type].g_iBuryMessage, 1);
		g_esBuryCache[tank].g_iBuryRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBuryRangeCooldown, g_esBuryTeammate[tank][iSpecType].g_iBuryRangeCooldown, g_esBuryPlayer[tank].g_iBuryRangeCooldown, g_esBurySpecial[type][0].g_iBuryRangeCooldown, g_esBurySpecial[type][iSpecType].g_iBuryRangeCooldown, g_esBuryAbility[type].g_iBuryRangeCooldown, 1);
		g_esBuryCache[tank].g_iBurySight = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iBurySight, g_esBuryTeammate[tank][iSpecType].g_iBurySight, g_esBuryPlayer[tank].g_iBurySight, g_esBurySpecial[type][0].g_iBurySight, g_esBurySpecial[type][iSpecType].g_iBurySight, g_esBuryAbility[type].g_iBurySight, 1);
		g_esBuryCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flCloseAreasOnly, g_esBuryTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esBuryPlayer[tank].g_flCloseAreasOnly, g_esBurySpecial[type][0].g_flCloseAreasOnly, g_esBurySpecial[type][iSpecType].g_flCloseAreasOnly, g_esBuryAbility[type].g_flCloseAreasOnly, 1);
		g_esBuryCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iComboAbility, g_esBuryTeammate[tank][iSpecType].g_iComboAbility, g_esBuryPlayer[tank].g_iComboAbility, g_esBurySpecial[type][0].g_iComboAbility, g_esBurySpecial[type][iSpecType].g_iComboAbility, g_esBuryAbility[type].g_iComboAbility, 1);
		g_esBuryCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iHumanAbility, g_esBuryTeammate[tank][iSpecType].g_iHumanAbility, g_esBuryPlayer[tank].g_iHumanAbility, g_esBurySpecial[type][0].g_iHumanAbility, g_esBurySpecial[type][iSpecType].g_iHumanAbility, g_esBuryAbility[type].g_iHumanAbility, 1);
		g_esBuryCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iHumanAmmo, g_esBuryTeammate[tank][iSpecType].g_iHumanAmmo, g_esBuryPlayer[tank].g_iHumanAmmo, g_esBurySpecial[type][0].g_iHumanAmmo, g_esBurySpecial[type][iSpecType].g_iHumanAmmo, g_esBuryAbility[type].g_iHumanAmmo, 1);
		g_esBuryCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iHumanCooldown, g_esBuryTeammate[tank][iSpecType].g_iHumanCooldown, g_esBuryPlayer[tank].g_iHumanCooldown, g_esBurySpecial[type][0].g_iHumanCooldown, g_esBurySpecial[type][iSpecType].g_iHumanCooldown, g_esBuryAbility[type].g_iHumanCooldown, 1);
		g_esBuryCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iHumanRangeCooldown, g_esBuryTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esBuryPlayer[tank].g_iHumanRangeCooldown, g_esBurySpecial[type][0].g_iHumanRangeCooldown, g_esBurySpecial[type][iSpecType].g_iHumanRangeCooldown, g_esBuryAbility[type].g_iHumanRangeCooldown, 1);
		g_esBuryCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_flOpenAreasOnly, g_esBuryTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esBuryPlayer[tank].g_flOpenAreasOnly, g_esBurySpecial[type][0].g_flOpenAreasOnly, g_esBurySpecial[type][iSpecType].g_flOpenAreasOnly, g_esBuryAbility[type].g_flOpenAreasOnly, 1);
		g_esBuryCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esBuryTeammate[tank][0].g_iRequiresHumans, g_esBuryTeammate[tank][iSpecType].g_iRequiresHumans, g_esBuryPlayer[tank].g_iRequiresHumans, g_esBurySpecial[type][0].g_iRequiresHumans, g_esBurySpecial[type][iSpecType].g_iRequiresHumans, g_esBuryAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
