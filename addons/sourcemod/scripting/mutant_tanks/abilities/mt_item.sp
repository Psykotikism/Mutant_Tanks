...
esItemTeammate g_esItemTeammate[MAXPLAYERS + 1][6];
...
esItemSpecial g_esItemSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN
void vItemConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esItemTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esItemTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esItemTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esItemTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esItemTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esItemTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esItemTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esItemTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esItemTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esItemTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esItemTeammate[admin][specType].g_iItemAbility = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esItemTeammate[admin][specType].g_iItemAbility, value, -1, 1, specName, specType);
			g_esItemTeammate[admin][specType].g_iItemMessage = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esItemTeammate[admin][specType].g_iItemMessage, value, -1, 1, specName, specType);
			g_esItemTeammate[admin][specType].g_flItemChance = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemChance", "Item Chance", "Item_Chance", "chance", g_esItemTeammate[admin][specType].g_flItemChance, value, -1.0, 100.0, specName, specType);
			g_esItemTeammate[admin][specType].g_iItemMode = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemMode", "Item Mode", "Item_Mode", "mode", g_esItemTeammate[admin][specType].g_iItemMode, value, -1, 3, specName, specType);
			g_esItemTeammate[admin][specType].g_iItemPinataBody = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemPinataBody", "Item Pinata Body", "Item_Pinata_Body", "pinatabody", g_esItemTeammate[admin][specType].g_iItemPinataBody, value, -1, 1, specName, specType);
			g_esItemTeammate[admin][specType].g_flItemPinataChance = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemPinataChance", "Item Pinata Chance", "Item_Pinata_Chance", "pinatachance", g_esItemTeammate[admin][specType].g_flItemPinataChance, value, -1.0, 100.0, specName, specType);

			vGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemLoadout", "Item Loadout", "Item_Loadout", "loadout", g_esItemTeammate[admin][specType].g_sItemLoadout, sizeof esItemTeammate::g_sItemLoadout, value, specName, specType);
			vGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemPinata", "Item Pinata", "Item_Pinata", "pinata", g_esItemTeammate[admin][specType].g_sItemPinata, sizeof esItemTeammate::g_sItemPinata, value, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esItemSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esItemSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esItemSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esItemSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esItemSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esItemSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esItemSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esItemSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esItemSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esItemSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esItemSpecial[type][specType].g_iItemAbility = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esItemSpecial[type][specType].g_iItemAbility, value, -1, 1, specName, specType);
			g_esItemSpecial[type][specType].g_iItemMessage = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esItemSpecial[type][specType].g_iItemMessage, value, -1, 1, specName, specType);
			g_esItemSpecial[type][specType].g_flItemChance = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemChance", "Item Chance", "Item_Chance", "chance", g_esItemSpecial[type][specType].g_flItemChance, value, -1.0, 100.0, specName, specType);
			g_esItemSpecial[type][specType].g_iItemMode = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemMode", "Item Mode", "Item_Mode", "mode", g_esItemSpecial[type][specType].g_iItemMode, value, -1, 3, specName, specType);
			g_esItemSpecial[type][specType].g_iItemPinataBody = iGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemPinataBody", "Item Pinata Body", "Item_Pinata_Body", "pinatabody", g_esItemSpecial[type][specType].g_iItemPinataBody, value, -1, 1, specName, specType);
			g_esItemSpecial[type][specType].g_flItemPinataChance = flGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemPinataChance", "Item Pinata Chance", "Item_Pinata_Chance", "pinatachance", g_esItemSpecial[type][specType].g_flItemPinataChance, value, -1.0, 100.0, specName, specType);

			vGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemLoadout", "Item Loadout", "Item_Loadout", "loadout", g_esItemSpecial[type][specType].g_sItemLoadout, sizeof esItemSpecial::g_sItemLoadout, value, specName, specType);
			vGetKeyValue(subsection, MT_ITEM_SECTION, MT_ITEM_SECTION2, MT_ITEM_SECTION3, MT_ITEM_SECTION4, key, "ItemPinata", "Item Pinata", "Item_Pinata", "pinata", g_esItemSpecial[type][specType].g_sItemPinata, sizeof esItemSpecial::g_sItemPinata, value, specName, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esItemCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esItemPlayer[tank].g_flCloseAreasOnly, g_esItemSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esItemAbility[type].g_flCloseAreasOnly, 1);
		g_esItemCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_iComboAbility, g_esItemPlayer[tank].g_iComboAbility, g_esItemSpecial[type][iSpecType - 1].g_iComboAbility, g_esItemAbility[type].g_iComboAbility, 1);
		g_esItemCache[tank].g_flItemChance = flGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_flItemChance, g_esItemPlayer[tank].g_flItemChance, g_esItemSpecial[type][iSpecType - 1].g_flItemChance, g_esItemAbility[type].g_flItemChance, 1);
		g_esItemCache[tank].g_flItemPinataChance = flGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_flItemPinataChance, g_esItemPlayer[tank].g_flItemPinataChance, g_esItemSpecial[type][iSpecType - 1].g_flItemPinataChance, g_esItemAbility[type].g_flItemPinataChance, 1);
		g_esItemCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esItemPlayer[tank].g_iHumanAbility, g_esItemSpecial[type][iSpecType - 1].g_iHumanAbility, g_esItemAbility[type].g_iHumanAbility, 1);
		g_esItemCache[tank].g_iItemAbility = iGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_iItemAbility, g_esItemPlayer[tank].g_iItemAbility, g_esItemSpecial[type][iSpecType - 1].g_iItemAbility, g_esItemAbility[type].g_iItemAbility, 1);
		g_esItemCache[tank].g_iItemMessage = iGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_iItemMessage, g_esItemPlayer[tank].g_iItemMessage, g_esItemSpecial[type][iSpecType - 1].g_iItemMessage, g_esItemAbility[type].g_iItemMessage, 1);
		g_esItemCache[tank].g_iItemMode = iGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_iItemMode, g_esItemPlayer[tank].g_iItemMode, g_esItemSpecial[type][iSpecType - 1].g_iItemMode, g_esItemAbility[type].g_iItemMode, 1);
		g_esItemCache[tank].g_iItemPinataBody = iGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_iItemPinataBody, g_esItemPlayer[tank].g_iItemPinataBody, g_esItemSpecial[type][iSpecType - 1].g_iItemPinataBody, g_esItemAbility[type].g_iItemPinataBody, 1);
		g_esItemCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esItemPlayer[tank].g_flOpenAreasOnly, g_esItemSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esItemAbility[type].g_flOpenAreasOnly, 1);
		g_esItemCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esItemTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esItemPlayer[tank].g_iRequiresHumans, g_esItemSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esItemAbility[type].g_iRequiresHumans, 1);

		vGetSubSettingValue(apply, bHuman, g_esItemCache[tank].g_sItemLoadout, sizeof esItemCache::g_sItemLoadout, g_esItemTeammate[tank][iSpecType - 1].g_sItemLoadout, g_esItemPlayer[tank].g_sItemLoadout, g_esItemSpecial[type][iSpecType - 1].g_sItemLoadout, g_esItemAbility[type].g_sItemLoadout);
		vGetSubSettingValue(apply, bHuman, g_esItemCache[tank].g_sItemPinata, sizeof esItemCache::g_sItemPinata, g_esItemTeammate[tank][iSpecType - 1].g_sItemPinata, g_esItemPlayer[tank].g_sItemPinata, g_esItemSpecial[type][iSpecType - 1].g_sItemPinata, g_esItemAbility[type].g_sItemPinata);
	}
	else
	{
