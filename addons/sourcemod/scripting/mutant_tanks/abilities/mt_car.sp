...
esCarTeammate g_esCarTeammate[MAXPLAYERS + 1][6];
...
esCarSpecial g_esCarSpecial[MT_MAXTYPES + 1][6];
...
#if defined MT_ABILITIES_MAIN
void vCarConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, const char[] specName, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esCarTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esCarTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esCarTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esCarTeammate[admin][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esCarTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esCarTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esCarTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esCarTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esCarTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esCarTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esCarTeammate[admin][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esCarTeammate[admin][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esCarTeammate[admin][specType].g_iHumanMode = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esCarTeammate[admin][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esCarTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esCarTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esCarTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esCarTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esCarTeammate[admin][specType].g_iCarAbility = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esCarTeammate[admin][specType].g_iCarAbility, value, -1, 1, specName, specType);
			g_esCarTeammate[admin][specType].g_iCarMessage = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esCarTeammate[admin][specType].g_iCarMessage, value, -1, 1, specName, specType);
			g_esCarTeammate[admin][specType].g_flCarChance = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarChance", "Car Chance", "Car_Chance", "chance", g_esCarTeammate[admin][specType].g_flCarChance, value, -1.0, 100.0, specName, specType);
			g_esCarTeammate[admin][specType].g_iCarCooldown = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarCooldown", "Car Cooldown", "Car_Cooldown", "cooldown", g_esCarTeammate[admin][specType].g_iCarCooldown, value, -1, 99999, specName, specType);
			g_esCarTeammate[admin][specType].g_iCarDuration = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarDuration", "Car Duration", "Car_Duration", "duration", g_esCarTeammate[admin][specType].g_iCarDuration, value, -1, 99999, specName, specType);
			g_esCarTeammate[admin][specType].g_flCarInterval = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarInterval", "Car Interval", "Car_Interval", "interval", g_esCarTeammate[admin][specType].g_flCarInterval, value, -1.0, 1.0, specName, specType);
			g_esCarTeammate[admin][specType].g_flCarLifetime = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarLifetime", "Car Lifetime", "Car_Lifetime", "lifetime", g_esCarTeammate[admin][specType].g_flCarLifetime, value, -1.0, 99999.0, specName, specType);
			g_esCarTeammate[admin][specType].g_iCarOptions = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarOptions", "Car Options", "Car_Options", "options", g_esCarTeammate[admin][specType].g_iCarOptions, value, -1, 7, specName, specType);
			g_esCarTeammate[admin][specType].g_iCarOwner = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarOwner", "Car Owner", "Car_Owner", "owner", g_esCarTeammate[admin][specType].g_iCarOwner, value, -1, 1, specName, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esCarSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esCarSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esCarSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esCarSpecial[type][specType].g_iComboAbility, value, -1, 1, specName, specType);
			g_esCarSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esCarSpecial[type][specType].g_iHumanAbility, value, -1, 2, specName, specType);
			g_esCarSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esCarSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specName, specType);
			g_esCarSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esCarSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specName, specType);
			g_esCarSpecial[type][specType].g_iHumanDuration = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanDuration", "Human Duration", "Human_Duration", "hduration", g_esCarSpecial[type][specType].g_iHumanDuration, value, -1, 99999, specName, specType);
			g_esCarSpecial[type][specType].g_iHumanMode = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "HumanMode", "Human Mode", "Human_Mode", "hmode", g_esCarSpecial[type][specType].g_iHumanMode, value, -1, 1, specName, specType);
			g_esCarSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esCarSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specName, specType);
			g_esCarSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esCarSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specName, specType);
			g_esCarSpecial[type][specType].g_iCarAbility = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esCarSpecial[type][specType].g_iCarAbility, value, -1, 1, specName, specType);
			g_esCarSpecial[type][specType].g_iCarMessage = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esCarSpecial[type][specType].g_iCarMessage, value, -1, 1, specName, specType);
			g_esCarSpecial[type][specType].g_flCarChance = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarChance", "Car Chance", "Car_Chance", "chance", g_esCarSpecial[type][specType].g_flCarChance, value, -1.0, 100.0, specName, specType);
			g_esCarSpecial[type][specType].g_iCarCooldown = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarCooldown", "Car Cooldown", "Car_Cooldown", "cooldown", g_esCarSpecial[type][specType].g_iCarCooldown, value, -1, 99999, specName, specType);
			g_esCarSpecial[type][specType].g_iCarDuration = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarDuration", "Car Duration", "Car_Duration", "duration", g_esCarSpecial[type][specType].g_iCarDuration, value, -1, 99999, specName, specType);
			g_esCarSpecial[type][specType].g_flCarInterval = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarInterval", "Car Interval", "Car_Interval", "interval", g_esCarSpecial[type][specType].g_flCarInterval, value, -1.0, 1.0, specName, specType);
			g_esCarSpecial[type][specType].g_flCarLifetime = flGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarLifetime", "Car Lifetime", "Car_Lifetime", "lifetime", g_esCarSpecial[type][specType].g_flCarLifetime, value, -1.0, 99999.0, specName, specType);
			g_esCarSpecial[type][specType].g_iCarOptions = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarOptions", "Car Options", "Car_Options", "options", g_esCarSpecial[type][specType].g_iCarOptions, value, -1, 7, specName, specType);
			g_esCarSpecial[type][specType].g_iCarOwner = iGetKeyValue(subsection, MT_CAR_SECTION, MT_CAR_SECTION2, MT_CAR_SECTION3, MT_CAR_SECTION4, key, "CarOwner", "Car Owner", "Car_Owner", "owner", g_esCarSpecial[type][specType].g_iCarOwner, value, -1, 1, specName, specType);
		}
		else
		{
...
#endif
{
	...
	{
		g_esCarCache[tank].g_flCarChance = flGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_flCarChance, g_esCarPlayer[tank].g_flCarChance, g_esCarSpecial[type][iSpecType - 1].g_flCarChance, g_esCarAbility[type].g_flCarChance, 1);
		g_esCarCache[tank].g_flCarInterval = flGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_flCarInterval, g_esCarPlayer[tank].g_flCarInterval, g_esCarSpecial[type][iSpecType - 1].g_flCarInterval, g_esCarAbility[type].g_flCarInterval, 1);
		g_esCarCache[tank].g_flCarLifetime = flGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_flCarLifetime, g_esCarPlayer[tank].g_flCarLifetime, g_esCarSpecial[type][iSpecType - 1].g_flCarLifetime, g_esCarAbility[type].g_flCarLifetime, 1);
		g_esCarCache[tank].g_flCarRadius[0] = flGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_flCarRadius[0], g_esCarPlayer[tank].g_flCarRadius[0], g_esCarSpecial[type][iSpecType - 1].g_flCarRadius[0], g_esCarAbility[type].g_flCarRadius[0], 2, 1.0);
		g_esCarCache[tank].g_flCarRadius[1] = flGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_flCarRadius[1], g_esCarPlayer[tank].g_flCarRadius[1], g_esCarSpecial[type][iSpecType - 1].g_flCarRadius[1], g_esCarAbility[type].g_flCarRadius[1], 2, -1.0);
		g_esCarCache[tank].g_iCarAbility = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iCarAbility, g_esCarPlayer[tank].g_iCarAbility, g_esCarSpecial[type][iSpecType - 1].g_iCarAbility, g_esCarAbility[type].g_iCarAbility, 1);
		g_esCarCache[tank].g_iCarCooldown = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iCarCooldown, g_esCarPlayer[tank].g_iCarCooldown, g_esCarSpecial[type][iSpecType - 1].g_iCarCooldown, g_esCarAbility[type].g_iCarCooldown, 1);
		g_esCarCache[tank].g_iCarDuration = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iCarDuration, g_esCarPlayer[tank].g_iCarDuration, g_esCarSpecial[type][iSpecType - 1].g_iCarDuration, g_esCarAbility[type].g_iCarDuration, 1);
		g_esCarCache[tank].g_iCarMessage = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iCarMessage, g_esCarPlayer[tank].g_iCarMessage, g_esCarSpecial[type][iSpecType - 1].g_iCarMessage, g_esCarAbility[type].g_iCarMessage, 1);
		g_esCarCache[tank].g_iCarOptions = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iCarOptions, g_esCarPlayer[tank].g_iCarOptions, g_esCarSpecial[type][iSpecType - 1].g_iCarOptions, g_esCarAbility[type].g_iCarOptions, 1);
		g_esCarCache[tank].g_iCarOwner = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iCarOwner, g_esCarPlayer[tank].g_iCarOwner, g_esCarSpecial[type][iSpecType - 1].g_iCarOwner, g_esCarAbility[type].g_iCarOwner, 1);
		g_esCarCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_flCloseAreasOnly, g_esCarPlayer[tank].g_flCloseAreasOnly, g_esCarSpecial[type][iSpecType - 1].g_flCloseAreasOnly, g_esCarAbility[type].g_flCloseAreasOnly, 1);
		g_esCarCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iComboAbility, g_esCarPlayer[tank].g_iComboAbility, g_esCarSpecial[type][iSpecType - 1].g_iComboAbility, g_esCarAbility[type].g_iComboAbility, 1);
		g_esCarCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iHumanAbility, g_esCarPlayer[tank].g_iHumanAbility, g_esCarSpecial[type][iSpecType - 1].g_iHumanAbility, g_esCarAbility[type].g_iHumanAbility, 1);
		g_esCarCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iHumanAmmo, g_esCarPlayer[tank].g_iHumanAmmo, g_esCarSpecial[type][iSpecType - 1].g_iHumanAmmo, g_esCarAbility[type].g_iHumanAmmo, 1);
		g_esCarCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iHumanCooldown, g_esCarPlayer[tank].g_iHumanCooldown, g_esCarSpecial[type][iSpecType - 1].g_iHumanCooldown, g_esCarAbility[type].g_iHumanCooldown, 1);
		g_esCarCache[tank].g_iHumanDuration = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iHumanDuration, g_esCarPlayer[tank].g_iHumanDuration, g_esCarSpecial[type][iSpecType - 1].g_iHumanDuration, g_esCarAbility[type].g_iHumanDuration, 1);
		g_esCarCache[tank].g_iHumanMode = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iHumanMode, g_esCarPlayer[tank].g_iHumanMode, g_esCarSpecial[type][iSpecType - 1].g_iHumanMode, g_esCarAbility[type].g_iHumanMode, 1);
		g_esCarCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_flOpenAreasOnly, g_esCarPlayer[tank].g_flOpenAreasOnly, g_esCarSpecial[type][iSpecType - 1].g_flOpenAreasOnly, g_esCarAbility[type].g_flOpenAreasOnly, 1);
		g_esCarCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esCarTeammate[tank][iSpecType - 1].g_iRequiresHumans, g_esCarPlayer[tank].g_iRequiresHumans, g_esCarSpecial[type][iSpecType - 1].g_iRequiresHumans, g_esCarAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
		g_esCarCache[tank].g_flCarChance = flGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_flCarChance, g_esCarAbility[type].g_flCarChance, 1);
		g_esCarCache[tank].g_flCarInterval = flGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_flCarInterval, g_esCarAbility[type].g_flCarInterval, 1);
		g_esCarCache[tank].g_flCarLifetime = flGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_flCarLifetime, g_esCarAbility[type].g_flCarLifetime, 1);
		g_esCarCache[tank].g_flCarRadius[0] = flGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_flCarRadius[0], g_esCarAbility[type].g_flCarRadius[0], 2, 1.0);
		g_esCarCache[tank].g_flCarRadius[1] = flGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_flCarRadius[1], g_esCarAbility[type].g_flCarRadius[1], 2, -1.0);
		g_esCarCache[tank].g_iCarAbility = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iCarAbility, g_esCarAbility[type].g_iCarAbility, 1);
		g_esCarCache[tank].g_iCarCooldown = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iCarCooldown, g_esCarAbility[type].g_iCarCooldown, 1);
		g_esCarCache[tank].g_iCarDuration = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iCarDuration, g_esCarAbility[type].g_iCarDuration, 1);
		g_esCarCache[tank].g_iCarMessage = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iCarMessage, g_esCarAbility[type].g_iCarMessage, 1);
		g_esCarCache[tank].g_iCarOptions = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iCarOptions, g_esCarAbility[type].g_iCarOptions, 1);
		g_esCarCache[tank].g_iCarOwner = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iCarOwner, g_esCarAbility[type].g_iCarOwner, 1);
		g_esCarCache[tank].g_flCloseAreasOnly = flGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_flCloseAreasOnly, g_esCarAbility[type].g_flCloseAreasOnly, 1);
		g_esCarCache[tank].g_iComboAbility = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iComboAbility, g_esCarAbility[type].g_iComboAbility, 1);
		g_esCarCache[tank].g_iHumanAbility = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iHumanAbility, g_esCarAbility[type].g_iHumanAbility, 1);
		g_esCarCache[tank].g_iHumanAmmo = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iHumanAmmo, g_esCarAbility[type].g_iHumanAmmo, 1);
		g_esCarCache[tank].g_iHumanCooldown = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iHumanCooldown, g_esCarAbility[type].g_iHumanCooldown, 1);
		g_esCarCache[tank].g_iHumanDuration = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iHumanDuration, g_esCarAbility[type].g_iHumanDuration, 1);
		g_esCarCache[tank].g_iHumanMode = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iHumanMode, g_esCarAbility[type].g_iHumanMode, 1);
		g_esCarCache[tank].g_flOpenAreasOnly = flGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_flOpenAreasOnly, g_esCarAbility[type].g_flOpenAreasOnly, 1);
		g_esCarCache[tank].g_iRequiresHumans = iGetSettingValue(apply, bHuman, g_esCarPlayer[tank].g_iRequiresHumans, g_esCarAbility[type].g_iRequiresHumans, 1);
	}
}
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esCarCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esCarCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esCarPlayer[tank].g_iTankType, tank) || (g_esCarCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esCarCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esCarAbility[g_esCarPlayer[tank].g_iTankType].g_iAccessFlags, g_esCarPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
