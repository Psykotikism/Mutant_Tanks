...
esBombTeammate g_esBombTeammate[MAXPLAYERS + 1][7];
...
esBombSpecial g_esBombSpecial[MT_MAXTYPES + 1][7];
	...
	switch (mode)
	{
		case 1:
		{
			for (int iIndex = MT_GetMinType(); iIndex <= MT_GetMaxType(); iIndex++)
			{
				...
				{
					g_esBombSpecial[iIndex][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esBombSpecial[iIndex][iSpecType].g_iComboAbility = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iHumanAbility = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iHumanAmmo = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iHumanCooldown = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iHumanRangeCooldown = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iHumanRockCooldown = -1;
					g_esBombSpecial[iIndex][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esBombSpecial[iIndex][iSpecType].g_iRequiresHumans = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iBombAbility = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iBombEffect = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iBombMessage = -1;
					g_esBombSpecial[iIndex][iSpecType].g_flBombChance = -1.0;
					g_esBombSpecial[iIndex][iSpecType].g_iBombCooldown = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iBombDeath = -1;
					g_esBombSpecial[iIndex][iSpecType].g_flBombDeathChance = -1.0;
					g_esBombSpecial[iIndex][iSpecType].g_iBombHit = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iBombHitMode = -1;
					g_esBombSpecial[iIndex][iSpecType].g_flBombRange = -1.0;
					g_esBombSpecial[iIndex][iSpecType].g_flBombRangeChance = -1.0;
					g_esBombSpecial[iIndex][iSpecType].g_iBombRangeCooldown = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iBombRockBreak = -1;
					g_esBombSpecial[iIndex][iSpecType].g_flBombRockChance = -1.0;
					g_esBombSpecial[iIndex][iSpecType].g_iBombRockCooldown = -1;
					g_esBombSpecial[iIndex][iSpecType].g_iBombSight = -1;
				}
			}
		}
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				...
				for (int iSpecType = 0; iSpecType < (sizeof g_sSpecialNames); iSpecType++)
				{
					g_esBombTeammate[iPlayer][iSpecType].g_flCloseAreasOnly = -1.0;
					g_esBombTeammate[iPlayer][iSpecType].g_iComboAbility = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iHumanAbility = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iHumanAmmo = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iHumanCooldown = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iHumanRangeCooldown = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iHumanRockCooldown = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_flOpenAreasOnly = -1.0;
					g_esBombTeammate[iPlayer][iSpecType].g_iRequiresHumans = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombAbility = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombEffect = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombMessage = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_flBombChance = -1.0;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombCooldown = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombDeath = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_flBombDeathChance = -1.0;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombHit = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombHitMode = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_flBombRange = -1.0;
					g_esBombTeammate[iPlayer][iSpecType].g_flBombRangeChance = -1.0;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombRangeCooldown = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombRockBreak = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_flBombRockChance = -1.0;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombRockCooldown = -1;
					g_esBombTeammate[iPlayer][iSpecType].g_iBombSight = -1;
				}
			}
		}
	}
...
#if defined MT_ABILITIES_MAIN
void vBombConfigsLoaded(const char[] subsection, const char[] key, const char[] value, int type, int admin, int mode, bool special, const char[] specsection, int specType)
#else
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esBombTeammate[admin][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esBombTeammate[admin][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esBombTeammate[admin][specType].g_iComboAbility = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esBombTeammate[admin][specType].g_iComboAbility, value, -1, 1, specType);
			g_esBombTeammate[admin][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esBombTeammate[admin][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esBombTeammate[admin][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esBombTeammate[admin][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esBombTeammate[admin][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esBombTeammate[admin][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esBombTeammate[admin][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esBombTeammate[admin][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esBombTeammate[admin][specType].g_iHumanRockCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanRockCooldown", "Human Rock Cooldown", "Human_Rock_Cooldown", "hrockcooldown", g_esBombTeammate[admin][specType].g_iHumanRockCooldown, value, -1, 99999, specType);
			g_esBombTeammate[admin][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esBombTeammate[admin][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esBombTeammate[admin][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esBombTeammate[admin][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esBombTeammate[admin][specType].g_iBombAbility = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esBombTeammate[admin][specType].g_iBombAbility, value, -1, 1, specType);
			g_esBombTeammate[admin][specType].g_iBombEffect = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esBombTeammate[admin][specType].g_iBombEffect, value, -1, 7, specType);
			g_esBombTeammate[admin][specType].g_iBombMessage = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esBombTeammate[admin][specType].g_iBombMessage, value, -1, 7, specType);
			g_esBombTeammate[admin][specType].g_iBombSight = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esBombTeammate[admin][specType].g_iBombSight, value, -1, 2, specType);
			g_esBombTeammate[admin][specType].g_flBombChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombChance", "Bomb Chance", "Bomb_Chance", "chance", g_esBombTeammate[admin][specType].g_flBombChance, value, -1.0, 100.0, specType);
			g_esBombTeammate[admin][specType].g_iBombCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombCooldown", "Bomb Cooldown", "Bomb_Cooldown", "cooldown", g_esBombTeammate[admin][specType].g_iBombCooldown, value, -1, 99999, specType);
			g_esBombTeammate[admin][specType].g_iBombDeath = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombDeath", "Bomb Death", "Bomb_Death", "death", g_esBombTeammate[admin][specType].g_iBombDeath, value, -1, 1, specType);
			g_esBombTeammate[admin][specType].g_flBombDeathChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombDeathChance", "Bomb Death Chance", "Bomb_Death_Chance", "deathchance", g_esBombTeammate[admin][specType].g_flBombDeathChance, value, -1.0, 99999.0, specType);
			g_esBombTeammate[admin][specType].g_iBombHit = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombHit", "Bomb Hit", "Bomb_Hit", "hit", g_esBombTeammate[admin][specType].g_iBombHit, value, -1, 1, specType);
			g_esBombTeammate[admin][specType].g_iBombHitMode = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombHitMode", "Bomb Hit Mode", "Bomb_Hit_Mode", "hitmode", g_esBombTeammate[admin][specType].g_iBombHitMode, value, -1, 2, specType);
			g_esBombTeammate[admin][specType].g_flBombRange = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRange", "Bomb Range", "Bomb_Range", "range", g_esBombTeammate[admin][specType].g_flBombRange, value, -1.0, 99999.0, specType);
			g_esBombTeammate[admin][specType].g_flBombRangeChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRangeChance", "Bomb Range Chance", "Bomb_Range_Chance", "rangechance", g_esBombTeammate[admin][specType].g_flBombRangeChance, value, -1.0, 100.0, specType);
			g_esBombTeammate[admin][specType].g_iBombRangeCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRangeCooldown", "Bomb Range Cooldown", "Bomb_Range_Cooldown", "rangecooldown", g_esBombTeammate[admin][specType].g_iBombRangeCooldown, value, -1, 99999, specType);
			g_esBombTeammate[admin][specType].g_iBombRockBreak = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRockBreak", "Bomb Rock Break", "Bomb_Rock_Break", "rock", g_esBombTeammate[admin][specType].g_iBombRockBreak, value, -1, 1, specType);
			g_esBombTeammate[admin][specType].g_flBombRockChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRockChance", "Bomb Rock Chance", "Bomb_Rock_Chance", "rockchance", g_esBombTeammate[admin][specType].g_flBombRockChance, value, -1.0, 100.0, specType);
			g_esBombTeammate[admin][specType].g_iBombRockCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRockCooldown", "Bomb Rock Cooldown", "Bomb_Rock_Cooldown", "rockcooldown", g_esBombTeammate[admin][specType].g_iBombRockCooldown, value, -1, 99999, specType);
		}
		else
		{
	...
	if (mode < 3 && type > 0)
	{
		if (special && specsection[0] != '\0')
		{
			g_esBombSpecial[type][specType].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esBombSpecial[type][specType].g_flCloseAreasOnly, value, -1.0, 99999.0, specType);
			g_esBombSpecial[type][specType].g_iComboAbility = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esBombSpecial[type][specType].g_iComboAbility, value, -1, 1, specType);
			g_esBombSpecial[type][specType].g_iHumanAbility = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esBombSpecial[type][specType].g_iHumanAbility, value, -1, 2, specType);
			g_esBombSpecial[type][specType].g_iHumanAmmo = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esBombSpecial[type][specType].g_iHumanAmmo, value, -1, 99999, specType);
			g_esBombSpecial[type][specType].g_iHumanCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esBombSpecial[type][specType].g_iHumanCooldown, value, -1, 99999, specType);
			g_esBombSpecial[type][specType].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esBombSpecial[type][specType].g_iHumanRangeCooldown, value, -1, 99999, specType);
			g_esBombSpecial[type][specType].g_iHumanRockCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "HumanRockCooldown", "Human Rock Cooldown", "Human_Rock_Cooldown", "hrockcooldown", g_esBombSpecial[type][specType].g_iHumanRockCooldown, value, -1, 99999, specType);
			g_esBombSpecial[type][specType].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esBombSpecial[type][specType].g_flOpenAreasOnly, value, -1.0, 99999.0, specType);
			g_esBombSpecial[type][specType].g_iRequiresHumans = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esBombSpecial[type][specType].g_iRequiresHumans, value, -1, 32, specType);
			g_esBombSpecial[type][specType].g_iBombAbility = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilityEnabled", "Ability Enabled", "Ability_Enabled", "aenabled", g_esBombSpecial[type][specType].g_iBombAbility, value, -1, 1, specType);
			g_esBombSpecial[type][specType].g_iBombEffect = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilityEffect", "Ability Effect", "Ability_Effect", "effect", g_esBombSpecial[type][specType].g_iBombEffect, value, -1, 7, specType);
			g_esBombSpecial[type][specType].g_iBombMessage = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilityMessage", "Ability Message", "Ability_Message", "message", g_esBombSpecial[type][specType].g_iBombMessage, value, -1, 7, specType);
			g_esBombSpecial[type][specType].g_iBombSight = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "AbilitySight", "Ability Sight", "Ability_Sight", "sight", g_esBombSpecial[type][specType].g_iBombSight, value, -1, 2, specType);
			g_esBombSpecial[type][specType].g_flBombChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombChance", "Bomb Chance", "Bomb_Chance", "chance", g_esBombSpecial[type][specType].g_flBombChance, value, -1.0, 100.0, specType);
			g_esBombSpecial[type][specType].g_iBombCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombCooldown", "Bomb Cooldown", "Bomb_Cooldown", "cooldown", g_esBombSpecial[type][specType].g_iBombCooldown, value, -1, 99999, specType);
			g_esBombSpecial[type][specType].g_iBombDeath = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombDeath", "Bomb Death", "Bomb_Death", "death", g_esBombSpecial[type][specType].g_iBombDeath, value, -1, 1, specType);
			g_esBombSpecial[type][specType].g_flBombDeathChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombDeathChance", "Bomb Death Chance", "Bomb_Death_Chance", "deathchance", g_esBombSpecial[type][specType].g_flBombDeathChance, value, -1.0, 99999.0, specType);
			g_esBombSpecial[type][specType].g_iBombHit = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombHit", "Bomb Hit", "Bomb_Hit", "hit", g_esBombSpecial[type][specType].g_iBombHit, value, -1, 1, specType);
			g_esBombSpecial[type][specType].g_iBombHitMode = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombHitMode", "Bomb Hit Mode", "Bomb_Hit_Mode", "hitmode", g_esBombSpecial[type][specType].g_iBombHitMode, value, -1, 2, specType);
			g_esBombSpecial[type][specType].g_flBombRange = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRange", "Bomb Range", "Bomb_Range", "range", g_esBombSpecial[type][specType].g_flBombRange, value, -1.0, 99999.0, specType);
			g_esBombSpecial[type][specType].g_flBombRangeChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRangeChance", "Bomb Range Chance", "Bomb_Range_Chance", "rangechance", g_esBombSpecial[type][specType].g_flBombRangeChance, value, -1.0, 100.0, specType);
			g_esBombSpecial[type][specType].g_iBombRangeCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRangeCooldown", "Bomb Range Cooldown", "Bomb_Range_Cooldown", "rangecooldown", g_esBombSpecial[type][specType].g_iBombRangeCooldown, value, -1, 99999, specType);
			g_esBombSpecial[type][specType].g_iBombRockBreak = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRockBreak", "Bomb Rock Break", "Bomb_Rock_Break", "rock", g_esBombSpecial[type][specType].g_iBombRockBreak, value, -1, 1, specType);
			g_esBombSpecial[type][specType].g_flBombRockChance = flGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRockChance", "Bomb Rock Chance", "Bomb_Rock_Chance", "rockchance", g_esBombSpecial[type][specType].g_flBombRockChance, value, -1.0, 100.0, specType);
			g_esBombSpecial[type][specType].g_iBombRockCooldown = iGetKeyValue(subsection, MT_BOMB_SECTION, MT_BOMB_SECTION2, MT_BOMB_SECTION3, MT_BOMB_SECTION4, key, "BombRockCooldown", "Bomb Rock Cooldown", "Bomb_Rock_Cooldown", "rockcooldown", g_esBombSpecial[type][specType].g_iBombRockCooldown, value, -1, 99999, specType);
		}
		else
		{
...
#endif
{
	...
	g_esBombPlayer[tank].g_iInfectedType = iGetInfectedType(tank);
	g_esBombPlayer[tank].g_iTankType = apply ? type : 0;
	int iSpecType = g_esBombPlayer[tank].g_iInfectedType;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esBombCache[tank].g_flBombChance = flGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_flBombChance, g_esBombTeammate[tank][iSpecType].g_flBombChance, g_esBombPlayer[tank].g_flBombChance, g_esBombSpecial[type][0].g_flBombChance, g_esBombSpecial[type][iSpecType].g_flBombChance, g_esBombAbility[type].g_flBombChance, 1);
		g_esBombCache[tank].g_flBombDeathChance = flGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_flBombDeathChance, g_esBombTeammate[tank][iSpecType].g_flBombDeathChance, g_esBombPlayer[tank].g_flBombDeathChance, g_esBombSpecial[type][0].g_flBombDeathChance, g_esBombSpecial[type][iSpecType].g_flBombDeathChance, g_esBombAbility[type].g_flBombDeathChance, 1);
		g_esBombCache[tank].g_flBombRange = flGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_flBombRange, g_esBombTeammate[tank][iSpecType].g_flBombRange, g_esBombPlayer[tank].g_flBombRange, g_esBombSpecial[type][0].g_flBombRange, g_esBombSpecial[type][iSpecType].g_flBombRange, g_esBombAbility[type].g_flBombRange, 1);
		g_esBombCache[tank].g_flBombRangeChance = flGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_flBombRangeChance, g_esBombTeammate[tank][iSpecType].g_flBombRangeChance, g_esBombPlayer[tank].g_flBombRangeChance, g_esBombSpecial[type][0].g_flBombRangeChance, g_esBombSpecial[type][iSpecType].g_flBombRangeChance, g_esBombAbility[type].g_flBombRangeChance, 1);
		g_esBombCache[tank].g_flBombRockChance = flGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_flBombRockChance, g_esBombTeammate[tank][iSpecType].g_flBombRockChance, g_esBombPlayer[tank].g_flBombRockChance, g_esBombSpecial[type][0].g_flBombRockChance, g_esBombSpecial[type][iSpecType].g_flBombRockChance, g_esBombAbility[type].g_flBombRockChance, 1);
		g_esBombCache[tank].g_iBombAbility = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombAbility, g_esBombTeammate[tank][iSpecType].g_iBombAbility, g_esBombPlayer[tank].g_iBombAbility, g_esBombSpecial[type][0].g_iBombAbility, g_esBombSpecial[type][iSpecType].g_iBombAbility, g_esBombAbility[type].g_iBombAbility, 1);
		g_esBombCache[tank].g_iBombCooldown = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombCooldown, g_esBombTeammate[tank][iSpecType].g_iBombCooldown, g_esBombPlayer[tank].g_iBombCooldown, g_esBombSpecial[type][0].g_iBombCooldown, g_esBombSpecial[type][iSpecType].g_iBombCooldown, g_esBombAbility[type].g_iBombCooldown, 1);
		g_esBombCache[tank].g_iBombDeath = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombDeath, g_esBombTeammate[tank][iSpecType].g_iBombDeath, g_esBombPlayer[tank].g_iBombDeath, g_esBombSpecial[type][0].g_iBombDeath, g_esBombSpecial[type][iSpecType].g_iBombDeath, g_esBombAbility[type].g_iBombDeath, 1);
		g_esBombCache[tank].g_iBombEffect = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombEffect, g_esBombTeammate[tank][iSpecType].g_iBombEffect, g_esBombPlayer[tank].g_iBombEffect, g_esBombSpecial[type][0].g_iBombEffect, g_esBombSpecial[type][iSpecType].g_iBombEffect, g_esBombAbility[type].g_iBombEffect, 1);
		g_esBombCache[tank].g_iBombHit = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombHit, g_esBombTeammate[tank][iSpecType].g_iBombHit, g_esBombPlayer[tank].g_iBombHit, g_esBombSpecial[type][0].g_iBombHit, g_esBombSpecial[type][iSpecType].g_iBombHit, g_esBombAbility[type].g_iBombHit, 1);
		g_esBombCache[tank].g_iBombHitMode = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombHitMode, g_esBombTeammate[tank][iSpecType].g_iBombHitMode, g_esBombPlayer[tank].g_iBombHitMode, g_esBombSpecial[type][0].g_iBombHitMode, g_esBombSpecial[type][iSpecType].g_iBombHitMode, g_esBombAbility[type].g_iBombHitMode, 1);
		g_esBombCache[tank].g_iBombMessage = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombMessage, g_esBombTeammate[tank][iSpecType].g_iBombMessage, g_esBombPlayer[tank].g_iBombMessage, g_esBombSpecial[type][0].g_iBombMessage, g_esBombSpecial[type][iSpecType].g_iBombMessage, g_esBombAbility[type].g_iBombMessage, 1);
		g_esBombCache[tank].g_iBombRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombRangeCooldown, g_esBombTeammate[tank][iSpecType].g_iBombRangeCooldown, g_esBombPlayer[tank].g_iBombRangeCooldown, g_esBombSpecial[type][0].g_iBombRangeCooldown, g_esBombSpecial[type][iSpecType].g_iBombRangeCooldown, g_esBombAbility[type].g_iBombRangeCooldown, 1);
		g_esBombCache[tank].g_iBombRockBreak = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombRockBreak, g_esBombTeammate[tank][iSpecType].g_iBombRockBreak, g_esBombPlayer[tank].g_iBombRockBreak, g_esBombSpecial[type][0].g_iBombRockBreak, g_esBombSpecial[type][iSpecType].g_iBombRockBreak, g_esBombAbility[type].g_iBombRockBreak, 1);
		g_esBombCache[tank].g_iBombRockCooldown = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombRockCooldown, g_esBombTeammate[tank][iSpecType].g_iBombRockCooldown, g_esBombPlayer[tank].g_iBombRockCooldown, g_esBombSpecial[type][0].g_iBombRockCooldown, g_esBombSpecial[type][iSpecType].g_iBombRockCooldown, g_esBombAbility[type].g_iBombRockCooldown, 1);
		g_esBombCache[tank].g_iBombSight = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iBombSight, g_esBombTeammate[tank][iSpecType].g_iBombSight, g_esBombPlayer[tank].g_iBombSight, g_esBombSpecial[type][0].g_iBombSight, g_esBombSpecial[type][iSpecType].g_iBombSight, g_esBombAbility[type].g_iBombSight, 1);
		g_esBombCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_flCloseAreasOnly, g_esBombTeammate[tank][iSpecType].g_flCloseAreasOnly, g_esBombPlayer[tank].g_flCloseAreasOnly, g_esBombSpecial[type][0].g_flCloseAreasOnly, g_esBombSpecial[type][iSpecType].g_flCloseAreasOnly, g_esBombAbility[type].g_flCloseAreasOnly, 1);
		g_esBombCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iComboAbility, g_esBombTeammate[tank][iSpecType].g_iComboAbility, g_esBombPlayer[tank].g_iComboAbility, g_esBombSpecial[type][0].g_iComboAbility, g_esBombSpecial[type][iSpecType].g_iComboAbility, g_esBombAbility[type].g_iComboAbility, 1);
		g_esBombCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iHumanAbility, g_esBombTeammate[tank][iSpecType].g_iHumanAbility, g_esBombPlayer[tank].g_iHumanAbility, g_esBombSpecial[type][0].g_iHumanAbility, g_esBombSpecial[type][iSpecType].g_iHumanAbility, g_esBombAbility[type].g_iHumanAbility, 1);
		g_esBombCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iHumanAmmo, g_esBombTeammate[tank][iSpecType].g_iHumanAmmo, g_esBombPlayer[tank].g_iHumanAmmo, g_esBombSpecial[type][0].g_iHumanAmmo, g_esBombSpecial[type][iSpecType].g_iHumanAmmo, g_esBombAbility[type].g_iHumanAmmo, 1);
		g_esBombCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iHumanCooldown, g_esBombTeammate[tank][iSpecType].g_iHumanCooldown, g_esBombPlayer[tank].g_iHumanCooldown, g_esBombSpecial[type][0].g_iHumanCooldown, g_esBombSpecial[type][iSpecType].g_iHumanCooldown, g_esBombAbility[type].g_iHumanCooldown, 1);
		g_esBombCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iHumanRangeCooldown, g_esBombTeammate[tank][iSpecType].g_iHumanRangeCooldown, g_esBombPlayer[tank].g_iHumanRangeCooldown, g_esBombSpecial[type][0].g_iHumanRangeCooldown, g_esBombSpecial[type][iSpecType].g_iHumanRangeCooldown, g_esBombAbility[type].g_iHumanRangeCooldown, 1);
		g_esBombCache[tank].g_iHumanRockCooldown = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iHumanRockCooldown, g_esBombTeammate[tank][iSpecType].g_iHumanRockCooldown, g_esBombPlayer[tank].g_iHumanRockCooldown, g_esBombSpecial[type][0].g_iHumanRockCooldown, g_esBombSpecial[type][iSpecType].g_iHumanRockCooldown, g_esBombAbility[type].g_iHumanRockCooldown, 1);
		g_esBombCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_flOpenAreasOnly, g_esBombTeammate[tank][iSpecType].g_flOpenAreasOnly, g_esBombPlayer[tank].g_flOpenAreasOnly, g_esBombSpecial[type][0].g_flOpenAreasOnly, g_esBombSpecial[type][iSpecType].g_flOpenAreasOnly, g_esBombAbility[type].g_flOpenAreasOnly, 1);
		g_esBombCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esBombTeammate[tank][0].g_iRequiresHumans, g_esBombTeammate[tank][iSpecType].g_iRequiresHumans, g_esBombPlayer[tank].g_iRequiresHumans, g_esBombSpecial[type][0].g_iRequiresHumans, g_esBombSpecial[type][iSpecType].g_iRequiresHumans, g_esBombAbility[type].g_iRequiresHumans, 1);
	}
	else
	{
		g_esBombCache[tank].g_flBombChance = flGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_flBombChance, g_esBombAbility[type].g_flBombChance, 1);
		g_esBombCache[tank].g_flBombDeathChance = flGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_flBombDeathChance, g_esBombAbility[type].g_flBombDeathChance, 1);
		g_esBombCache[tank].g_flBombRange = flGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_flBombRange, g_esBombAbility[type].g_flBombRange, 1);
		g_esBombCache[tank].g_flBombRangeChance = flGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_flBombRangeChance, g_esBombAbility[type].g_flBombRangeChance, 1);
		g_esBombCache[tank].g_flBombRockChance = flGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_flBombRockChance, g_esBombAbility[type].g_flBombRockChance, 1);
		g_esBombCache[tank].g_iBombAbility = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombAbility, g_esBombAbility[type].g_iBombAbility, 1);
		g_esBombCache[tank].g_iBombCooldown = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombCooldown, g_esBombAbility[type].g_iBombCooldown, 1);
		g_esBombCache[tank].g_iBombDeath = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombDeath, g_esBombAbility[type].g_iBombDeath, 1);
		g_esBombCache[tank].g_iBombEffect = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombEffect, g_esBombAbility[type].g_iBombEffect, 1);
		g_esBombCache[tank].g_iBombHit = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombHit, g_esBombAbility[type].g_iBombHit, 1);
		g_esBombCache[tank].g_iBombHitMode = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombHitMode, g_esBombAbility[type].g_iBombHitMode, 1);
		g_esBombCache[tank].g_iBombMessage = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombMessage, g_esBombAbility[type].g_iBombMessage, 1);
		g_esBombCache[tank].g_iBombRangeCooldown = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombRangeCooldown, g_esBombAbility[type].g_iBombRangeCooldown, 1);
		g_esBombCache[tank].g_iBombRockBreak = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombRockBreak, g_esBombAbility[type].g_iBombRockBreak, 1);
		g_esBombCache[tank].g_iBombRockCooldown = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombRockCooldown, g_esBombAbility[type].g_iBombRockCooldown, 1);
		g_esBombCache[tank].g_iBombSight = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iBombSight, g_esBombAbility[type].g_iBombSight, 1);
		g_esBombCache[tank].g_flCloseAreasOnly = flGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_flCloseAreasOnly, g_esBombAbility[type].g_flCloseAreasOnly, 1);
		g_esBombCache[tank].g_iComboAbility = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iComboAbility, g_esBombAbility[type].g_iComboAbility, 1);
		g_esBombCache[tank].g_iHumanAbility = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iHumanAbility, g_esBombAbility[type].g_iHumanAbility, 1);
		g_esBombCache[tank].g_iHumanAmmo = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iHumanAmmo, g_esBombAbility[type].g_iHumanAmmo, 1);
		g_esBombCache[tank].g_iHumanCooldown = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iHumanCooldown, g_esBombAbility[type].g_iHumanCooldown, 1);
		g_esBombCache[tank].g_iHumanRangeCooldown = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iHumanRangeCooldown, g_esBombAbility[type].g_iHumanRangeCooldown, 1);
		g_esBombCache[tank].g_iHumanRockCooldown = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iHumanRockCooldown, g_esBombAbility[type].g_iHumanRockCooldown, 1);
		g_esBombCache[tank].g_flOpenAreasOnly = flGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_flOpenAreasOnly, g_esBombAbility[type].g_flOpenAreasOnly, 1);
		g_esBombCache[tank].g_iRequiresHumans = iGetSettingValue(apply, bHuman, g_esBombPlayer[tank].g_iRequiresHumans, g_esBombAbility[type].g_iRequiresHumans, 1);
	}
}
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esBombCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esBombCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esBombPlayer[tank].g_iTankType, tank) || (g_esBombCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esBombCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esBombAbility[g_esBombPlayer[tank].g_iTankType].g_iAccessFlags, g_esBombPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
#endif
{
	...
	{
		if (bIsInfected(tank, MT_CHECK_FAKECLIENT) && ((!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esBombAbility[g_esBombPlayer[tank].g_iTankType].g_iAccessFlags, g_esBombPlayer[tank].g_iAccessFlags)) || g_esBombCache[tank].g_iHumanAbility == 0))
		{
			return;
		}
...
void tTimerBombCombo(Handle timer, DataPack pack)
{
	...
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esBombAbility[g_esBombPlayer[iTank].g_iTankType].g_iAccessFlags, g_esBombPlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esBombPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esBombCache[iTank].g_iBombAbility == 0)
	{
		return;
	}
