...
bool g_bLateLoad, g_bPluginEnabled, g_bShove[MAXPLAYERS + 1], g_bTankConfig[ST_MAXTYPES + 1];
...
{
	if (g_bPluginEnabled && enabled == 1 && GetRandomInt(1, chance) == 1 && bIsSurvivor(client) && !g_bShove[client])
	{
