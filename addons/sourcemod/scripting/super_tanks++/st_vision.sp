...
bool g_bLateLoad, g_bPluginEnabled, g_bTankConfig[ST_MAXTYPES + 1], g_bVision[MAXPLAYERS + 1];
...
{
	if (g_bPluginEnabled && enabled == 1 && GetRandomInt(1, chance) == 1 && bIsSurvivor(client) && !g_bVision[client])
	{
