...
bool g_bPluginEnabled, g_bRegen[MAXPLAYERS + 1], g_bTankConfig[ST_MAXTYPES + 1];
...
public void ST_Ability(int client)
{
	...
	if (g_bPluginEnabled && iRegenAbility == 1 && ST_TankAllowed(client) && IsPlayerAlive(client) && !g_bRegen[client])
	{
