...
stock void vBuryHit(int survivor, int tank, int chance, int enabled, int message, const char[] mode)
{
...
stock void vRemoveBury(int tank)
{
	for (int iSurvivor = 1; iSurvivor <= MaxClients; iSurvivor++)
	{
